...
parser = argparse.ArgumentParser(
                    prog = 'Imbalanced_Raw-20.py',
                    description = 'Run Imbalanced model for machine learning classifiers')
...
#    write.writerow(("Year", "Sampling", "Technique", "Classifier", "Test Size", "Train Size", "Iteration",
#                    "Precision", "Recall", "AUC", "Accuracy"))

df = pd.DataFrame()
#raw = (os.path.join(path, "NIST_FULL", [args["negdata"]]))
#datapath = r'C://Users//Predator//Documents//Document-Classification//classifier//NIST_FULL'
#print(datapath)
with open(args.negdata, encoding="ISO-8859-1") as raw:
    print(raw)
    #path = 'C:/Users/jodix5/Documents/Document-Classification/classifier/'
    #raw = open(r"C://Users//jod1//Documents//Document-Classification//classifier//NIST_FULL//", args.group-neg.txt", encoding="ISO-8859-1")
    lines = raw.readlines()
    raw.close()
...
#raw1 = (os.path.join(path, "NIST_FULL", [args["posdata"]]))
#with open(os.path.join(datapath, "NIST_FULL", args.posdata), encoding="ISO-8859-1") as /
#raw1 = os.path.join(datapath + "//" + args.posdata)
with open(args.posdata, encoding="ISO-8859-1") as raw1:
#raw1 = open(r"C://Users//jod1//Documents//Document-Classification//classifier//NIST_FULL//", args.group-pos.txt", encoding="ISO-8859-1")
...
#test_values = np.array([0.83, 0.67, 0.50, 0.33, 0.17])
...
for i in train_values:
    ...
    x_train, x_test, y_train, y_test = train_test_split(x_tfidf, df1["label"], train_size=i, stratify=df1["label"])
    ...
    print("===Logistic Regression with TfidfVectorizer Imbalanced", args.group, df1_l, i)
    lr_end = time.time()
    ...
    print('Logistic Confusion Matrix', confusion_matrix(y_test,ly_prediction), "/n")
    print('Logistic Classification', classification_report(y_test,ly_prediction), "/n")
    ...
    print("===DecisionTreeClassifier with TfidfVectorizer Imbalanced", args.group, df1_l, i)
    dt_end = time.time()
    ...
    print('DCT Confusion Matrix', confusion_matrix(y_test, dct_pred), "/n")
    print('DCT Classification', classification_report(y_test, dct_pred), "/n")
    ...
    print("===Naive Bayes with TfidfVectorizer Imabalanced", args.group, df1_l, i)
    ...
    print('Naive Confusion Matrix', confusion_matrix(y_test, ny_pred), "/n")
    print('Naive Classification', classification_report(y_test, ny_pred), "/n")
...
# XGBoost Classifier
    ...
    xg_end = time.time()
    print("===XGB with TfidfVectorizer Imbalanced", args.group, df1_l, i)
    ...
    print('XGB Confusion Matrix', confusion_matrix(xgb_y_predict, y_test), "/n")
    print('XGB Classification', classification_report(xgb_y_predict, y_test), "/n")
...
# Random Forest Classifier
    ...
    rf_end = time.time()
    print("====RandomForest with Tfidf Imbalanced", args.group, df1_l, i)
    ...
    print('RFC Confusion Matrix', confusion_matrix(y_test,rfc_pred), "/n")
    print('RFC Classification', classification_report(y_test,rfc_pred), "/n")
...
for i in train_values:
    ...
    x_train, x_test, y_train, y_test = train_test_split(x_tfidf1, df2["label"], train_size=i, stratify=df2["label"])
    ...
    print("===Logistic Regression with TfidfVectorizer Imbalanced - ", args.group, df2_l, i)
    lr_end = time.time()
    print('Logistic F1-score',fly*100)
    print('Logistic ROCAUC score:',rocauc_lr*100)
    print('Logistic Recall score:', recalls_lr*100)
    ...
    print("===DecisionTreeClassifier with TfidfVectorizer Imbalanced - ", args.group, df2_l, i)
    dt_end = time.time()
    print('DCT F1-score',fdct*100)
    print('DCT ROCAUC score:',rocauc_dt*100)
    print('DCT Recall score:', recalls_dt*100)
    ...
    nb_end = time.time()
    # Use accuracy_score function to get the accuracy
    print("===Naive Bayes with TfidfVectorizer Imabalanced - ", args.group, df2_l, i)
    print('Naive F1-score',fnb*100)
    print('Naive ROCAUC score:',rocauc_nb*100)
    print('Naive Recall score:', recalls_nb*100)
    print('Naive Precision Score:', precisions_nb*100)
...
# XGBoost Classifier
    ...
    xg_end = time.time()
    print("===XGB with TfidfVectorizer Imbalanced - ", args.group, df2_l, i)
    print('XGB F1-Score', fxg*100)
    print('XGB ROCAUC Score:', rocauc_xg*100)
    print('XGB Recall score:', recall_xg*100)
    print('XGB Precision Score:', precisions_xg *100)
...
# Random Forest Classifier
    ...
    rf_end = time.time()
    print("====RandomForest with Tfidf Imbalanced", args.group, df2_l, i)
    print('RFC F1 score', frfc*100)
    print('RFC ROCAUC Score:', rocauc_rf*100)
    print('RFC Recall score:', recalls_rf*100)
    print('RFC Precision Score:', precisions_rf*100)
    ...
    print("Array of Prob Scores LR-Imb:",  df2_l,":",  probs_lr_scol1)
    print("Array of F1 Scores LR-Imb:",  df2_l,":",  f1_lr_scol1)
    print("Array of ROCAUC Scores LR-Imb:",  df2_l,":",  rocauc_lr_scol1)
    print("Array of Recall Scores LR-Imb:",  df2_l,":",  recall_lr_scol1)
    print("Array of Precision Scores LR-Imb:",  df2_l,":", precision_lr_scol1)
    print("Array of Accuracy Scores LR-Imb:", df2_l,":", accuracy_lr_scol1)

    print("Array of Prob Scores DT-Imb:", df2_l,":", probs_dt_scol1)
    print("Array of F1 Scores DT-Imb:", df2_l,":", f1_dt_scol1)
    print("Array of ROCAUC Scores DT-Imb:", df2_l,":", rocauc_dt_scol1)
    print("Array of Recall Scores DT-Imb:",df2_l,":", recall_dt_scol1)
    print("Array of Precision Scores DT-Imb:", df2_l,":", precision_dt_scol1)
    print("Array of Accuracy Scores DT-Imb:", df2_l,":", accuracy_dt_scol1)

    print("Array of Prob Scores NB-Imb:", df2_l,":", probs_nb_scol1)
    print("Array of F1 Scores NB-Imb:", df2_l,":", f1_nb_scol1)
    print("Array of ROCAUC Scores NB-Imb:", df2_l,":", rocauc_nb_scol1)
    print("Array of Recall Scores NB-Imb:", df2_l,":", recall_nb_scol1)
    print("Array of Precision Scores NB-Imb:", df2_l,":", precision_nb_scol1)
    print("Array of Accuracy Scores NB-Imb:", df2_l,":", accuracy_nb_scol1)

    print("Array of Prob Scores XG-Imb:", df2_l,":", probs_xg_scol1)
    print("Array of F1 Scores XG-Imb:", df2_l,":", f1_xg_scol1)
    print("Array of ROCAUC Scores XG-Imb:", df2_l,":", rocauc_xg_scol1)
    print("Array of Recall Scores XG-Imb:", df2_l,":", recall_xg_scol1)
    print("Array of Precision Scores XG-Imb:", df2_l,":", precision_xg_scol1)
    print("Array of Accuracy Scores XG-Imb:", df2_l,":", accuracy_xg_scol1)

    print("Array of Prob Scores RF-Imb:", df2_l,":", probs_rf_scol1)
    print("Array of F1 Scores RF-Imb:", df2_l,":", f1_rf_scol1)
    print("Array of ROCAUC Scores RF-Imb:", df2_l,":", rocauc_rf_scol1)
    print("Array of Recall Scores RF-Imb:", df2_l,":", recall_rf_scol1)
    print("Array of Precision Scores RF-Imb:", df2_l,":", precision_rf_scol1)
    print("Array of Accuracy Scores RF-Imb:", df2_l,":", accuracy_rf_scol1)
'''
classifier_list = ['Logistic Regression', 'Decision Tree', 'Naive Bayes', 'XGBoost', 'Random Forest']
test_sizes_num = [0.17, 0.33, 0.50, 0.67, 0.83]
train_sizes_num = [0.83, 0.67, 0.50, 0.33, 0.17]
...
sampling1 = ['Imbalanced' for t in range(25)]
technique1 = ['Imbalanced' for t in range(25)]
...
'''
# Precision - 1st Test Size
#precision_imb1b = list([precision_rf_scol1[0], precision_xg_scol1[0], precision_dt_scol1[0], precision_lr_scol1[0], precision_nb_scol1[0]])
precision_imb1 = list([test_sizes[0], precision_rf_scol1[0], precision_xg_scol1[0], precision_dt_scol1[0], precision_lr_scol1[0], precision_nb_scol1[0]])
precision_imb2 = list([test_sizes[0], precision_rf_scol1[1], precision_xg_scol1[1], precision_dt_scol1[1], precision_lr_scol1[1], precision_nb_scol1[1]])
precision_imb3 = list([test_sizes[0], precision_rf_scol1[2], precision_xg_scol1[2], precision_dt_scol1[2], precision_lr_scol1[2], precision_nb_scol1[2]])
precision_imb4 = list([test_sizes[0], precision_rf_scol1[3], precision_xg_scol1[3], precision_dt_scol1[3], precision_lr_scol1[3], precision_nb_scol1[3]])
precision_imb5 = list([test_sizes[0], precision_rf_scol1[4], precision_xg_scol1[4], precision_dt_scol1[4], precision_lr_scol1[4], precision_nb_scol1[4]])

# Recall - 1st Test Size 
#recall_imb1b = list([recall_rf_scol1[0], recall_xg_scol1[0], recall_dt_scol1[0], recall_lr_scol1[0], recall_nb_scol1[0]])
recall_imb1 = list([test_sizes[0], recall_rf_scol1[0], recall_xg_scol1[0], recall_dt_scol1[0], recall_lr_scol1[0], recall_nb_scol1[0]])
recall_imb2 = list([test_sizes[0], recall_rf_scol1[1], recall_xg_scol1[1], recall_dt_scol1[1], recall_lr_scol1[1], recall_nb_scol1[1]])
recall_imb3 = list([test_sizes[0], recall_rf_scol1[2], recall_xg_scol1[2], recall_dt_scol1[2], recall_lr_scol1[2], recall_nb_scol1[2]])
recall_imb4 = list([test_sizes[0], recall_rf_scol1[3], recall_xg_scol1[3], recall_dt_scol1[3], recall_lr_scol1[3], recall_nb_scol1[3]])
recall_imb5 = list([test_sizes[0], recall_rf_scol1[4], recall_xg_scol1[4], recall_dt_scol1[4], recall_lr_scol1[4], recall_nb_scol1[4]])
'''
'''
recall_imb16 = list([test_sizes[1], recall_lr_scol11[5], recall_dt_scol11[5], recall_rf_scol11[5], recall_nb_scol11[5], recall_xg_scol11[5]])
recall_imb17 = list([test_sizes[1], recall_lr_scol11[6], recall_dt_scol11[6], recall_rf_scol11[6], recall_nb_scol11[6], recall_xg_scol11[6]])
recall_imb18 = list([test_sizes[1], recall_lr_scol11[7], recall_dt_scol11[7], recall_rf_scol11[7], recall_nb_scol11[7], recall_xg_scol11[7]])
recall_imb19 = list([test_sizes[1], recall_lr_scol11[8], recall_dt_scol11[8], recall_rf_scol11[8], recall_nb_scol11[8], recall_xg_scol11[8]])
recall_imb30 = list([test_sizes[1], recall_lr_scol11[9], recall_dt_scol11[9], recall_rf_scol11[9], recall_nb_scol11[9], recall_xg_scol11[9]])
'''
...
for i in train_values:
    ...
    x_train, x_test, y_train, y_test = train_test_split(x_tfidf2, df3["label"], train_size=i, stratify=df3["label"])
    ...
    print("===Logistic Regression with TfidfVectorizer Imbalanced - ", args.group, df3_l, i)
    lr_end = time.time()
    print('Logistic F1-score',fly*100)
    print('Logistic ROCAUC score:',rocauc_lr*100)
    print('Logistic Recall score:', recalls_lr*100)
    ...
    print("===DecisionTreeClassifier with TfidfVectorizer Imbalanced - ", args.group, df3_l, i)
    dt_end = time.time()
    print('DCT F1-score',fdct*100)
    print('DCT ROCAUC score:',rocauc_dt*100)
    print('DCT Recall score:', recalls_dt*100)
    ...
    nb_end = time.time()
    # Use accuracy_score function to get the accuracy
    print("===Naive Bayes with TfidfVectorizer Imabalanced - ", args.group, df3_l, i)
    print('Naive F1-score',fnb*100)
    print('Naive ROCAUC score:',rocauc_nb*100)
    print('Naive Recall score:', recalls_nb*100)
    print('Naive Precision Score:', precisions_nb*100)
...
# XGBoost Classifier
    ...
    xg_end = time.time()
    print("===XGB with TfidfVectorizer Imbalanced - ", args.group, df3_l, i)
    print('XGB F1-Score', fxg*100)
    print('XGB ROCAUC Score:', rocauc_xg*100)
    print('XGB Recall score:', recall_xg*100)
    print('XGB Precision Score:', precisions_xg *100)
...
# Random Forest Classifier
    ...
    rf_end = time.time()
    print("====RandomForest with Tfidf Imbalanced", args.group, df3_l, i)
    print('RFC F1 score', frfc*100)
    print('RFC ROCAUC Score:', rocauc_rf*100)
    print('RFC Recall score:', recalls_rf*100)
    print('RFC Precision Score:', precisions_rf*100)
    ...
    print("Array of Prob Scores LR-Imb:",  df3_l,":",  probs_lr_scol2)
    print("Array of F1 Scores LR-Imb:",  df3_l,":",  f1_lr_scol2)
    print("Array of ROCAUC Scores LR-Imb:",  df3_l,":",  rocauc_lr_scol2)
    print("Array of Recall Scores LR-Imb:",  df3_l,":",  recall_lr_scol2)
    print("Array of Precision Scores LR-Imb:",  df3_l,":", precision_lr_scol2)
    print("Array of Accuracy Scores LR-Imb:", df3_l,":", accuracy_lr_scol2)

    print("Array of Prob Scores DT-Imb:", df3_l,":", probs_dt_scol2)
    print("Array of F1 Scores DT-Imb:", df3_l,":", f1_dt_scol2)
    print("Array of ROCAUC Scores DT-Imb:", df3_l,":", rocauc_dt_scol2)
    print("Array of Recall Scores DT-Imb:",df3_l,":", recall_dt_scol2)
    print("Array of Precision Scores DT-Imb:", df3_l,":", precision_dt_scol2)
    print("Array of Accuracy Scores DT-Imb:", df3_l,":", accuracy_dt_scol2)

    print("Array of Prob Scores NB-Imb:", df3_l,":", probs_nb_scol2)
    print("Array of F1 Scores NB-Imb:", df3_l,":", f1_nb_scol2)
    print("Array of ROCAUC Scores NB-Imb:", df3_l,":", rocauc_nb_scol2)
    print("Array of Recall Scores NB-Imb:", df3_l,":", recall_nb_scol2)
    print("Array of Precision Scores NB-Imb:", df3_l,":", precision_nb_scol2)
    print("Array of Accuracy Scores NB-Imb:", df3_l,":", accuracy_nb_scol2)

    print("Array of Prob Scores XG-Imb:", df3_l,":", probs_xg_scol2)
    print("Array of F1 Scores XG-Imb:", df3_l,":", f1_xg_scol2)
    print("Array of ROCAUC Scores XG-Imb:", df3_l,":", rocauc_xg_scol2)
    print("Array of Recall Scores XG-Imb:", df3_l,":", recall_xg_scol2)
    print("Array of Precision Scores XG-Imb:", df3_l,":", precision_xg_scol2)
    print("Array of Accuracy Scores XG-Imb:", df3_l,":", accuracy_xg_scol2)

    print("Array of Prob Scores RF-Imb:", df3_l,":", probs_rf_scol2)
    print("Array of F1 Scores RF-Imb:", df3_l,":", f1_rf_scol2)
    print("Array of ROCAUC Scores RF-Imb:", df3_l,":", rocauc_rf_scol2)
    print("Array of Recall Scores RF-Imb:", df3_l,":", recall_rf_scol2)
    print("Array of Precision Scores RF-Imb:", df3_l,":", precision_rf_scol2)
    print("Array of Accuracy Scores RF-Imb:", df3_l,":", accuracy_rf_scol2)


from itertools import chain
year2 = [args.group for t in range(25)]
sampling2 = ['Imbalanced' for t in range(25)]
technique2 = ['Imbalanced' for t in range(25)]
...
for i in train_values:
    ...
    x_train, x_test, y_train, y_test = train_test_split(x_tfidf3, df4["label"], train_size=i, stratify=df4["label"])
    ...
    print("===Logistic Regression with TfidfVectorizer Imbalanced - ", args.group, df4_l, i)
    lr_end = time.time()
    print('Logistic F1-score', fly * 100)
    print('Logistic ROCAUC score:', rocauc_lr * 100)
    print('Logistic Recall score:', recalls_lr * 100)
    ...
    print("===DecisionTreeClassifier with TfidfVectorizer Imbalanced - ", args.group, df4_l, i)
    dt_end = time.time()
    print('DCT F1-score', fdct * 100)
    print('DCT ROCAUC score:', rocauc_dt * 100)
    print('DCT Recall score:', recalls_dt * 100)
    ...
    nb_end = time.time()
    # Use accuracy_score function to get the accuracy
    print("===Naive Bayes with TfidfVectorizer Imabalanced - ", args.group, df4_l, i)
    print('Naive F1-score', fnb * 100)
    print('Naive ROCAUC score:', rocauc_nb * 100)
    print('Naive Recall score:', recalls_nb * 100)
    print('Naive Precision Score:', precisions_nb * 100)
    ...
    xg_end = time.time()
    print("===XGB with TfidfVectorizer Imbalanced - ", args.group, df4_l, i)
    print('XGB F1-Score', fxg * 100)
    print('XGB ROCAUC Score:', rocauc_xg * 100)
    print('XGB Recall score:', recall_xg * 100)
    print('XGB Precision Score:', precisions_xg * 100)
    ...
    rf_end = time.time()
    print("====RandomForest with Tfidf Imbalanced", args.group, df4_l, i)
    print('RFC F1 score', frfc * 100)
    print('RFC ROCAUC Score:', rocauc_rf * 100)
    print('RFC Recall score:', recalls_rf * 100)
    print('RFC Precision Score:', precisions_rf * 100)
    ...
    print("Array of Prob Scores LR-Imb:", df4_l, ":", probs_lr_scol3)
    print("Array of F1 Scores LR-Imb:", df4_l, ":", f1_lr_scol3)
    print("Array of ROCAUC Scores LR-Imb:", df4_l, ":", rocauc_lr_scol3)
    print("Array of Recall Scores LR-Imb:", df4_l, ":", recall_lr_scol3)
    print("Array of Precision Scores LR-Imb:", df4_l, ":", precision_lr_scol3)
    print("Array of Accuracy Scores LR-Imb:", df4_l, ":", accuracy_lr_scol3)

    print("Array of Prob Scores DT-Imb:", df4_l, ":", probs_dt_scol3)
    print("Array of F1 Scores DT-Imb:", df4_l, ":", f1_dt_scol3)
    print("Array of ROCAUC Scores DT-Imb:", df4_l, ":", rocauc_dt_scol3)
    print("Array of Recall Scores DT-Imb:", df4_l, ":", recall_dt_scol3)
    print("Array of Precision Scores DT-Imb:", df4_l, ":", precision_dt_scol3)
    print("Array of Accuracy Scores DT-Imb:", df4_l, ":", accuracy_dt_scol3)

    print("Array of Prob Scores NB-Imb:", df4_l, ":", probs_nb_scol3)
    print("Array of F1 Scores NB-Imb:", df4_l, ":", f1_nb_scol3)
    print("Array of ROCAUC Scores NB-Imb:", df4_l, ":", rocauc_nb_scol3)
    print("Array of Recall Scores NB-Imb:", df4_l, ":", recall_nb_scol3)
    print("Array of Precision Scores NB-Imb:", df4_l, ":", precision_nb_scol3)
    print("Array of Accuracy Scores NB-Imb:", df4_l, ":", accuracy_nb_scol3)

    print("Array of Prob Scores XG-Imb:", df4_l, ":", probs_xg_scol3)
    print("Array of F1 Scores XG-Imb:", df4_l, ":", f1_xg_scol3)
    print("Array of ROCAUC Scores XG-Imb:", df4_l, ":", rocauc_xg_scol3)
    print("Array of Recall Scores XG-Imb:", df4_l, ":", recall_xg_scol3)
    print("Array of Precision Scores XG-Imb:", df4_l, ":", precision_xg_scol3)
    print("Array of Accuracy Scores XG-Imb:", df4_l, ":", accuracy_xg_scol3)

    print("Array of Prob Scores RF-Imb:", df4_l, ":", probs_rf_scol3)
    print("Array of F1 Scores RF-Imb:", df4_l, ":", f1_rf_scol3)
    print("Array of ROCAUC Scores RF-Imb:", df4_l, ":", rocauc_rf_scol3)
    print("Array of Recall Scores RF-Imb:", df4_l, ":", recall_rf_scol3)
    print("Array of Precision Scores RF-Imb:", df4_l, ":", precision_rf_scol3)
    print("Array of Accuracy Scores RF-Imb:", df4_l, ":", accuracy_rf_scol3)
    

year3 = [args.group for t in range(25)]
sampling3 = ['Imbalanced' for t in range(25)]
technique3 = ['Imbalanced' for t in range(25)]
...
for i in train_values:
    ...
    x_train, x_test, y_train, y_test = train_test_split(x_tfidf4,df5["label"], train_size=i, stratify=df5["label"])
    ...
    print("===Logistic Regression with TfidfVectorizer Imbalanced - ", args.group, df5_l, i)
    lr_end = time.time()
    print('Logistic F1-score', fly * 100)
    print('Logistic ROCAUC score:', rocauc_lr * 100)
    print('Logistic Recall score:', recalls_lr * 100)
    ...
    print("===DecisionTreeClassifier with TfidfVectorizer Imbalanced - ", args.group, df5_l, i)
    dt_end = time.time()
    print('DCT F1-score', fdct * 100)
    print('DCT ROCAUC score:', rocauc_dt * 100)
    print('DCT Recall score:', recalls_dt * 100)
    ...
    nb_end = time.time()
    # Use accuracy_score function to get the accuracy
    print("===Naive Bayes with TfidfVectorizer Imabalanced - ", args.group, df5_l, i)
    print('Naive F1-score', fnb * 100)
    print('Naive ROCAUC score:', rocauc_nb * 100)
    print('Naive Recall score:', recalls_nb * 100)
    print('Naive Precision Score:', precisions_nb * 100)
    ...
    xg_end = time.time()
    print("===XGB with TfidfVectorizer Imbalanced - ", args.group, df5_l, i)
    print('XGB F1-Score', fxg * 100)
    print('XGB ROCAUC Score:', rocauc_xg * 100)
    print('XGB Recall score:', recall_xg * 100)
    print('XGB Precision Score:', precisions_xg * 100)
    ...
    rf_end = time.time()
    print("====RandomForest with Tfidf Imbalanced", args.group, df5_l, i)
    print('RFC F1 score', frfc * 100)
    print('RFC ROCAUC Score:', rocauc_rf * 100)
    print('RFC Recall score:', recalls_rf * 100)
    print('RFC Precision Score:', precisions_rf * 100)
    ...
    print("Array of Prob Scores LR-Imb:", df5_l, ":", probs_lr_scol4)
    print("Array of F1 Scores LR-Imb:", df5_l, ":", f1_lr_scol4)
    print("Array of ROCAUC Scores LR-Imb:", df5_l, ":", rocauc_lr_scol4)
    print("Array of Recall Scores LR-Imb:", df5_l, ":", recall_lr_scol4)
    print("Array of Precision Scores LR-Imb:", df5_l, ":", precision_lr_scol4)
    print("Array of Accuracy Scores LR-Imb:", df5_l, ":", accuracy_lr_scol4)

    print("Array of Prob Scores DT-Imb:", df5_l, ":", probs_dt_scol4)
    print("Array of F1 Scores DT-Imb:", df5_l, ":", f1_dt_scol4)
    print("Array of ROCAUC Scores DT-Imb:", df5_l, ":", rocauc_dt_scol4)
    print("Array of Recall Scores DT-Imb:", df5_l, ":", recall_dt_scol4)
    print("Array of Precision Scores DT-Imb:", df5_l, ":", precision_dt_scol4)
    print("Array of Accuracy Scores DT-Imb:", df5_l, ":", accuracy_dt_scol4)

    print("Array of Prob Scores NB-Imb:", df5_l, ":", probs_nb_scol4)
    print("Array of F1 Scores NB-Imb:", df5_l, ":", f1_nb_scol4)
    print("Array of ROCAUC Scores NB-Imb:", df5_l, ":", rocauc_nb_scol4)
    print("Array of Recall Scores NB-Imb:", df5_l, ":", recall_nb_scol4)
    print("Array of Precision Scores NB-Imb:", df5_l, ":", precision_nb_scol4)
    print("Array of Accuracy Scores NB-Imb:", df5_l, ":", accuracy_nb_scol4)

    print("Array of Prob Scores XG-Imb:", df5_l, ":", probs_xg_scol4)
    print("Array of F1 Scores XG-Imb:", df5_l, ":", f1_xg_scol4)
    print("Array of ROCAUC Scores XG-Imb:", df5_l, ":", rocauc_xg_scol4)
    print("Array of Recall Scores XG-Imb:", df5_l, ":", recall_xg_scol4)
    print("Array of Precision Scores XG-Imb:", df5_l, ":", precision_xg_scol4)
    print("Array of Accuracy Scores XG-Imb:", df5_l, ":", accuracy_xg_scol4)

    print("Array of Prob Scores RF-Imb:", df5_l, ":", probs_rf_scol4)
    print("Array of F1 Scores RF-Imb:", df5_l, ":", f1_rf_scol4)
    print("Array of ROCAUC Scores RF-Imb:", df5_l, ":", rocauc_rf_scol4)
    print("Array of Recall Scores RF-Imb:", df5_l, ":", recall_rf_scol4)
    print("Array of Precision Scores RF-Imb:", df5_l, ":", precision_rf_scol4)
    print("Array of Accuracy Scores RF-Imb:", df5_l, ":", accuracy_rf_scol4)


year4 = [args.group for t in range(25)]
sampling4 = ['Imbalanced' for t in range(25)]
technique4 = ['Imbalanced' for t in range(25)]
...
for i in train_values:
    ...
    x_train, x_test, y_train, y_test = train_test_split(x_tfidf5, df6["label"], train_size=i, stratify=df6["label"])
    ...
    print("===Logistic Regression with TfidfVectorizer Imbalanced - ", args.group, df6_l, i)
    lr_end = time.time()
    print('Logistic F1-score', fly * 100)
    print('Logistic ROCAUC score:', rocauc_lr * 100)
    print('Logistic Recall score:', recalls_lr * 100)
    ...
    print("===DecisionTreeClassifier with TfidfVectorizer Imbalanced - ", args.group, df6_l, i)
    dt_end = time.time()
    print('DCT F1-score', fdct * 100)
    print('DCT ROCAUC score:', rocauc_dt * 100)
    print('DCT Recall score:', recalls_dt * 100)
    ...
    nb_end = time.time()
    # Use accuracy_score function to get the accuracy
    print("===Naive Bayes with TfidfVectorizer Imabalanced - ", args.group, df6_l, i)
    print('Naive F1-score', fnb * 100)
    print('Naive ROCAUC score:', rocauc_nb * 100)
    print('Naive Recall score:', recalls_nb * 100)
    print('Naive Precision Score:', precisions_nb * 100)
    ...
    xg_end = time.time()
    print("===XGB with TfidfVectorizer Imbalanced - ", args.group, df6_l, i)
    print('XGB F1-Score', fxg * 100)
    print('XGB ROCAUC Score:', rocauc_xg * 100)
    print('XGB Recall score:', recall_xg * 100)
    print('XGB Precision Score:', precisions_xg * 100)
    ...
    rf_end = time.time()
    print("====RandomForest with Tfidf Imbalanced", args.group, df6_l, i)
    print('RFC F1 score', frfc * 100)
    print('RFC ROCAUC Score:', rocauc_rf * 100)
    print('RFC Recall score:', recalls_rf * 100)
    print('RFC Precision Score:', precisions_rf * 100)
    ...
    print("Array of Prob Scores LR-Imb:", df6_l, ":", probs_lr_scol5)
    print("Array of F1 Scores LR-Imb:", df6_l, ":", f1_lr_scol5)
    print("Array of ROCAUC Scores LR-Imb:", df6_l, ":", rocauc_lr_scol5)
    print("Array of Recall Scores LR-Imb:", df6_l, ":", recall_lr_scol5)
    print("Array of Precision Scores LR-Imb:", df6_l, ":", precision_lr_scol5)
    print("Array of Accuracy Scores LR-Imb:", df6_l, ":", accuracy_lr_scol5)

    print("Array of Prob Scores DT-Imb:", df6_l, ":", probs_dt_scol5)
    print("Array of F1 Scores DT-Imb:", df6_l, ":", f1_dt_scol5)
    print("Array of ROCAUC Scores DT-Imb:", df6_l, ":", rocauc_dt_scol5)
    print("Array of Recall Scores DT-Imb:", df6_l, ":", recall_dt_scol5)
    print("Array of Precision Scores DT-Imb:", df6_l, ":", precision_dt_scol5)
    print("Array of Accuracy Scores DT-Imb:", df6_l, ":", accuracy_dt_scol5)

    print("Array of Prob Scores NB-Imb:", df6_l, ":", probs_nb_scol5)
    print("Array of F1 Scores NB-Imb:", df6_l, ":", f1_nb_scol5)
    print("Array of ROCAUC Scores NB-Imb:", df6_l, ":", rocauc_nb_scol5)
    print("Array of Recall Scores NB-Imb:", df6_l, ":", recall_nb_scol5)
    print("Array of Precision Scores NB-Imb:", df6_l, ":", precision_nb_scol5)
    print("Array of Accuracy Scores NB-Imb:", df6_l, ":", accuracy_nb_scol5)

    print("Array of Prob Scores XG-Imb:", df6_l, ":", probs_xg_scol5)
    print("Array of F1 Scores XG-Imb:", df6_l, ":", f1_xg_scol5)
    print("Array of ROCAUC Scores XG-Imb:", df6_l, ":", rocauc_xg_scol5)
    print("Array of Recall Scores XG-Imb:", df6_l, ":", recall_xg_scol5)
    print("Array of Precision Scores XG-Imb:", df6_l, ":", precision_xg_scol5)
    print("Array of Accuracy Scores XG-Imb:", df6_l, ":", accuracy_xg_scol5)

    print("Array of Prob Scores RF-Imb:", df6_l, ":", probs_rf_scol5)
    print("Array of F1 Scores RF-Imb:", df6_l, ":", f1_rf_scol5)
    print("Array of ROCAUC Scores RF-Imb:", df6_l, ":", rocauc_rf_scol5)
    print("Array of Recall Scores RF-Imb:", df6_l, ":", recall_rf_scol5)
    print("Array of Precision Scores RF-Imb:", df6_l, ":", precision_rf_scol5)
    print("Array of Accuracy Scores RF-Imb:", df6_l, ":", accuracy_rf_scol5)
    

year5 = [args.group for t in range(25)]
sampling5 = ['Imbalanced' for t in range(25)]
technique5 = ['Imbalanced' for t in range(25)]
...
for i in train_values:
    ...
    x_train, x_test, y_train, y_test = train_test_split(x_tfidf6, df7["label"], train_size=i, stratify=df7["label"])
    ...
    print("===Logistic Regression with TfidfVectorizer Imbalanced - ", args.group, df7_l, i)
    lr_end = time.time()
    print('Logistic F1-score', fly * 100)
    print('Logistic ROCAUC score:', rocauc_lr * 100)
    print('Logistic Recall score:', recalls_lr * 100)
    ...
    print("===DecisionTreeClassifier with TfidfVectorizer Imbalanced - ", args.group, df7_l, i)
    dt_end = time.time()
    print('DCT F1-score', fdct * 100)
    print('DCT ROCAUC score:', rocauc_dt * 100)
    print('DCT Recall score:', recalls_dt * 100)
    ...
    nb_end = time.time()
    # Use accuracy_score function to get the accuracy
    print("===Naive Bayes with TfidfVectorizer Imabalanced - ", args.group, df7_l, i)
    print('Naive F1-score', fnb * 100)
    print('Naive ROCAUC score:', rocauc_nb * 100)
    print('Naive Recall score:', recalls_nb * 100)
    print('Naive Precision Score:', precisions_nb * 100)
    ...
    xg_end = time.time()
    print("===XGB with TfidfVectorizer Imbalanced - ", args.group, df7_l, i)
    print('XGB F1-Score', fxg * 100)
    print('XGB ROCAUC Score:', rocauc_xg * 100)
    print('XGB Recall score:', recall_xg * 100)
    print('XGB Precision Score:', precisions_xg * 100)
    ...
    rf_end = time.time()
    print("====RandomForest with Tfidf Imbalanced", args.group, df7_l, i)
    print('RFC F1 score', frfc * 100)
    print('RFC ROCAUC Score:', rocauc_rf * 100)
    print('RFC Recall score:', recalls_rf * 100)
    print('RFC Precision Score:', precisions_rf * 100)
    ...
    print("Array of Prob Scores LR-Imb:", df7_l, ":", probs_lr_scol6)
    print("Array of F1 Scores LR-Imb:", df7_l, ":", f1_lr_scol6)
    print("Array of ROCAUC Scores LR-Imb:", df7_l, ":", rocauc_lr_scol6)
    print("Array of Recall Scores LR-Imb:", df7_l, ":", recall_lr_scol6)
    print("Array of Precision Scores LR-Imb:", df7_l, ":", precision_lr_scol6)
    print("Array of Accuracy Scores LR-Imb:", df7_l, ":", accuracy_lr_scol6)

    print("Array of Prob Scores DT-Imb:", df7_l, ":", probs_dt_scol6)
    print("Array of F1 Scores DT-Imb:", df7_l, ":", f1_dt_scol6)
    print("Array of ROCAUC Scores DT-Imb:", df7_l, ":", rocauc_dt_scol6)
    print("Array of Recall Scores DT-Imb:", df7_l, ":", recall_dt_scol6)
    print("Array of Precision Scores DT-Imb:", df7_l, ":", precision_dt_scol6)
    print("Array of Accuracy Scores DT-Imb:", df7_l, ":", accuracy_dt_scol6)

    print("Array of Prob Scores NB-Imb:", df7_l, ":", probs_nb_scol6)
    print("Array of F1 Scores NB-Imb:", df7_l, ":", f1_nb_scol6)
    print("Array of ROCAUC Scores NB-Imb:", df7_l, ":", rocauc_nb_scol6)
    print("Array of Recall Scores NB-Imb:", df7_l, ":", recall_nb_scol6)
    print("Array of Precision Scores NB-Imb:", df7_l, ":", precision_nb_scol6)
    print("Array of Accuracy Scores NB-Imb:", df7_l, ":", accuracy_nb_scol6)

    print("Array of Prob Scores XG-Imb:", df7_l, ":", probs_xg_scol6)
    print("Array of F1 Scores XG-Imb:", df7_l, ":", f1_xg_scol6)
    print("Array of ROCAUC Scores XG-Imb:", df7_l, ":", rocauc_xg_scol6)
    print("Array of Recall Scores XG-Imb:", df7_l, ":", recall_xg_scol6)
    print("Array of Precision Scores XG-Imb:", df7_l, ":", precision_xg_scol6)
    print("Array of Accuracy Scores XG-Imb:", df7_l, ":", accuracy_xg_scol6)

    print("Array of Prob Scores RF-Imb:", df7_l, ":", probs_rf_scol6)
    print("Array of F1 Scores RF-Imb:", df7_l, ":", f1_rf_scol6)
    print("Array of ROCAUC Scores RF-Imb:", df7_l, ":", rocauc_rf_scol6)
    print("Array of Recall Scores RF-Imb:", df7_l, ":", recall_rf_scol6)
    print("Array of Precision Scores RF-Imb:", df7_l, ":", precision_rf_scol6)
    print("Array of Accuracy Scores RF-Imb:", df7_l, ":", accuracy_rf_scol6)

year6 = [args.group for t in range(25)]
sampling6 = ['Imbalanced' for t in range(25)]
technique6 = ['Imbalanced' for t in range(25)]
...
for i in train_values:
    ...
    x_train, x_test, y_train, y_test = train_test_split(x_tfidf7,df8["label"], train_size=i, stratify=df8["label"])
    ...
    print("===Logistic Regression with TfidfVectorizer Imbalanced - ", args.group, df8_l, i)
    lr_end = time.time()
    print('Logistic F1-score', fly * 100)
    print('Logistic ROCAUC score:', rocauc_lr * 100)
    print('Logistic Recall score:', recalls_lr * 100)
    ...
    print("===DecisionTreeClassifier with TfidfVectorizer Imbalanced - ", args.group, df8_l, i)
    dt_end = time.time()
    print('DCT F1-score', fdct * 100)
    print('DCT ROCAUC score:', rocauc_dt * 100)
    print('DCT Recall score:', recalls_dt * 100)
    ...
    nb_end = time.time()
    # Use accuracy_score function to get the accuracy
    print("===Naive Bayes with TfidfVectorizer Imabalanced - ", args.group, df8_l, i)
    print('Naive F1-score', fnb * 100)
    print('Naive ROCAUC score:', rocauc_nb * 100)
    print('Naive Recall score:', recalls_nb * 100)
    print('Naive Precision Score:', precisions_nb * 100)
    ...
    xg_end = time.time()
    print("===XGB with TfidfVectorizer Imbalanced - ", args.group, df8_l, i)
    print('XGB F1-Score', fxg * 100)
    print('XGB ROCAUC Score:', rocauc_xg * 100)
    print('XGB Recall score:', recall_xg * 100)
    print('XGB Precision Score:', precisions_xg * 100)
    ...
    rf_end = time.time()
    print("====RandomForest with Tfidf Imbalanced", args.group, df8_l, i)
    print('RFC F1 score', frfc * 100)
    print('RFC ROCAUC Score:', rocauc_rf * 100)
    print('RFC Recall score:', recalls_rf * 100)
    print('RFC Precision Score:', precisions_rf * 100)
    ...
    print("Array of Prob Scores LR-Imb:", df8_l, ":", probs_lr_scol7)
    print("Array of F1 Scores LR-Imb:", df8_l, ":", f1_lr_scol7)
    print("Array of ROCAUC Scores LR-Imb:", df8_l, ":", rocauc_lr_scol7)
    print("Array of Recall Scores LR-Imb:", df8_l, ":", recall_lr_scol7)
    print("Array of Precision Scores LR-Imb:", df8_l, ":", precision_lr_scol7)
    print("Array of Accuracy Scores LR-Imb:", df8_l, ":", accuracy_lr_scol7)

    print("Array of Prob Scores DT-Imb:", df8_l, ":", probs_dt_scol7)
    print("Array of F1 Scores DT-Imb:", df8_l, ":", f1_dt_scol7)
    print("Array of ROCAUC Scores DT-Imb:", df8_l, ":", rocauc_dt_scol7)
    print("Array of Recall Scores DT-Imb:", df8_l, ":", recall_dt_scol7)
    print("Array of Precision Scores DT-Imb:", df8_l, ":", precision_dt_scol7)
    print("Array of Accuracy Scores DT-Imb:", df8_l, ":", accuracy_dt_scol7)

    print("Array of Prob Scores NB-Imb:", df8_l, ":", probs_nb_scol7)
    print("Array of F1 Scores NB-Imb:", df8_l, ":", f1_nb_scol7)
    print("Array of ROCAUC Scores NB-Imb:", df8_l, ":", rocauc_nb_scol7)
    print("Array of Recall Scores NB-Imb:", df8_l, ":", recall_nb_scol7)
    print("Array of Precision Scores NB-Imb:", df8_l, ":", precision_nb_scol7)
    print("Array of Accuracy Scores NB-Imb:", df8_l, ":", accuracy_nb_scol7)

    print("Array of Prob Scores XG-Imb:", df8_l, ":", probs_xg_scol7)
    print("Array of F1 Scores XG-Imb:", df8_l, ":", f1_xg_scol7)
    print("Array of ROCAUC Scores XG-Imb:", df8_l, ":", rocauc_xg_scol7)
    print("Array of Recall Scores XG-Imb:", df8_l, ":", recall_xg_scol7)
    print("Array of Precision Scores XG-Imb:", df8_l, ":", precision_xg_scol7)
    print("Array of Accuracy Scores XG-Imb:", df8_l, ":", accuracy_xg_scol7)

    print("Array of Prob Scores RF-Imb:", df8_l, ":", probs_rf_scol7)
    print("Array of F1 Scores RF-Imb:", df8_l, ":", f1_rf_scol7)
    print("Array of ROCAUC Scores RF-Imb:", df8_l, ":", rocauc_rf_scol7)
    print("Array of Recall Scores RF-Imb:", df8_l, ":", recall_rf_scol7)
    print("Array of Precision Scores RF-Imb:", df8_l, ":", precision_rf_scol7)
    print("Array of Accuracy Scores RF-Imb:", df8_l, ":", accuracy_rf_scol7)

year7 = [args.group for t in range(25)]
sampling7 = ['Imbalanced' for t in range(25)]
technique7 = ['Imbalanced' for t in range(25)]
...
for i in train_values:
    ...
    x_train, x_test, y_train, y_test = train_test_split(x_tfidf8, df9["label"], train_size=i, stratify=df9["label"])
    ...
    print("===Logistic Regression with TfidfVectorizer Imbalanced - ", args.group, df9_l, i)
    lr_end = time.time()
    print('Logistic F1-score', fly * 100)
    print('Logistic ROCAUC score:', rocauc_lr * 100)
    print('Logistic Recall score:', recalls_lr * 100)
    ...
    print("===DecisionTreeClassifier with TfidfVectorizer Imbalanced - ", args.group, df9_l, i)
    dt_end = time.time()
    print('DCT F1-score', fdct * 100)
    print('DCT ROCAUC score:', rocauc_dt * 100)
    print('DCT Recall score:', recalls_dt * 100)
    ...
    nb_end = time.time()
    # Use accuracy_score function to get the accuracy
    print("===Naive Bayes with TfidfVectorizer Imabalanced - ", args.group, df9_l, i)
    print('Naive F1-score', fnb * 100)
    print('Naive ROCAUC score:', rocauc_nb * 100)
    print('Naive Recall score:', recalls_nb * 100)
    print('Naive Precision Score:', precisions_nb * 100)
    ...
    xg_end = time.time()
    print("===XGB with TfidfVectorizer Imbalanced - ", args.group, df9_l, i)
    print('XGB F1-Score', fxg * 100)
    print('XGB ROCAUC Score:', rocauc_xg * 100)
    print('XGB Recall score:', recall_xg * 100)
    print('XGB Precision Score:', precisions_xg * 100)
    ...
    rf_end = time.time()
    print("====RandomForest with Tfidf Imbalanced", args.group, df9_l, i)
    print('RFC F1 score', frfc * 100)
    print('RFC ROCAUC Score:', rocauc_rf * 100)
    print('RFC Recall score:', recalls_rf * 100)
    print('RFC Precision Score:', precisions_rf * 100)
    ...
    print("Array of Prob Scores LR-Imb:", df9_l, ":", probs_lr_scol8)
    print("Array of F1 Scores LR-Imb:", df9_l, ":", f1_lr_scol8)
    print("Array of ROCAUC Scores LR-Imb:", df9_l, ":", rocauc_lr_scol8)
    print("Array of Recall Scores LR-Imb:", df9_l, ":", recall_lr_scol8)
    print("Array of Precision Scores LR-Imb:", df9_l, ":", precision_lr_scol8)
    print("Array of Accuracy Scores LR-Imb:", df9_l, ":", accuracy_lr_scol8)

    print("Array of Prob Scores DT-Imb:", df9_l, ":", probs_dt_scol8)
    print("Array of F1 Scores DT-Imb:", df9_l, ":", f1_dt_scol8)
    print("Array of ROCAUC Scores DT-Imb:", df9_l, ":", rocauc_dt_scol8)
    print("Array of Recall Scores DT-Imb:", df9_l, ":", recall_dt_scol8)
    print("Array of Precision Scores DT-Imb:", df9_l, ":", precision_dt_scol8)
    print("Array of Accuracy Scores DT-Imb:", df9_l, ":", accuracy_dt_scol8)

    print("Array of Prob Scores NB-Imb:", df9_l, ":", probs_nb_scol8)
    print("Array of F1 Scores NB-Imb:", df9_l, ":", f1_nb_scol8)
    print("Array of ROCAUC Scores NB-Imb:", df9_l, ":", rocauc_nb_scol8)
    print("Array of Recall Scores NB-Imb:", df9_l, ":", recall_nb_scol8)
    print("Array of Precision Scores NB-Imb:", df9_l, ":", precision_nb_scol8)
    print("Array of Accuracy Scores NB-Imb:", df9_l, ":", accuracy_nb_scol8)

    print("Array of Prob Scores XG-Imb:", df9_l, ":", probs_xg_scol8)
    print("Array of F1 Scores XG-Imb:", df9_l, ":", f1_xg_scol8)
    print("Array of ROCAUC Scores XG-Imb:", df9_l, ":", rocauc_xg_scol8)
    print("Array of Recall Scores XG-Imb:", df9_l, ":", recall_xg_scol8)
    print("Array of Precision Scores XG-Imb:", df9_l, ":", precision_xg_scol8)
    print("Array of Accuracy Scores XG-Imb:", df9_l, ":", accuracy_xg_scol8)

    print("Array of Prob Scores RF-Imb:", df9_l, ":", probs_rf_scol8)
    print("Array of F1 Scores RF-Imb:", df9_l, ":", f1_rf_scol8)
    print("Array of ROCAUC Scores RF-Imb:", df9_l, ":", rocauc_rf_scol8)
    print("Array of Recall Scores RF-Imb:", df9_l, ":", recall_rf_scol8)
    print("Array of Precision Scores RF-Imb:", df9_l, ":", precision_rf_scol8)
    print("Array of Accuracy Scores RF-Imb:", df9_l, ":", accuracy_rf_scol8)

year8 = [args.group for t in range(25)]
sampling8 = ['Imbalanced' for t in range(25)]
technique8 = ['Imbalanced' for t in range(25)]
...
for i in train_values:
    ...
    x_train, x_test, y_train, y_test = train_test_split(x_tfidf9, df10["label"], train_size=i, stratify=df10["label"])
    ...
    print("===Logistic Regression with TfidfVectorizer Imbalanced - ", args.group, df10_l, i)
    lr_end = time.time()
    print('Logistic F1-score', fly * 100)
    print('Logistic ROCAUC score:', rocauc_lr * 100)
    print('Logistic Recall score:', recalls_lr * 100)
    ...
    print("===DecisionTreeClassifier with TfidfVectorizer Imbalanced - ", args.group, df10_l, i)
    dt_end = time.time()
    print('DCT F1-score', fdct * 100)
    print('DCT ROCAUC score:', rocauc_dt * 100)
    print('DCT Recall score:', recalls_dt * 100)
    ...
    nb_end = time.time()
    # Use accuracy_score function to get the accuracy
    print("===Naive Bayes with TfidfVectorizer Imabalanced - ", args.group, df10_l, i)
    print('Naive F1-score', fnb * 100)
    print('Naive ROCAUC score:', rocauc_nb * 100)
    print('Naive Recall score:', recalls_nb * 100)
    print('Naive Precision Score:', precisions_nb * 100)
    ...
    xg_end = time.time()
    print("===XGB with TfidfVectorizer Imbalanced - ", args.group, df10_l, i)
    print('XGB F1-Score', fxg * 100)
    print('XGB ROCAUC Score:', rocauc_xg * 100)
    print('XGB Recall score:', recall_xg * 100)
    print('XGB Precision Score:', precisions_xg * 100)
    ...
    rf_end = time.time()
    print("====RandomForest with Tfidf Imbalanced", args.group, df10_l, i)
    print('RFC F1 score', frfc * 100)
    print('RFC ROCAUC Score:', rocauc_rf * 100)
    print('RFC Recall score:', recalls_rf * 100)
    print('RFC Precision Score:', precisions_rf * 100)
    ...
    print("Array of Prob Scores LR-Imb:", df10_l, ":", probs_lr_scol9)
    print("Array of F1 Scores LR-Imb:", df10_l, ":", f1_lr_scol9)
    print("Array of ROCAUC Scores LR-Imb:", df10_l, ":", rocauc_lr_scol9)
    print("Array of Recall Scores LR-Imb:", df10_l, ":", recall_lr_scol9)
    print("Array of Precision Scores LR-Imb:", df10_l, ":", precision_lr_scol9)
    print("Array of Accuracy Scores LR-Imb:", df10_l, ":", accuracy_lr_scol9)

    print("Array of Prob Scores DT-Imb:", df10_l, ":", probs_dt_scol9)
    print("Array of F1 Scores DT-Imb:", df10_l, ":", f1_dt_scol9)
    print("Array of ROCAUC Scores DT-Imb:", df10_l, ":", rocauc_dt_scol9)
    print("Array of Recall Scores DT-Imb:", df10_l, ":", recall_dt_scol9)
    print("Array of Precision Scores DT-Imb:", df10_l, ":", precision_dt_scol9)
    print("Array of Accuracy Scores DT-Imb:", df10_l, ":", accuracy_dt_scol9)

    print("Array of Prob Scores NB-Imb:", df10_l, ":", probs_nb_scol9)
    print("Array of F1 Scores NB-Imb:", df10_l, ":", f1_nb_scol9)
    print("Array of ROCAUC Scores NB-Imb:", df10_l, ":", rocauc_nb_scol9)
    print("Array of Recall Scores NB-Imb:", df10_l, ":", recall_nb_scol9)
    print("Array of Precision Scores NB-Imb:", df10_l, ":", precision_nb_scol9)
    print("Array of Accuracy Scores NB-Imb:", df10_l, ":", accuracy_nb_scol9)

    print("Array of Prob Scores XG-Imb:", df10_l, ":", probs_xg_scol9)
    print("Array of F1 Scores XG-Imb:", df10_l, ":", f1_xg_scol9)
    print("Array of ROCAUC Scores XG-Imb:", df10_l, ":", rocauc_xg_scol9)
    print("Array of Recall Scores XG-Imb:", df10_l, ":", recall_xg_scol9)
    print("Array of Precision Scores XG-Imb:", df10_l, ":", precision_xg_scol9)
    print("Array of Accuracy Scores XG-Imb:", df10_l, ":", accuracy_xg_scol9)

    print("Array of Prob Scores RF-Imb:", df10_l, ":", probs_rf_scol9)
    print("Array of F1 Scores RF-Imb:", df10_l, ":", f1_rf_scol9)
    print("Array of ROCAUC Scores RF-Imb:", df10_l, ":", rocauc_rf_scol9)
    print("Array of Recall Scores RF-Imb:", df10_l, ":", recall_rf_scol9)
    print("Array of Precision Scores RF-Imb:", df10_l, ":", precision_rf_scol9)
    print("Array of Accuracy Scores RF-Imb:", df10_l, ":", accuracy_rf_scol9)

year9 = [args.group for t in range(25)]
sampling9 = ['Imbalanced' for t in range(25)]
technique9 = ['Imbalanced' for t in range(25)]
...
for i in train_values:
    ...
    x_train, x_test, y_train, y_test = train_test_split(x_tfidf10, df11["label"], train_size=i, stratify=df11["label"])
    ...
    print("===Logistic Regression with TfidfVectorizer Imbalanced - 1010", df11_l, i1)
    lr_end = time.time()
    print('Logistic F1-score', fly * 100)
    print('Logistic ROCAUC score:', rocauc_lr * 100)
    print('Logistic Recall score:', recalls_lr * 100)
    ...
    print("===DecisionTreeClassifier with TfidfVectorizer Imbalanced - 1010", df11_l, i1)
    dt_end = time.time()
    print('DCT F1-score', fdct * 100)
    print('DCT ROCAUC score:', rocauc_dt * 100)
    print('DCT Recall score:', recalls_dt * 100)
    ...
    nb_end = time.time()
    # Use accuracy_score function to get the accuracy
    print("===Naive Bayes with TfidfVectorizer Imabalanced - 1010", df11_l, i1)
    print('Naive F1-score', fnb * 100)
    print('Naive ROCAUC score:', rocauc_nb * 100)
    print('Naive Recall score:', recalls_nb * 100)
    print('Naive Precision Score:', precisions_nb * 100)
    ...
    xg_end = time.time()
    print("===XGB with TfidfVectorizer Imbalanced - 1010", df11_l, i1)
    print('XGB F1-Score', fxg * 100)
    print('XGB ROCAUC Score:', rocauc_xg * 100)
    print('XGB Recall score:', recall_xg * 100)
    print('XGB Precision Score:', precisions_xg * 100)
    ...
    rf_end = time.time()
    print("====RandomForest with Tfidf Imbalanced 1010", df11_l, i1)
    print('RFC F1 score', frfc * 100)
    print('RFC ROCAUC Score:', rocauc_rf * 100)
    print('RFC Recall score:', recalls_rf * 100)
    print('RFC Precision Score:', precisions_rf * 100)
    ...
    print("Array of Prob Scores LR-Imb:", df11_l, ":", probs_lr_scol10)
    print("Array of F1 Scores LR-Imb:", df11_l, ":", f1_lr_scol10)
    print("Array of ROCAUC Scores LR-Imb:", df11_l, ":", rocauc_lr_scol10)
    print("Array of Recall Scores LR-Imb:", df11_l, ":", recall_lr_scol10)
    print("Array of Precision Scores LR-Imb:", df11_l, ":", precision_lr_scol10)
    print("Array of Accuracy Scores LR-Imb:", df11_l, ":", accuracy_lr_scol10)

    print("Array of Prob Scores DT-Imb:", df11_l, ":", probs_dt_scol10)
    print("Array of F1 Scores DT-Imb:", df11_l, ":", f1_dt_scol10)
    print("Array of ROCAUC Scores DT-Imb:", df11_l, ":", rocauc_dt_scol10)
    print("Array of Recall Scores DT-Imb:", df11_l, ":", recall_dt_scol10)
    print("Array of Precision Scores DT-Imb:", df11_l, ":", precision_dt_scol10)
    print("Array of Accuracy Scores DT-Imb:", df11_l, ":", accuracy_dt_scol10)

    print("Array of Prob Scores NB-Imb:", df11_l, ":", probs_nb_scol10)
    print("Array of F1 Scores NB-Imb:", df11_l, ":", f1_nb_scol10)
    print("Array of ROCAUC Scores NB-Imb:", df11_l, ":", rocauc_nb_scol10)
    print("Array of Recall Scores NB-Imb:", df11_l, ":", recall_nb_scol10)
    print("Array of Precision Scores NB-Imb:", df11_l, ":", precision_nb_scol10)
    print("Array of Accuracy Scores NB-Imb:", df11_l, ":", accuracy_nb_scol10)

    print("Array of Prob Scores XG-Imb:", df11_l, ":", probs_xg_scol10)
    print("Array of F1 Scores XG-Imb:", df11_l, ":", f1_xg_scol10)
    print("Array of ROCAUC Scores XG-Imb:", df11_l, ":", rocauc_xg_scol10)
    print("Array of Recall Scores XG-Imb:", df11_l, ":", recall_xg_scol10)
    print("Array of Precision Scores XG-Imb:", df11_l, ":", precision_xg_scol10)
    print("Array of Accuracy Scores XG-Imb:", df11_l, ":", accuracy_xg_scol10)

    print("Array of Prob Scores RF-Imb:", df11_l, ":", probs_rf_scol10)
    print("Array of F1 Scores RF-Imb:", df11_l, ":", f1_rf_scol10)
    print("Array of ROCAUC Scores RF-Imb:", df11_l, ":", rocauc_rf_scol10)
    print("Array of Recall Scores RF-Imb:", df11_l, ":", recall_rf_scol10)
    print("Array of Precision Scores RF-Imb:", df11_l, ":", precision_rf_scol10)
    print("Array of Accuracy Scores RF-Imb:", df11_l, ":", accuracy_rf_scol10)
    

year10 = [args.group for t in range(25)]
sampling10 = ['Imbalanced' for t in range(25)]
technique10 = ['Imbalanced' for t in range(25)]
...
#precision_imb101b = list([precision_lr_scol20[0], precision_dt_scol20[0], precision_rf_scol20[0], precision_nb_scol20[0], precision_xg_scol20[0]])
precision_imb101 = list([test_sizes[10], precision_xg_scol20[0], precision_rf_scol20[0], precision_dt_scol20[0], precision_lr_scol20[0], precision_nb_scol20[0]])
#precision_imb101 = list([(test_sizes[10] - test_sizes[10]), (0.0 + precision_rf_scol20[0]), (1.0 + precision_xg_scol20[0]),(2.0 + precision_dt_scol20[0]), (3.0 + precision_lr_scol20[0]), (4.0 + precision_nb_scol20[0])])
print("Iteration 1 Array:", precision_imb101)
# precision_imb102 = list([precision_lr_scol20[1], precision_dt_scol20[1], precision_rf_scol20[1], precision_nb_scol20[1], precision_xg_scol20[1]])
precision_imb102 = list([test_sizes[10], precision_xg_scol20[1], precision_rf_scol20[1], precision_dt_scol20[1],  precision_lr_scol20[1], precision_nb_scol20[1]])
#precision_imb102 = list([(test_sizes[10] - test_sizes[10]), (0.0 + precision_rf_scol20[1]), (1.0 + precision_xg_scol20[1]),(2.0 + precision_dt_scol20[1]), (3.0 + precision_lr_scol20[1]), (4.0 + precision_nb_scol20[1])])
print("Iteration 2 Array:", precision_imb102)
precision_imb103 = list([test_sizes[10], precision_lr_scol20[2], precision_dt_scol20[2], precision_rf_scol20[2], precision_nb_scol20[2], precision_xg_scol20[2]] )
precision_imb104 = list([test_sizes[10], precision_lr_scol20[3], precision_dt_scol20[3], precision_rf_scol20[3], precision_nb_scol20[3], precision_xg_scol20[3]] )
precision_imb105 = list([test_sizes[10], precision_lr_scol20[4], precision_dt_scol20[4], precision_rf_scol20[4], precision_nb_scol20[4], precision_xg_scol20[4]] )
precision_imb106 = list([test_sizes[10], precision_lr_scol20[5], precision_dt_scol20[5], precision_rf_scol20[5], precision_nb_scol20[5], precision_xg_scol20[5]] )
precision_imb107 = list([test_sizes[10], precision_lr_scol20[6], precision_dt_scol20[6], precision_rf_scol20[6], precision_nb_scol20[6], precision_xg_scol20[6]] )
precision_imb108 = list([test_sizes[10], precision_lr_scol20[7], precision_dt_scol20[7], precision_rf_scol20[7], precision_nb_scol20[7], precision_xg_scol20[7]] )
precision_imb109 = list([test_sizes[10], precision_lr_scol20[8], precision_dt_scol20[8], precision_rf_scol20[8], precision_nb_scol20[8], precision_xg_scol20[8]] )
precision_imb110 = list([test_sizes[10], precision_lr_scol20[9], precision_dt_scol20[9], precision_rf_scol20[9], precision_nb_scol20[9], precision_xg_scol20[9]] )

# Recall - 10 test size
#recall_imb101b = list([recall_lr_scol20[0], recall_dt_scol20[0], recall_rf_scol20[0], recall_nb_scol20[0], recall_xg_scol20[0]])
recall_imb101 = list([test_sizes[10], recall_xg_scol20[0], recall_rf_scol20[0], recall_dt_scol20[0], recall_lr_scol20[0], recall_nb_scol20[0]])
# recall_imb101 = list([(test_sizes[10] - test_sizes[10]), (0.0 + recall_rf_scol20[0]), (1.0 + recall_xg_scol20[0]),(2.0 + recall_dt_scol20[0]), (3.0 + recall_lr_scol20[0]), (4.0 + recall_nb_scol20[0])])
print("Iteration 1 Array:", recall_imb101)
# recall_imb = list([recall_lr_scol20[1], recall_dt_scol20[1], recall_rf_scol20[1], recall_nb_scol20[1], recall_xg_scol20[1]])
recall_imb102 = list([test_sizes[10], recall_xg_scol20[1], recall_rf_scol20[1], recall_dt_scol20[1],  recall_lr_scol20[1], recall_nb_scol20[1]])
#recall_imb102 = list([(test_sizes[10] - test_sizes[10]), (0.0 + recall_rf_scol20[1]), (1.0 + recall_xg_scol20[1]),(2.0 + recall_dt_scol20[1]), (3.0 + recall_lr_scol20[1]), (4.0 + recall_nb_scol20[1])])
print("Iteration 2 Array:", recall_imb102)

recall_imb103 = list([test_sizes[10], recall_lr_scol20[2], recall_dt_scol20[2], recall_rf_scol20[2], recall_nb_scol20[2], recall_xg_scol20[2]] )
recall_imb104 = list([test_sizes[10], recall_lr_scol20[3], recall_dt_scol20[3], recall_rf_scol20[3], recall_nb_scol20[3], recall_xg_scol20[3]] )
recall_imb105 = list([test_sizes[10], recall_lr_scol20[4], recall_dt_scol20[4], recall_rf_scol20[4], recall_nb_scol20[4], recall_xg_scol20[4]] )
recall_imb106 = list([test_sizes[10], recall_lr_scol20[5], recall_dt_scol20[5], recall_rf_scol20[5], recall_nb_scol20[5], recall_xg_scol20[5]] )
recall_imb107 = list([test_sizes[10], recall_lr_scol20[6], recall_dt_scol20[6], recall_rf_scol20[6], recall_nb_scol20[6], recall_xg_scol20[6]] )
recall_imb108 = list([test_sizes[10], recall_lr_scol20[7], recall_dt_scol20[7], recall_rf_scol20[7], recall_nb_scol20[7], recall_xg_scol20[7]] )
recall_imb109 = list([test_sizes[10], recall_lr_scol20[8], recall_dt_scol20[8], recall_rf_scol20[8], recall_nb_scol20[8], recall_xg_scol20[8]] )
recall_imb110 = list([test_sizes[10], recall_lr_scol20[9], recall_dt_scol20[9], recall_rf_scol20[9], recall_nb_scol20[9], recall_xg_scol20[9]] )
...
for i in train_values:
    ...
    x_train, x_test, y_train, y_test = train_test_split(x_tfidf11, df12["label"], train_size=i, stratify=df12["label"])
    ...
    print("===Logistic Regression with TfidfVectorizer Imbalanced - ", args.group, df12_l, i)
    lr_end = time.time()
    print('Logistic F1-score', fly * 100)
    print('Logistic ROCAUC score:', rocauc_lr * 100)
    print('Logistic Recall score:', recalls_lr * 100)
    ...
    print("===DecisionTreeClassifier with TfidfVectorizer Imbalanced - ", args.group, df12_l, i)
    dt_end = time.time()
    print('DCT F1-score', fdct * 100)
    print('DCT ROCAUC score:', rocauc_dt * 100)
    print('DCT Recall score:', recalls_dt * 100)
    ...
    nb_end = time.time()
    # Use accuracy_score function to get the accuracy
    print("===Naive Bayes with TfidfVectorizer Imabalanced - ", args.group, df12_l, i)
    print('Naive F1-score', fnb * 100)
    print('Naive ROCAUC score:', rocauc_nb * 100)
    print('Naive Recall score:', recalls_nb * 100)
    print('Naive Precision Score:', precisions_nb * 100)
    ...
    xg_end = time.time()
    print("===XGB with TfidfVectorizer Imbalanced - ", args.group, df12_l, i)
    print('XGB F1-Score', fxg * 100)
    print('XGB ROCAUC Score:', rocauc_xg * 100)
    print('XGB Recall score:', recall_xg * 100)
    print('XGB Precision Score:', precisions_xg * 100)
    ...
    rf_end = time.time()
    print("====RandomForest with Tfidf Imbalanced", args.group, df12_l, i)
    print('RFC F1 score', frfc * 100)
    print('RFC ROCAUC Score:', rocauc_rf * 100)
    print('RFC Recall score:', recalls_rf * 100)
    print('RFC Precision Score:', precisions_rf * 100)
    ...
    print("Array of Prob Scores LR-Imb:", df12_l, ":", probs_lr_scol11)
    print("Array of F1 Scores LR-Imb:", df12_l, ":", f1_lr_scol11)
    print("Array of ROCAUC Scores LR-Imb:", df12_l, ":", rocauc_lr_scol11)
    print("Array of Recall Scores LR-Imb:", df12_l, ":", recall_lr_scol11)
    print("Array of Precision Scores LR-Imb:", df12_l, ":", precision_lr_scol11)
    print("Array of Accuracy Scores LR-Imb:", df12_l, ":", accuracy_lr_scol11)

    print("Array of Prob Scores DT-Imb:", df12_l, ":", probs_dt_scol11)
    print("Array of F1 Scores DT-Imb:", df12_l, ":", f1_dt_scol11)
    print("Array of ROCAUC Scores DT-Imb:", df12_l, ":", rocauc_dt_scol11)
    print("Array of Recall Scores DT-Imb:", df12_l, ":", recall_dt_scol11)
    print("Array of Precision Scores DT-Imb:", df12_l, ":", precision_dt_scol11)
    print("Array of Accuracy Scores DT-Imb:", df12_l, ":", accuracy_dt_scol11)

    print("Array of Prob Scores NB-Imb:", df12_l, ":", probs_nb_scol11)
    print("Array of F1 Scores NB-Imb:", df12_l, ":", f1_nb_scol11)
    print("Array of ROCAUC Scores NB-Imb:", df12_l, ":", rocauc_nb_scol11)
    print("Array of Recall Scores NB-Imb:", df12_l, ":", recall_nb_scol11)
    print("Array of Precision Scores NB-Imb:", df12_l, ":", precision_nb_scol11)
    print("Array of Accuracy Scores NB-Imb:", df12_l, ":", accuracy_nb_scol11)

    print("Array of Prob Scores XG-Imb:", df12_l, ":", probs_xg_scol11)
    print("Array of F1 Scores XG-Imb:", df12_l, ":", f1_xg_scol11)
    print("Array of ROCAUC Scores XG-Imb:", df12_l, ":", rocauc_xg_scol11)
    print("Array of Recall Scores XG-Imb:", df12_l, ":", recall_xg_scol11)
    print("Array of Precision Scores XG-Imb:", df12_l, ":", precision_xg_scol11)
    print("Array of Accuracy Scores XG-Imb:", df12_l, ":", accuracy_xg_scol11)

    print("Array of Prob Scores RF-Imb:", df12_l, ":", probs_rf_scol11)
    print("Array of F1 Scores RF-Imb:", df12_l, ":", f1_rf_scol11)
    print("Array of ROCAUC Scores RF-Imb:", df12_l, ":", rocauc_rf_scol11)
    print("Array of Recall Scores RF-Imb:", df12_l, ":", recall_rf_scol11)
    print("Array of Precision Scores RF-Imb:", df12_l, ":", precision_rf_scol11)
    print("Array of Accuracy Scores RF-Imb:", df12_l, ":", accuracy_rf_scol11)

year11 = [args.group for t in range(25)]
sampling11 = ['Imbalanced' for t in range(25)]
technique11 = ['Imbalanced' for t in range(25)]
...
for i in train_values:
    ...
    x_train, x_test, y_train, y_test = train_test_split(x_tfidf12, df13["label"], train_size=i, stratify=df13["label"])
    ...
    print("===Logistic Regression with TfidfVectorizer Imbalanced - ", args.group, df13_l, i)
    lr_end = time.time()
    print('Logistic F1-score', fly * 100)
    print('Logistic ROCAUC score:', rocauc_lr * 100)
    print('Logistic Recall score:', recalls_lr * 100)
    ...
    print("===DecisionTreeClassifier with TfidfVectorizer Imbalanced - ", args.group, df13_l, i)
    dt_end = time.time()
    print('DCT F1-score', fdct * 100)
    print('DCT ROCAUC score:', rocauc_dt * 100)
    print('DCT Recall score:', recalls_dt * 100)
    ...
    nb_end = time.time()
    # Use accuracy_score function to get the accuracy
    print("===Naive Bayes with TfidfVectorizer Imabalanced - ", args.group, df13_l, i)
    print('Naive F1-score', fnb * 100)
    print('Naive ROCAUC score:', rocauc_nb * 100)
    print('Naive Recall score:', recalls_nb * 100)
    print('Naive Precision Score:', precisions_nb * 100)
    ...
    xg_end = time.time()
    print("===XGB with TfidfVectorizer Imbalanced - ", args.group, df13_l, i)
    print('XGB F1-Score', fxg * 100)
    print('XGB ROCAUC Score:', rocauc_xg * 100)
    print('XGB Recall score:', recall_xg * 100)
    print('XGB Precision Score:', precisions_xg * 100)
    ...
    rf_end = time.time()
    print("====RandomForest with Tfidf Imbalanced", args.group, df13_l, i)
    print('RFC F1 score', frfc * 100)
    print('RFC ROCAUC Score:', rocauc_rf * 100)
    print('RFC Recall score:', recalls_rf * 100)
    print('RFC Precision Score:', precisions_rf * 100)
    ...
    print("Array of Prob Scores LR-Imb:", df13_l, ":", probs_lr_scol12)
    print("Array of F1 Scores LR-Imb:", df13_l, ":", f1_lr_scol12)
    print("Array of ROCAUC Scores LR-Imb:", df13_l, ":", rocauc_lr_scol12)
    print("Array of Recall Scores LR-Imb:", df13_l, ":", recall_lr_scol12)
    print("Array of Precision Scores LR-Imb:", df13_l, ":", precision_lr_scol12)
    print("Array of Accuracy Scores LR-Imb:", df13_l, ":", accuracy_lr_scol12)

    print("Array of Prob Scores DT-Imb:", df13_l, ":", probs_dt_scol12)
    print("Array of F1 Scores DT-Imb:", df13_l, ":", f1_dt_scol12)
    print("Array of ROCAUC Scores DT-Imb:", df13_l, ":", rocauc_dt_scol12)
    print("Array of Recall Scores DT-Imb:", df13_l, ":", recall_dt_scol12)
    print("Array of Precision Scores DT-Imb:", df13_l, ":", precision_dt_scol12)
    print("Array of Accuracy Scores DT-Imb:", df13_l, ":", accuracy_dt_scol12)

    print("Array of Prob Scores NB-Imb:", df13_l, ":", probs_nb_scol12)
    print("Array of F1 Scores NB-Imb:", df13_l, ":", f1_nb_scol12)
    print("Array of ROCAUC Scores NB-Imb:", df13_l, ":", rocauc_nb_scol12)
    print("Array of Recall Scores NB-Imb:", df13_l, ":", recall_nb_scol12)
    print("Array of Precision Scores NB-Imb:", df13_l, ":", precision_nb_scol12)
    print("Array of Accuracy Scores NB-Imb:", df13_l, ":", accuracy_nb_scol12)

    print("Array of Prob Scores XG-Imb:", df13_l, ":", probs_xg_scol12)
    print("Array of F1 Scores XG-Imb:", df13_l, ":", f1_xg_scol12)
    print("Array of ROCAUC Scores XG-Imb:", df13_l, ":", rocauc_xg_scol12)
    print("Array of Recall Scores XG-Imb:", df13_l, ":", recall_xg_scol12)
    print("Array of Precision Scores XG-Imb:", df13_l, ":", precision_xg_scol12)
    print("Array of Accuracy Scores XG-Imb:", df13_l, ":", accuracy_xg_scol12)

    print("Array of Prob Scores RF-Imb:", df13_l, ":", probs_rf_scol12)
    print("Array of F1 Scores RF-Imb:", df13_l, ":", f1_rf_scol12)
    print("Array of ROCAUC Scores RF-Imb:", df13_l, ":", rocauc_rf_scol12)
    print("Array of Recall Scores RF-Imb:", df13_l, ":", recall_rf_scol12)
    print("Array of Precision Scores RF-Imb:", df13_l, ":", precision_rf_scol12)
    print("Array of Accuracy Scores RF-Imb:", df13_l, ":", accuracy_rf_scol12)

year12 = [args.group for t in range(25)]
sampling12 = ['Imbalanced' for t in range(25)]
technique12 = ['Imbalanced' for t in range(25)]
...
for i in train_values:
    ...
    x_train, x_test, y_train, y_test = train_test_split(x_tfidf13, df14["label"], train_size=i, stratify=df14["label"])
    ...
    print("===Logistic Regression with TfidfVectorizer Imbalanced - ", args.group, df14_l, i)
    lr_end = time.time()
    print('Logistic F1-score', fly * 100)
    print('Logistic ROCAUC score:', rocauc_lr * 100)
    print('Logistic Recall score:', recalls_lr * 100)
    ...
    print("===DecisionTreeClassifier with TfidfVectorizer Imbalanced - ", args.group, df14_l, i)
    dt_end = time.time()
    print('DCT F1-score', fdct * 100)
    print('DCT ROCAUC score:', rocauc_dt * 100)
    print('DCT Recall score:', recalls_dt * 100)
    ...
    nb_end = time.time()
    # Use accuracy_score function to get the accuracy
    print("===Naive Bayes with TfidfVectorizer Imabalanced - ", args.group, df14_l, i)
    print('Naive F1-score', fnb * 100)
    print('Naive ROCAUC score:', rocauc_nb * 100)
    print('Naive Recall score:', recalls_nb * 100)
    print('Naive Precision Score:', precisions_nb * 100)
    ...
    xg_end = time.time()
    print("===XGB with TfidfVectorizer Imbalanced - ", args.group, df14_l, i)
    print('XGB F1-Score', fxg * 100)
    print('XGB ROCAUC Score:', rocauc_xg * 100)
    print('XGB Recall score:', recall_xg * 100)
    print('XGB Precision Score:', precisions_xg * 100)
    ...
    rf_end = time.time()
    print("====RandomForest with Tfidf Imbalanced", args.group, df14_l, i)
    print('RFC F1 score', frfc * 100)
    print('RFC ROCAUC Score:', rocauc_rf * 100)
    print('RFC Recall score:', recalls_rf * 100)
    print('RFC Precision Score:', precisions_rf * 100)
    ...
    print("Array of Prob Scores LR-Imb:", df14_l, ":", probs_lr_scol13)
    print("Array of F1 Scores LR-Imb:", df14_l, ":", f1_lr_scol13)
    print("Array of ROCAUC Scores LR-Imb:", df14_l, ":", rocauc_lr_scol13)
    print("Array of Recall Scores LR-Imb:", df14_l, ":", recall_lr_scol13)
    print("Array of Precision Scores LR-Imb:", df14_l, ":", precision_lr_scol13)
    print("Array of Accuracy Scores LR-Imb:", df14_l, ":", accuracy_lr_scol13)

    print("Array of Prob Scores DT-Imb:", df14_l, ":", probs_dt_scol13)
    print("Array of F1 Scores DT-Imb:", df14_l, ":", f1_dt_scol13)
    print("Array of ROCAUC Scores DT-Imb:", df14_l, ":", rocauc_dt_scol13)
    print("Array of Recall Scores DT-Imb:", df14_l, ":", recall_dt_scol13)
    print("Array of Precision Scores DT-Imb:", df14_l, ":", precision_dt_scol13)
    print("Array of Accuracy Scores DT-Imb:", df14_l, ":", accuracy_dt_scol13)

    print("Array of Prob Scores NB-Imb:", df14_l, ":", probs_nb_scol13)
    print("Array of F1 Scores NB-Imb:", df14_l, ":", f1_nb_scol13)
    print("Array of ROCAUC Scores NB-Imb:", df14_l, ":", rocauc_nb_scol13)
    print("Array of Recall Scores NB-Imb:", df14_l, ":", recall_nb_scol13)
    print("Array of Precision Scores NB-Imb:", df14_l, ":", precision_nb_scol13)
    print("Array of Accuracy Scores NB-Imb:", df14_l, ":", accuracy_nb_scol13)

    print("Array of Prob Scores XG-Imb:", df14_l, ":", probs_xg_scol13)
    print("Array of F1 Scores XG-Imb:", df14_l, ":", f1_xg_scol13)
    print("Array of ROCAUC Scores XG-Imb:", df14_l, ":", rocauc_xg_scol13)
    print("Array of Recall Scores XG-Imb:", df14_l, ":", recall_xg_scol13)
    print("Array of Precision Scores XG-Imb:", df14_l, ":", precision_xg_scol13)
    print("Array of Accuracy Scores XG-Imb:", df14_l, ":", accuracy_xg_scol13)

    print("Array of Prob Scores RF-Imb:", df14_l, ":", probs_rf_scol13)
    print("Array of F1 Scores RF-Imb:", df14_l, ":", f1_rf_scol13)
    print("Array of ROCAUC Scores RF-Imb:", df14_l, ":", rocauc_rf_scol13)
    print("Array of Recall Scores RF-Imb:", df14_l, ":", recall_rf_scol13)
    print("Array of Precision Scores RF-Imb:", df14_l, ":", precision_rf_scol13)
    print("Array of Accuracy Scores RF-Imb:", df14_l, ":", accuracy_rf_scol13)

year13 = [args.group for t in range(25)]
sampling13 = ['Imbalanced' for t in range(25)]
technique13 = ['Imbalanced' for t in range(25)]
...
for i in train_values:
    ...
    x_train, x_test, y_train, y_test = train_test_split(x_tfidf14, df15["label"], train_size=i, stratify=df15["label"])
    ...
    print("===Logistic Regression with TfidfVectorizer Imbalanced - ", args.group, df15_l, i)
    lr_end = time.time()
    print('Logistic F1-score', fly * 100)
    print('Logistic ROCAUC score:', rocauc_lr * 100)
    print('Logistic Recall score:', recalls_lr * 100)
    ...
    print("===DecisionTreeClassifier with TfidfVectorizer Imbalanced - ", args.group, df15_l, i)
    dt_end = time.time()
    print('DCT F1-score', fdct * 100)
    print('DCT ROCAUC score:', rocauc_dt * 100)
    print('DCT Recall score:', recalls_dt * 100)
    ...
    nb_end = time.time()
    # Use accuracy_score function to get the accuracy
    print("===Naive Bayes with TfidfVectorizer Imabalanced - ", args.group, df15_l, i)
    print('Naive F1-score', fnb * 100)
    print('Naive ROCAUC score:', rocauc_nb * 100)
    print('Naive Recall score:', recalls_nb * 100)
    print('Naive Precision Score:', precisions_nb * 100)
    ...
    xg_end = time.time()
    print("===XGB with TfidfVectorizer Imbalanced - ", args.group, df15_l, i)
    print('XGB F1-Score', fxg * 100)
    print('XGB ROCAUC Score:', rocauc_xg * 100)
    print('XGB Recall score:', recall_xg * 100)
    print('XGB Precision Score:', precisions_xg * 100)
    ...
    rf_end = time.time()
    print("====RandomForest with Tfidf Imbalanced", args.group, df15_l, i)
    print('RFC F1 score', frfc * 100)
    print('RFC ROCAUC Score:', rocauc_rf * 100)
    print('RFC Recall score:', recalls_rf * 100)
    print('RFC Precision Score:', precisions_rf * 100)
    ...
    print("Array of Prob Scores LR-Imb:", df15_l, ":", probs_lr_scol14)
    print("Array of F1 Scores LR-Imb:", df15_l, ":", f1_lr_scol14)
    print("Array of ROCAUC Scores LR-Imb:", df15_l, ":", rocauc_lr_scol14)
    print("Array of Recall Scores LR-Imb:", df15_l, ":", recall_lr_scol14)
    print("Array of Precision Scores LR-Imb:", df15_l, ":", precision_lr_scol14)
    print("Array of Accuracy Scores LR-Imb:", df15_l, ":", accuracy_lr_scol14)

    print("Array of Prob Scores DT-Imb:", df15_l, ":", probs_dt_scol14)
    print("Array of F1 Scores DT-Imb:", df15_l, ":", f1_dt_scol14)
    print("Array of ROCAUC Scores DT-Imb:", df15_l, ":", rocauc_dt_scol14)
    print("Array of Recall Scores DT-Imb:", df15_l, ":", recall_dt_scol14)
    print("Array of Precision Scores DT-Imb:", df15_l, ":", precision_dt_scol14)
    print("Array of Accuracy Scores DT-Imb:", df15_l, ":", accuracy_dt_scol14)

    print("Array of Prob Scores NB-Imb:", df15_l, ":", probs_nb_scol14)
    print("Array of F1 Scores NB-Imb:", df15_l, ":", f1_nb_scol14)
    print("Array of ROCAUC Scores NB-Imb:", df15_l, ":", rocauc_nb_scol14)
    print("Array of Recall Scores NB-Imb:", df15_l, ":", recall_nb_scol14)
    print("Array of Precision Scores NB-Imb:", df15_l, ":", precision_nb_scol14)
    print("Array of Accuracy Scores NB-Imb:", df15_l, ":", accuracy_nb_scol14)

    print("Array of Prob Scores XG-Imb:", df15_l, ":", probs_xg_scol14)
    print("Array of F1 Scores XG-Imb:", df15_l, ":", f1_xg_scol14)
    print("Array of ROCAUC Scores XG-Imb:", df15_l, ":", rocauc_xg_scol14)
    print("Array of Recall Scores XG-Imb:", df15_l, ":", recall_xg_scol14)
    print("Array of Precision Scores XG-Imb:", df15_l, ":", precision_xg_scol14)
    print("Array of Accuracy Scores XG-Imb:", df15_l, ":", accuracy_xg_scol14)

    print("Array of Prob Scores RF-Imb:", df15_l, ":", probs_rf_scol14)
    print("Array of F1 Scores RF-Imb:", df15_l, ":", f1_rf_scol14)
    print("Array of ROCAUC Scores RF-Imb:", df15_l, ":", rocauc_rf_scol14)
    print("Array of Recall Scores RF-Imb:", df15_l, ":", recall_rf_scol14)
    print("Array of Precision Scores RF-Imb:", df15_l, ":", precision_rf_scol14)
    print("Array of Accuracy Scores RF-Imb:", df15_l, ":", accuracy_rf_scol14)

year14 = [args.group for t in range(25)]
sampling14 = ['Imbalanced' for t in range(25)]
technique14 = ['Imbalanced' for t in range(25)]
...
for i in train_values:
    ...
    x_train, x_test, y_train, y_test = train_test_split(x_tfidf15, df16["label"], train_size=i, stratify=df16["label"])
    ...
    print("===Logistic Regression with TfidfVectorizer Imbalanced - ", args.group, df16_l, i)
    lr_end = time.time()
    print('Logistic F1-score', fly * 100)
    print('Logistic ROCAUC score:', rocauc_lr * 100)
    print('Logistic Recall score:', recalls_lr * 100)
    ...
    print("===DecisionTreeClassifier with TfidfVectorizer Imbalanced - ", args.group, df16_l, i)
    dt_end = time.time()
    print('DCT F1-score', fdct * 100)
    print('DCT ROCAUC score:', rocauc_dt * 100)
    print('DCT Recall score:', recalls_dt * 100)
    ...
    nb_end = time.time()
    # Use accuracy_score function to get the accuracy
    print("===Naive Bayes with TfidfVectorizer Imabalanced - ", args.group, df16_l, i)
    print('Naive F1-score', fnb * 100)
    print('Naive ROCAUC score:', rocauc_nb * 100)
    print('Naive Recall score:', recalls_nb * 100)
    print('Naive Precision Score:', precisions_nb * 100)
    ...
    xg_end = time.time()
    print("===XGB with TfidfVectorizer Imbalanced - ", args.group, df16_l, i)
    print('XGB F1-Score', fxg * 100)
    print('XGB ROCAUC Score:', rocauc_xg * 100)
    print('XGB Recall score:', recall_xg * 100)
    print('XGB Precision Score:', precisions_xg * 100)
    ...
    rf_end = time.time()
    print("====RandomForest with Tfidf Imbalanced", args.group, df16_l, i)
    print('RFC F1 score', frfc * 100)
    print('RFC ROCAUC Score:', rocauc_rf * 100)
    print('RFC Recall score:', recalls_rf * 100)
    print('RFC Precision Score:', precisions_rf * 100)
    ...
    print("Array of Prob Scores LR-Imb:", df16_l, ":", probs_lr_scol15)
    print("Array of F1 Scores LR-Imb:", df16_l, ":", f1_lr_scol15)
    print("Array of ROCAUC Scores LR-Imb:", df16_l, ":", rocauc_lr_scol15)
    print("Array of Recall Scores LR-Imb:", df16_l, ":", recall_lr_scol15)
    print("Array of Precision Scores LR-Imb:", df16_l, ":", precision_lr_scol15)
    print("Array of Accuracy Scores LR-Imb:", df16_l, ":", accuracy_lr_scol15)

    print("Array of Prob Scores DT-Imb:", df16_l, ":", probs_dt_scol15)
    print("Array of F1 Scores DT-Imb:", df16_l, ":", f1_dt_scol15)
    print("Array of ROCAUC Scores DT-Imb:", df16_l, ":", rocauc_dt_scol15)
    print("Array of Recall Scores DT-Imb:", df16_l, ":", recall_dt_scol15)
    print("Array of Precision Scores DT-Imb:", df16_l, ":", precision_dt_scol15)
    print("Array of Accuracy Scores DT-Imb:", df16_l, ":", accuracy_dt_scol15)

    print("Array of Prob Scores NB-Imb:", df16_l, ":", probs_nb_scol15)
    print("Array of F1 Scores NB-Imb:", df16_l, ":", f1_nb_scol15)
    print("Array of ROCAUC Scores NB-Imb:", df16_l, ":", rocauc_nb_scol15)
    print("Array of Recall Scores NB-Imb:", df16_l, ":", recall_nb_scol15)
    print("Array of Precision Scores NB-Imb:", df16_l, ":", precision_nb_scol15)
    print("Array of Accuracy Scores NB-Imb:", df16_l, ":", accuracy_nb_scol15)

    print("Array of Prob Scores XG-Imb:", df16_l, ":", probs_xg_scol15)
    print("Array of F1 Scores XG-Imb:", df16_l, ":", f1_xg_scol15)
    print("Array of ROCAUC Scores XG-Imb:", df16_l, ":", rocauc_xg_scol15)
    print("Array of Recall Scores XG-Imb:", df16_l, ":", recall_xg_scol15)
    print("Array of Precision Scores XG-Imb:", df16_l, ":", precision_xg_scol15)
    print("Array of Accuracy Scores XG-Imb:", df16_l, ":", accuracy_xg_scol15)

    print("Array of Prob Scores RF-Imb:", df16_l, ":", probs_rf_scol15)
    print("Array of F1 Scores RF-Imb:", df16_l, ":", f1_rf_scol15)
    print("Array of ROCAUC Scores RF-Imb:", df16_l, ":", rocauc_rf_scol15)
    print("Array of Recall Scores RF-Imb:", df16_l, ":", recall_rf_scol15)
    print("Array of Precision Scores RF-Imb:", df16_l, ":", precision_rf_scol15)
    print("Array of Accuracy Scores RF-Imb:", df16_l, ":", accuracy_rf_scol15)
    

year15 = [args.group for t in range(25)]
sampling15 = ['Imbalanced' for t in range(25)]
technique15 = ['Imbalanced' for t in range(25)]
...
for i in train_values:
    ...
    x_train, x_test, y_train, y_test = train_test_split(x_tfidf16, df17["label"], train_size=i, stratify=df17["label"])
    ...
    print("===Logistic Regression with TfidfVectorizer Imbalanced - ", args.group, df17_l, i)
    lr_end = time.time()
    print('Logistic F1-score', fly * 100)
    print('Logistic ROCAUC score:', rocauc_lr * 100)
    print('Logistic Recall score:', recalls_lr * 100)
    ...
    print("===DecisionTreeClassifier with TfidfVectorizer Imbalanced - ", args.group, df17_l, i)
    dt_end = time.time()
    print('DCT F1-score', fdct * 100)
    print('DCT ROCAUC score:', rocauc_dt * 100)
    print('DCT Recall score:', recalls_dt * 100)
    ...
    nb_end = time.time()
    # Use accuracy_score function to get the accuracy
    print("===Naive Bayes with TfidfVectorizer Imabalanced - ", args.group, df17_l, i)
    print('Naive F1-score', fnb * 100)
    print('Naive ROCAUC score:', rocauc_nb * 100)
    print('Naive Recall score:', recalls_nb * 100)
    print('Naive Precision Score:', precisions_nb * 100)
    ...
    xg_end = time.time()
    print("===XGB with TfidfVectorizer Imbalanced - ", args.group, df17_l, i)
    print('XGB F1-Score', fxg * 100)
    print('XGB ROCAUC Score:', rocauc_xg * 100)
    print('XGB Recall score:', recall_xg * 100)
    print('XGB Precision Score:', precisions_xg * 100)
    ...
    rf_end = time.time()
    print("====RandomForest with Tfidf Imbalanced", args.group, df17_l, i)
    print('RFC F1 score', frfc * 100)
    print('RFC ROCAUC Score:', rocauc_rf * 100)
    print('RFC Recall score:', recalls_rf * 100)
    print('RFC Precision Score:', precisions_rf * 100)
    ...
    print("Array of Prob Scores LR-Imb:", df17_l, ":", probs_lr_scol16)
    print("Array of F1 Scores LR-Imb:", df17_l, ":", f1_lr_scol16)
    print("Array of ROCAUC Scores LR-Imb:", df17_l, ":", rocauc_lr_scol16)
    print("Array of Recall Scores LR-Imb:", df17_l, ":", recall_lr_scol16)
    print("Array of Precision Scores LR-Imb:", df17_l, ":", precision_lr_scol16)
    print("Array of Accuracy Scores LR-Imb:", df17_l, ":", accuracy_lr_scol16)

    print("Array of Prob Scores DT-Imb:", df17_l, ":", probs_dt_scol16)
    print("Array of F1 Scores DT-Imb:", df17_l, ":", f1_dt_scol16)
    print("Array of ROCAUC Scores DT-Imb:", df17_l, ":", rocauc_dt_scol16)
    print("Array of Recall Scores DT-Imb:", df17_l, ":", recall_dt_scol16)
    print("Array of Precision Scores DT-Imb:", df17_l, ":", precision_dt_scol16)
    print("Array of Accuracy Scores DT-Imb:", df17_l, ":", accuracy_dt_scol16)

    print("Array of Prob Scores NB-Imb:", df17_l, ":", probs_nb_scol16)
    print("Array of F1 Scores NB-Imb:", df17_l, ":", f1_nb_scol16)
    print("Array of ROCAUC Scores NB-Imb:", df17_l, ":", rocauc_nb_scol16)
    print("Array of Recall Scores NB-Imb:", df17_l, ":", recall_nb_scol16)
    print("Array of Precision Scores NB-Imb:", df17_l, ":", precision_nb_scol16)
    print("Array of Accuracy Scores NB-Imb:", df17_l, ":", accuracy_nb_scol16)

    print("Array of Prob Scores XG-Imb:", df17_l, ":", probs_xg_scol16)
    print("Array of F1 Scores XG-Imb:", df17_l, ":", f1_xg_scol16)
    print("Array of ROCAUC Scores XG-Imb:", df17_l, ":", rocauc_xg_scol16)
    print("Array of Recall Scores XG-Imb:", df17_l, ":", recall_xg_scol16)
    print("Array of Precision Scores XG-Imb:", df17_l, ":", precision_xg_scol16)
    print("Array of Accuracy Scores XG-Imb:", df17_l, ":", accuracy_xg_scol16)

    print("Array of Prob Scores RF-Imb:", df17_l, ":", probs_rf_scol16)
    print("Array of F1 Scores RF-Imb:", df17_l, ":", f1_rf_scol16)
    print("Array of ROCAUC Scores RF-Imb:", df17_l, ":", rocauc_rf_scol16)
    print("Array of Recall Scores RF-Imb:", df17_l, ":", recall_rf_scol16)
    print("Array of Precision Scores RF-Imb:", df17_l, ":", precision_rf_scol16)
    print("Array of Accuracy Scores RF-Imb:", df17_l, ":", accuracy_rf_scol16)
    

year16 = [args.group for t in range(25)]
sampling16 = ['Imbalanced' for t in range(25)]
technique16 = ['Imbalanced' for t in range(25)]
...
for i in train_values:
    ...
    x_train, x_test, y_train, y_test = train_test_split(x_tfidf17, df18["label"], train_size=i, stratify=df18["label"])
    ...
    print("===Logistic Regression with TfidfVectorizer Imbalanced - ", args.group, df18_l, i)
    lr_end = time.time()
    print('Logistic F1-score', fly * 100)
    print('Logistic ROCAUC score:', rocauc_lr * 100)
    print('Logistic Recall score:', recalls_lr * 100)
    ...
    print("===DecisionTreeClassifier with TfidfVectorizer Imbalanced - ", args.group, df18_l, i)
    dt_end = time.time()
    print('DCT F1-score', fdct * 100)
    print('DCT ROCAUC score:', rocauc_dt * 100)
    print('DCT Recall score:', recalls_dt * 100)
    ...
    nb_end = time.time()
    # Use accuracy_score function to get the accuracy
    print("===Naive Bayes with TfidfVectorizer Imabalanced - ", args.group, df18_l, i)
    print('Naive F1-score', fnb * 100)
    print('Naive ROCAUC score:', rocauc_nb * 100)
    print('Naive Recall score:', recalls_nb * 100)
    print('Naive Precision Score:', precisions_nb * 100)
    ...
    xg_end = time.time()
    print("===XGB with TfidfVectorizer Imbalanced - ", args.group, df18_l, i)
    print('XGB F1-Score', fxg * 100)
    print('XGB ROCAUC Score:', rocauc_xg * 100)
    print('XGB Recall score:', recall_xg * 100)
    print('XGB Precision Score:', precisions_xg * 100)
    ...
    rf_end = time.time()
    print("====RandomForest with Tfidf Imbalanced", args.group, df18_l, i)
    print('RFC F1 score', frfc * 100)
    print('RFC ROCAUC Score:', rocauc_rf * 100)
    print('RFC Recall score:', recalls_rf * 100)
    print('RFC Precision Score:', precisions_rf * 100)
    ...
    print("Array of Prob Scores LR-Imb:", df18_l, ":", probs_lr_scol17)
    print("Array of F1 Scores LR-Imb:", df18_l, ":", f1_lr_scol17)
    print("Array of ROCAUC Scores LR-Imb:", df18_l, ":", rocauc_lr_scol17)
    print("Array of Recall Scores LR-Imb:", df18_l, ":", recall_lr_scol17)
    print("Array of Precision Scores LR-Imb:", df18_l, ":", precision_lr_scol17)
    print("Array of Accuracy Scores LR-Imb:", df18_l, ":", accuracy_lr_scol17)

    print("Array of Prob Scores DT-Imb:", df18_l, ":", probs_dt_scol17)
    print("Array of F1 Scores DT-Imb:", df18_l, ":", f1_dt_scol17)
    print("Array of ROCAUC Scores DT-Imb:", df18_l, ":", rocauc_dt_scol17)
    print("Array of Recall Scores DT-Imb:", df18_l, ":", recall_dt_scol17)
    print("Array of Precision Scores DT-Imb:", df18_l, ":", precision_dt_scol17)
    print("Array of Accuracy Scores DT-Imb:", df18_l, ":", accuracy_dt_scol17)

    print("Array of Prob Scores NB-Imb:", df18_l, ":", probs_nb_scol17)
    print("Array of F1 Scores NB-Imb:", df18_l, ":", f1_nb_scol17)
    print("Array of ROCAUC Scores NB-Imb:", df18_l, ":", rocauc_nb_scol17)
    print("Array of Recall Scores NB-Imb:", df18_l, ":", recall_nb_scol17)
    print("Array of Precision Scores NB-Imb:", df18_l, ":", precision_nb_scol17)
    print("Array of Accuracy Scores NB-Imb:", df18_l, ":", accuracy_nb_scol17)

    print("Array of Prob Scores XG-Imb:", df18_l, ":", probs_xg_scol17)
    print("Array of F1 Scores XG-Imb:", df18_l, ":", f1_xg_scol17)
    print("Array of ROCAUC Scores XG-Imb:", df18_l, ":", rocauc_xg_scol17)
    print("Array of Recall Scores XG-Imb:", df18_l, ":", recall_xg_scol17)
    print("Array of Precision Scores XG-Imb:", df18_l, ":", precision_xg_scol17)
    print("Array of Accuracy Scores XG-Imb:", df18_l, ":", accuracy_xg_scol17)

    print("Array of Prob Scores RF-Imb:", df18_l, ":", probs_rf_scol17)
    print("Array of F1 Scores RF-Imb:", df18_l, ":", f1_rf_scol17)
    print("Array of ROCAUC Scores RF-Imb:", df18_l, ":", rocauc_rf_scol17)
    print("Array of Recall Scores RF-Imb:", df18_l, ":", recall_rf_scol17)
    print("Array of Precision Scores RF-Imb:", df18_l, ":", precision_rf_scol17)
    print("Array of Accuracy Scores RF-Imb:", df18_l, ":", accuracy_rf_scol17)

year17 = [args.group for t in range(25)]
sampling17 = ['Imbalanced' for t in range(25)]
technique17 = ['Imbalanced' for t in range(25)]
...
for i in train_values:
    ...
    x_train, x_test, y_train, y_test = train_test_split(x_tfidf18, df18["label"], train_size=i, stratify=df19["label"])
    ...
    print("===Logistic Regression with TfidfVectorizer Imbalanced - ", args.group, df19_l, i)
    lr_end = time.time()
    print('Logistic F1-score', fly * 100)
    print('Logistic ROCAUC score:', rocauc_lr * 100)
    print('Logistic Recall score:', recalls_lr * 100)
    ...
    print("===DecisionTreeClassifier with TfidfVectorizer Imbalanced - ", args.group, df19_l, i)
    dt_end = time.time()
    print('DCT F1-score', fdct * 100)
    print('DCT ROCAUC score:', rocauc_dt * 100)
    print('DCT Recall score:', recalls_dt * 100)
    ...
    nb_end = time.time()
    # Use accuracy_score function to get the accuracy
    print("===Naive Bayes with TfidfVectorizer Imabalanced - ", args.group, df19_l, i)
    print('Naive F1-score', fnb * 100)
    print('Naive ROCAUC score:', rocauc_nb * 100)
    print('Naive Recall score:', recalls_nb * 100)
    print('Naive Precision Score:', precisions_nb * 100)
    ...
    xg_end = time.time()
    print("===XGB with TfidfVectorizer Imbalanced - ", args.group, df19_l, i)
    print('XGB F1-Score', fxg * 100)
    print('XGB ROCAUC Score:', rocauc_xg * 100)
    print('XGB Recall score:', recall_xg * 100)
    print('XGB Precision Score:', precisions_xg * 100)
    ...
    rf_end = time.time()
    print("====RandomForest with Tfidf Imbalanced", args.group, df19_l, i)
    print('RFC F1 score', frfc * 100)
    print('RFC ROCAUC Score:', rocauc_rf * 100)
    print('RFC Recall score:', recalls_rf * 100)
    print('RFC Precision Score:', precisions_rf * 100)
    ...
    print("Array of Prob Scores LR-Imb:", df19_l, ":", probs_lr_scol18)
    print("Array of F1 Scores LR-Imb:", df19_l, ":", f1_lr_scol18)
    print("Array of ROCAUC Scores LR-Imb:", df19_l, ":", rocauc_lr_scol18)
    print("Array of Recall Scores LR-Imb:", df19_l, ":", recall_lr_scol18)
    print("Array of Precision Scores LR-Imb:", df19_l, ":", precision_lr_scol18)
    print("Array of Accuracy Scores LR-Imb:", df19_l, ":", accuracy_lr_scol18)

    print("Array of Prob Scores DT-Imb:", df19_l, ":", probs_dt_scol18)
    print("Array of F1 Scores DT-Imb:", df19_l, ":", f1_dt_scol18)
    print("Array of ROCAUC Scores DT-Imb:", df19_l, ":", rocauc_dt_scol18)
    print("Array of Recall Scores DT-Imb:", df19_l, ":", recall_dt_scol18)
    print("Array of Precision Scores DT-Imb:", df19_l, ":", precision_dt_scol18)
    print("Array of Accuracy Scores DT-Imb:", df19_l, ":", accuracy_dt_scol18)

    print("Array of Prob Scores NB-Imb:", df19_l, ":", probs_nb_scol18)
    print("Array of F1 Scores NB-Imb:", df19_l, ":", f1_nb_scol18)
    print("Array of ROCAUC Scores NB-Imb:", df19_l, ":", rocauc_nb_scol18)
    print("Array of Recall Scores NB-Imb:", df19_l, ":", recall_nb_scol18)
    print("Array of Precision Scores NB-Imb:", df19_l, ":", precision_nb_scol18)
    print("Array of Accuracy Scores NB-Imb:", df19_l, ":", accuracy_nb_scol18)

    print("Array of Prob Scores XG-Imb:", df19_l, ":", probs_xg_scol18)
    print("Array of F1 Scores XG-Imb:", df19_l, ":", f1_xg_scol18)
    print("Array of ROCAUC Scores XG-Imb:", df19_l, ":", rocauc_xg_scol18)
    print("Array of Recall Scores XG-Imb:", df19_l, ":", recall_xg_scol18)
    print("Array of Precision Scores XG-Imb:", df19_l, ":", precision_xg_scol18)
    print("Array of Accuracy Scores XG-Imb:", df19_l, ":", accuracy_xg_scol18)

    print("Array of Prob Scores RF-Imb:", df19_l, ":", probs_rf_scol18)
    print("Array of F1 Scores RF-Imb:", df19_l, ":", f1_rf_scol18)
    print("Array of ROCAUC Scores RF-Imb:", df19_l, ":", rocauc_rf_scol18)
    print("Array of Recall Scores RF-Imb:", df19_l, ":", recall_rf_scol18)
    print("Array of Precision Scores RF-Imb:", df19_l, ":", precision_rf_scol18)
    print("Array of Accuracy Scores RF-Imb:", df19_l, ":", accuracy_rf_scol18)
    

year18 = [args.group for t in range(25)]
sampling18 = ['Imbalanced' for t in range(25)]
technique18 = ['Imbalanced' for t in range(25)]
...
for i in train_values:
    ...
    x_train, x_test, y_train, y_test = train_test_split(x_tfidf19, df20["label"], train_size=i, stratify=df20["label"])
    ...
    print("===Logistic Regression with TfidfVectorizer Imbalanced - ", args.group, df20_l, i)
    lr_end = time.time()
    print('Logistic F1-score', fly * 100)
    print('Logistic ROCAUC score:', rocauc_lr * 100)
    print('Logistic Recall score:', recalls_lr * 100)
    ...
    print("===DecisionTreeClassifier with TfidfVectorizer Imbalanced - ", args.group, df20_l, i)
    dt_end = time.time()
    print('DCT F1-score', fdct * 100)
    print('DCT ROCAUC score:', rocauc_dt * 100)
    print('DCT Recall score:', recalls_dt * 100)
    ...
    nb_end = time.time()
    # Use accuracy_score function to get the accuracy
    print("===Naive Bayes with TfidfVectorizer Imabalanced - ", args.group, df20_l, i)
    print('Naive F1-score', fnb * 100)
    print('Naive ROCAUC score:', rocauc_nb * 100)
    print('Naive Recall score:', recalls_nb * 100)
    print('Naive Precision Score:', precisions_nb * 100)
    ...
    xg_end = time.time()
    print("===XGB with TfidfVectorizer Imbalanced - ", args.group, df20_l, i)
    print('XGB F1-Score', fxg * 100)
    print('XGB ROCAUC Score:', rocauc_xg * 100)
    print('XGB Recall score:', recall_xg * 100)
    print('XGB Precision Score:', precisions_xg * 100)
    ...
    rf_end = time.time()
    print("====RandomForest with Tfidf Imbalanced", args.group, df20_l, i)
    print('RFC F1 score', frfc * 100)
    print('RFC ROCAUC Score:', rocauc_rf * 100)
    print('RFC Recall score:', recalls_rf * 100)
    print('RFC Precision Score:', precisions_rf * 100)
    ...
    print("Array of Prob Scores LR-Imb:", df20_l, ":", probs_lr_scol19)
    print("Array of F1 Scores LR-Imb:", df20_l, ":", f1_lr_scol19)
    print("Array of ROCAUC Scores LR-Imb:", df20_l, ":", rocauc_lr_scol19)
    print("Array of Recall Scores LR-Imb:", df20_l, ":", recall_lr_scol19)
    print("Array of Precision Scores LR-Imb:", df20_l, ":", precision_lr_scol19)
    print("Array of Accuracy Scores LR-Imb:", df20_l, ":", accuracy_lr_scol19)

    print("Array of Prob Scores DT-Imb:", df20_l, ":", probs_dt_scol19)
    print("Array of F1 Scores DT-Imb:", df20_l, ":", f1_dt_scol19)
    print("Array of ROCAUC Scores DT-Imb:", df20_l, ":", rocauc_dt_scol19)
    print("Array of Recall Scores DT-Imb:", df20_l, ":", recall_dt_scol19)
    print("Array of Precision Scores DT-Imb:", df20_l, ":", precision_dt_scol19)
    print("Array of Accuracy Scores DT-Imb:", df20_l, ":", accuracy_dt_scol19)

    print("Array of Prob Scores NB-Imb:", df20_l, ":", probs_nb_scol19)
    print("Array of F1 Scores NB-Imb:", df20_l, ":", f1_nb_scol19)
    print("Array of ROCAUC Scores NB-Imb:", df20_l, ":", rocauc_nb_scol19)
    print("Array of Recall Scores NB-Imb:", df20_l, ":", recall_nb_scol19)
    print("Array of Precision Scores NB-Imb:", df20_l, ":", precision_nb_scol19)
    print("Array of Accuracy Scores NB-Imb:", df20_l, ":", accuracy_nb_scol19)

    print("Array of Prob Scores XG-Imb:", df20_l, ":", probs_xg_scol19)
    print("Array of F1 Scores XG-Imb:", df20_l, ":", f1_xg_scol19)
    print("Array of ROCAUC Scores XG-Imb:", df20_l, ":", rocauc_xg_scol19)
    print("Array of Recall Scores XG-Imb:", df20_l, ":", recall_xg_scol19)
    print("Array of Precision Scores XG-Imb:", df20_l, ":", precision_xg_scol19)
    print("Array of Accuracy Scores XG-Imb:", df20_l, ":", accuracy_xg_scol19)

    print("Array of Prob Scores RF-Imb:", df20_l, ":", probs_rf_scol19)
    print("Array of F1 Scores RF-Imb:", df20_l, ":", f1_rf_scol19)
    print("Array of ROCAUC Scores RF-Imb:", df20_l, ":", rocauc_rf_scol19)
    print("Array of Recall Scores RF-Imb:", df20_l, ":", recall_rf_scol19)
    print("Array of Precision Scores RF-Imb:", df20_l, ":", precision_rf_scol19)
    print("Array of Accuracy Scores RF-Imb:", df20_l, ":", accuracy_rf_scol19)
    

year19 = [args.group for t in range(25)]
sampling19 = ['Imbalanced' for t in range(25)]
technique19 = ['Imbalanced' for t in range(25)]
...
'''
ax.set_title('Precision: Imbalanced - Randomization', args.group', size=20)
...
#plt.ylim(0, 8)
#plt.tight_layout()
plt.title('Precision: Randomization Imbalanced ", args.group')
