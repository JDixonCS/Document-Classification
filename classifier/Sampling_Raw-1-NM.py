...
parser = argparse.ArgumentParser(
                    prog = 'Sampling_Raw-1-NM.py',
                    description = 'Run NearMiss sampling with machine learning classifiers')
...
for i in train_values:
    ...
    x_train, x_test, y_train, y_test = train_test_split(x_nm, y_nm, train_size=i, stratify=y_nm)
    ...
    print("===Logistic Regression with TfidfVectorizer NearMiss - ", args.group, df1_l, i)
    lr_end = time.time()
    ...
    print("===DecisionTreeClassifier with TfidfVectorizer NearMiss - ", args.group, df1_l, i)
    dt_end = time.time()
    ...
    print("===Naive Bayes with TfidfVectorizer NearMiss - ", args.group, df1_l, i)
...
# XGBoost Classifier
    ...
    xg_end = time.time()
    print("===XGB with TfidfVectorizer NearMiss - ", args.group, df1_l, i)
...
# Random Forest Classifier
    ...
    rf_end = time.time()
    print("====RandomForest with Tfidf NearMiss ", args.group, df1_l, i)
    ...
    print("Array of Prob Scores LR-Nea Test-Size", df1_l,":", probs_lr_scol)
    print("Array of F1 Scores LR-Nea Test-Size:", df1_l,":", f1_lr_scol)
    print("Array of ROCAUC Scores LR-Nea:", df1_l,":", rocauc_lr_scol)
    print("Array of Recall Scores LR-Nea:", df1_l,":", recall_lr_scol)
    print("Array of Precision Scores LR-Nea:", df1_l,":", precision_lr_scol)
    print("Array of Accuracy Scores LR-Nea:", df1_l,":", accuracy_lr_scol)

    print("Array of Prob Scores DT-Nea:", df1_l,":", probs_dt_scol)
    print("Array of F1 Scores DT-Nea:", df1_l,":", f1_dt_scol)
    print("Array of ROCAUC Scores DT-Nea:", df1_l,":", rocauc_dt_scol)
    print("Array of Recall Scores DT-Nea:", df1_l,":", recall_dt_scol)
    print("Array of Precision Scores DT-Nea:", df1_l,":", precision_dt_scol)
    print("Array of Accuracy Scores DT-Nea:", df1_l,":", accuracy_dt_scol)

    print("Array of Prob Scores NB-Nea:", df1_l,":", probs_nb_scol)
    print("Array of F1 Scores NB-Nea:", df1_l,":", f1_nb_scol)
    print("Array of ROCAUC Scores NB-Nea:", df1_l,":", rocauc_nb_scol)
    print("Array of Recall Scores NB-Nea:", df1_l,":", recall_nb_scol)
    print("Array of Precision Scores NB-Nea:", df1_l,":", precision_nb_scol)
    print("Array of Accuracy Scores NB-Nea:", df1_l,":", accuracy_nb_scol)

    print("Array of Prob Scores XG-Nea:", df1_l,":", probs_xg_scol)
    print("Array of F1 Scores XG-Nea:",  df1_l,":", f1_xg_scol)
    print("Array of ROCAUC Scores XG-Nea:",  df1_l,":",  rocauc_xg_scol)
    print("Array of Recall Scores XG-Nea:",  df1_l,":",  recall_xg_scol)
    print("Array of Precision Scores XG-Nea:",  df1_l,":", precision_xg_scol)
    print("Array of Accuracy Scores XG-Nea:",  df1_l,":", accuracy_xg_scol)

    print("Array of Prob Scores RF-Nea:",  df1_l,":", probs_rf_scol)
    print("Array of F1 Scores RF-Nea:", df1_l,":",  f1_rf_scol)
    print("Array of ROCAUC Scores RF-Nea:",  df1_l,":", rocauc_rf_scol)
    print("Array of Recall Scores RF-Nea:", df1_l,":",  recall_rf_scol)
    print("Array of Precision Scores RF-Nea:", df1_l,":",  precision_rf_scol)
    print("Array of Accuracy Scores RF-Nea:", df1_l,":",  accuracy_rf_scol)
...
technique = ['NearMiss' for t in range(25)]
...
x_nm1, y_nm1 = nm.fit_resample(x_tfidf1, df2["label"])
...
for i in train_values:
    ...
    x_train, x_test, y_train, y_test = train_test_split(x_nm1,y_nm1, train_size=i, stratify=y_nm1)
    ...
    print("===Logistic Regression with TfidfVectorizer NearMiss - ", args.group, df2_l, i)
    lr_end = time.time()
    print('Logistic F1-score',fly*100)
    print('Logistic ROCAUC score:',rocauc_lr*100)
    print('Logistic Recall score:', recalls_lr*100)
    ...
    print("===DecisionTreeClassifier with TfidfVectorizer NearMiss - ", args.group, df2_l, i)
    dt_end = time.time()
    print('DCT F1-score',fdct*100)
    print('DCT ROCAUC score:',rocauc_dt*100)
    print('DCT Recall score:', recalls_dt*100)
    ...
    nb_end = time.time()
    # Use accuracy_score function to get the accuracy
    print("===Naive Bayes with TfidfVectorizer NearMiss - ", args.group, df2_l, i)
    print('Naive F1-score',fnb*100)
    print('Naive ROCAUC score:',rocauc_nb*100)
    print('Naive Recall score:', recalls_nb*100)
    print('Naive Precision Score:', precisions_nb*100)
...
# XGBoost Classifier
    ...
    xg_end = time.time()
    print("===XGB with TfidfVectorizer NearMiss - ", args.group, df2_l, i)
    print('XGB F1-Score', fxg*100)
    print('XGB ROCAUC Score:', rocauc_xg*100)
    print('XGB Recall score:', recall_xg*100)
    print('XGB Precision Score:', precisions_xg *100)
...
# Random Forest Classifier
    ...
    rf_end = time.time()
    print("====RandomForest with Tfidf NearMiss ", args.group, df2_l, i)
    print('RFC F1 score', frfc*100)
    print('RFC ROCAUC Score:', rocauc_rf*100)
    print('RFC Recall score:', recalls_rf*100)
    print('RFC Precision Score:', precisions_rf*100)
    ...
    print("Array of Prob Scores LR-Nea:",  df2_l,":",  probs_lr_scol1)
    print("Array of F1 Scores LR-Nea:",  df2_l,":",  f1_lr_scol1)
    print("Array of ROCAUC Scores LR-Nea:",  df2_l,":",  rocauc_lr_scol1)
    print("Array of Recall Scores LR-Nea:",  df2_l,":",  recall_lr_scol1)
    print("Array of Precision Scores LR-Nea:",  df2_l,":", precision_lr_scol1)
    print("Array of Accuracy Scores LR-Nea:", df2_l,":", accuracy_lr_scol1)

    print("Array of Prob Scores DT-Nea:", df2_l,":", probs_dt_scol1)
    print("Array of F1 Scores DT-Nea:", df2_l,":", f1_dt_scol1)
    print("Array of ROCAUC Scores DT-Nea:", df2_l,":", rocauc_dt_scol1)
    print("Array of Recall Scores DT-Nea:",df2_l,":", recall_dt_scol1)
    print("Array of Precision Scores DT-Nea:", df2_l,":", precision_dt_scol1)
    print("Array of Accuracy Scores DT-Nea:", df2_l,":", accuracy_dt_scol1)

    print("Array of Prob Scores NB-Nea:", df2_l,":", probs_nb_scol1)
    print("Array of F1 Scores NB-Nea:", df2_l,":", f1_nb_scol1)
    print("Array of ROCAUC Scores NB-Nea:", df2_l,":", rocauc_nb_scol1)
    print("Array of Recall Scores NB-Nea:", df2_l,":", recall_nb_scol1)
    print("Array of Precision Scores NB-Nea:", df2_l,":", precision_nb_scol1)
    print("Array of Accuracy Scores NB-Nea:", df2_l,":", accuracy_nb_scol1)

    print("Array of Prob Scores XG-Nea:", df2_l,":", probs_xg_scol1)
    print("Array of F1 Scores XG-Nea:", df2_l,":", f1_xg_scol1)
    print("Array of ROCAUC Scores XG-Nea:", df2_l,":", rocauc_xg_scol1)
    print("Array of Recall Scores XG-Nea:", df2_l,":", recall_xg_scol1)
    print("Array of Precision Scores XG-Nea:", df2_l,":", precision_xg_scol1)
    print("Array of Accuracy Scores XG-Nea:", df2_l,":", accuracy_xg_scol1)

    print("Array of Prob Scores RF-Nea:", df2_l,":", probs_rf_scol1)
    print("Array of F1 Scores RF-Nea:", df2_l,":", f1_rf_scol1)
    print("Array of ROCAUC Scores RF-Nea:", df2_l,":", rocauc_rf_scol1)
    print("Array of Recall Scores RF-Nea:", df2_l,":", recall_rf_scol1)
    print("Array of Precision Scores RF-Nea:", df2_l,":", precision_rf_scol1)
    print("Array of Accuracy Scores RF-Nea:", df2_l,":", accuracy_rf_scol1)
'''
classifier_list = ['Logistic Regression', 'Decision Tree', 'Naive Bayes', 'XGBoost', 'Random Forest']
test_sizes_num = [0.17, 0.33, 0.50, 0.67, 0.83]
train_sizes_num = [0.83, 0.67, 0.50, 0.33, 0.17]
...
technique1 = ['NearMiss' for t in range(25)]
...
x_nm2, y_nm2 = nm.fit_resample(x_tfidf2, df3["label"])
...
for i in train_values:
    ...
    x_train, x_test, y_train, y_test = train_test_split(x_nm2, y_nm2, train_size=i, stratify=y_nm2)
    ...
    print("===Logistic Regression with TfidfVectorizer NearMiss - ", args.group, df3_l, i)
    lr_end = time.time()
    print('Logistic F1-score',fly*100)
    print('Logistic ROCAUC score:',rocauc_lr*100)
    print('Logistic Recall score:', recalls_lr*100)
    ...
    print("===DecisionTreeClassifier with TfidfVectorizer NearMiss - ", args.group, df3_l, i)
    dt_end = time.time()
    print('DCT F1-score',fdct*100)
    print('DCT ROCAUC score:',rocauc_dt*100)
    print('DCT Recall score:', recalls_dt*100)
    ...
    nb_end = time.time()
    # Use accuracy_score function to get the accuracy
    print("===Naive Bayes with TfidfVectorizer NearMiss - ", args.group, df3_l, i)
    print('Naive F1-score',fnb*100)
    print('Naive ROCAUC score:',rocauc_nb*100)
    print('Naive Recall score:', recalls_nb*100)
    print('Naive Precision Score:', precisions_nb*100)
...
# XGBoost Classifier
    ...
    xg_end = time.time()
    print("===XGB with TfidfVectorizer NearMiss - ", args.group, df3_l, i)
    print('XGB F1-Score', fxg*100)
    print('XGB ROCAUC Score:', rocauc_xg*100)
    print('XGB Recall score:', recall_xg*100)
    print('XGB Precision Score:', precisions_xg *100)
...
# Random Forest Classifier
    ...
    rf_end = time.time()
    print("====RandomForest with Tfidf NearMiss ", args.group, df3_l, i)
    print('RFC F1 score', frfc*100)
    print('RFC ROCAUC Score:', rocauc_rf*100)
    print('RFC Recall score:', recalls_rf*100)
    print('RFC Precision Score:', precisions_rf*100)
    ...
    print("Array of Prob Scores LR-Nea:",  df3_l,":",  probs_lr_scol2)
    print("Array of F1 Scores LR-Nea:",  df3_l,":",  f1_lr_scol2)
    print("Array of ROCAUC Scores LR-Nea:",  df3_l,":",  rocauc_lr_scol2)
    print("Array of Recall Scores LR-Nea:",  df3_l,":",  recall_lr_scol2)
    print("Array of Precision Scores LR-Nea:",  df3_l,":", precision_lr_scol2)
    print("Array of Accuracy Scores LR-Nea:", df3_l,":", accuracy_lr_scol2)

    print("Array of Prob Scores DT-Nea:", df3_l,":", probs_dt_scol2)
    print("Array of F1 Scores DT-Nea:", df3_l,":", f1_dt_scol2)
    print("Array of ROCAUC Scores DT-Nea:", df3_l,":", rocauc_dt_scol2)
    print("Array of Recall Scores DT-Nea:",df3_l,":", recall_dt_scol2)
    print("Array of Precision Scores DT-Nea:", df3_l,":", precision_dt_scol2)
    print("Array of Accuracy Scores DT-Nea:", df3_l,":", accuracy_dt_scol2)

    print("Array of Prob Scores NB-Nea:", df3_l,":", probs_nb_scol2)
    print("Array of F1 Scores NB-Nea:", df3_l,":", f1_nb_scol2)
    print("Array of ROCAUC Scores NB-Nea:", df3_l,":", rocauc_nb_scol2)
    print("Array of Recall Scores NB-Nea:", df3_l,":", recall_nb_scol2)
    print("Array of Precision Scores NB-Nea:", df3_l,":", precision_nb_scol2)
    print("Array of Accuracy Scores NB-Nea:", df3_l,":", accuracy_nb_scol2)

    print("Array of Prob Scores XG-Nea:", df3_l,":", probs_xg_scol2)
    print("Array of F1 Scores XG-Nea:", df3_l,":", f1_xg_scol2)
    print("Array of ROCAUC Scores XG-Nea:", df3_l,":", rocauc_xg_scol2)
    print("Array of Recall Scores XG-Nea:", df3_l,":", recall_xg_scol2)
    print("Array of Precision Scores XG-Nea:", df3_l,":", precision_xg_scol2)
    print("Array of Accuracy Scores XG-Nea:", df3_l,":", accuracy_xg_scol2)

    print("Array of Prob Scores RF-Nea:", df3_l,":", probs_rf_scol2)
    print("Array of F1 Scores RF-Nea:", df3_l,":", f1_rf_scol2)
    print("Array of ROCAUC Scores RF-Nea:", df3_l,":", rocauc_rf_scol2)
    print("Array of Recall Scores RF-Nea:", df3_l,":", recall_rf_scol2)
    print("Array of Precision Scores RF-Nea:", df3_l,":", precision_rf_scol2)
    print("Array of Accuracy Scores RF-Nea:", df3_l,":", accuracy_rf_scol2)
    

from itertools import chain
year2 = [ args.group for t in range(25)]
sampling2 =['Undersampling' for t in range(25)]
technique2 = ['NearMiss' for t in range(25)]
...
x_nm3, y_nm3 = nm.fit_resample(x_tfidf3, df4["label"])
...
for i in train_values:
    ...
    x_train, x_test, y_train, y_test = train_test_split(x_nm3, y_nm3, train_size=i, stratify=y_nm3)
    ...
    print("===Logistic Regression with TfidfVectorizer NearMiss - ", args.group, df4_l, i)
    lr_end = time.time()
    print('Logistic F1-score', fly * 100)
    print('Logistic ROCAUC score:', rocauc_lr * 100)
    print('Logistic Recall score:', recalls_lr * 100)
    ...
    print("===DecisionTreeClassifier with TfidfVectorizer NearMiss - ", args.group, df4_l, i)
    dt_end = time.time()
    print('DCT F1-score', fdct * 100)
    print('DCT ROCAUC score:', rocauc_dt * 100)
    print('DCT Recall score:', recalls_dt * 100)
    ...
    nb_end = time.time()
    # Use accuracy_score function to get the accuracy
    print("===Naive Bayes with TfidfVectorizer NearMiss - ", args.group, df4_l, i)
    print('Naive F1-score', fnb * 100)
    print('Naive ROCAUC score:', rocauc_nb * 100)
    print('Naive Recall score:', recalls_nb * 100)
    print('Naive Precision Score:', precisions_nb * 100)
    ...
    xg_end = time.time()
    print("===XGB with TfidfVectorizer NearMiss - ", args.group, df4_l, i)
    print('XGB F1-Score', fxg * 100)
    print('XGB ROCAUC Score:', rocauc_xg * 100)
    print('XGB Recall score:', recall_xg * 100)
    print('XGB Precision Score:', precisions_xg * 100)
    ...
    rf_end = time.time()
    print("====RandomForest with Tfidf NearMiss ", args.group, df4_l, i)
    print('RFC F1 score', frfc * 100)
    print('RFC ROCAUC Score:', rocauc_rf * 100)
    print('RFC Recall score:', recalls_rf * 100)
    print('RFC Precision Score:', precisions_rf * 100)
    ...
    print("Array of Prob Scores LR-Nea:", df4_l, ":", probs_lr_scol3)
    print("Array of F1 Scores LR-Nea:", df4_l, ":", f1_lr_scol3)
    print("Array of ROCAUC Scores LR-Nea:", df4_l, ":", rocauc_lr_scol3)
    print("Array of Recall Scores LR-Nea:", df4_l, ":", recall_lr_scol3)
    print("Array of Precision Scores LR-Nea:", df4_l, ":", precision_lr_scol3)
    print("Array of Accuracy Scores LR-Nea:", df4_l, ":", accuracy_lr_scol3)

    print("Array of Prob Scores DT-Nea:", df4_l, ":", probs_dt_scol3)
    print("Array of F1 Scores DT-Nea:", df4_l, ":", f1_dt_scol3)
    print("Array of ROCAUC Scores DT-Nea:", df4_l, ":", rocauc_dt_scol3)
    print("Array of Recall Scores DT-Nea:", df4_l, ":", recall_dt_scol3)
    print("Array of Precision Scores DT-Nea:", df4_l, ":", precision_dt_scol3)
    print("Array of Accuracy Scores DT-Nea:", df4_l, ":", accuracy_dt_scol3)

    print("Array of Prob Scores NB-Nea:", df4_l, ":", probs_nb_scol3)
    print("Array of F1 Scores NB-Nea:", df4_l, ":", f1_nb_scol3)
    print("Array of ROCAUC Scores NB-Nea:", df4_l, ":", rocauc_nb_scol3)
    print("Array of Recall Scores NB-Nea:", df4_l, ":", recall_nb_scol3)
    print("Array of Precision Scores NB-Nea:", df4_l, ":", precision_nb_scol3)
    print("Array of Accuracy Scores NB-Nea:", df4_l, ":", accuracy_nb_scol3)

    print("Array of Prob Scores XG-Nea:", df4_l, ":", probs_xg_scol3)
    print("Array of F1 Scores XG-Nea:", df4_l, ":", f1_xg_scol3)
    print("Array of ROCAUC Scores XG-Nea:", df4_l, ":", rocauc_xg_scol3)
    print("Array of Recall Scores XG-Nea:", df4_l, ":", recall_xg_scol3)
    print("Array of Precision Scores XG-Nea:", df4_l, ":", precision_xg_scol3)
    print("Array of Accuracy Scores XG-Nea:", df4_l, ":", accuracy_xg_scol3)

    print("Array of Prob Scores RF-Nea:", df4_l, ":", probs_rf_scol3)
    print("Array of F1 Scores RF-Nea:", df4_l, ":", f1_rf_scol3)
    print("Array of ROCAUC Scores RF-Nea:", df4_l, ":", rocauc_rf_scol3)
    print("Array of Recall Scores RF-Nea:", df4_l, ":", recall_rf_scol3)
    print("Array of Precision Scores RF-Nea:", df4_l, ":", precision_rf_scol3)
    print("Array of Accuracy Scores RF-Nea:", df4_l, ":", accuracy_rf_scol3)
    

year3 = [ args.group for t in range(25)]
sampling3 =['Undersampling' for t in range(25)]
technique3 = ['NearMiss' for t in range(25)]
...
x_nm4, y_nm4 = nm.fit_resample(x_tfidf4, df5["label"])
...
for i in train_values:
    ...
    x_train, x_test, y_train, y_test = train_test_split(x_nm4, y_nm4, train_size=i, stratify=y_nm4)
    ...
    print("===Logistic Regression with TfidfVectorizer NearMiss - ", args.group, df5_l, i)
    lr_end = time.time()
    print('Logistic F1-score', fly * 100)
    print('Logistic ROCAUC score:', rocauc_lr * 100)
    print('Logistic Recall score:', recalls_lr * 100)
    ...
    print("===DecisionTreeClassifier with TfidfVectorizer NearMiss - ", args.group, df5_l, i)
    dt_end = time.time()
    print('DCT F1-score', fdct * 100)
    print('DCT ROCAUC score:', rocauc_dt * 100)
    print('DCT Recall score:', recalls_dt * 100)
    ...
    nb_end = time.time()
    # Use accuracy_score function to get the accuracy
    print("===Naive Bayes with TfidfVectorizer NearMiss - ", args.group, df5_l, i)
    print('Naive F1-score', fnb * 100)
    print('Naive ROCAUC score:', rocauc_nb * 100)
    print('Naive Recall score:', recalls_nb * 100)
    print('Naive Precision Score:', precisions_nb * 100)
    ...
    xg_end = time.time()
    print("===XGB with TfidfVectorizer NearMiss - ", args.group, df5_l, i)
    print('XGB F1-Score', fxg * 100)
    print('XGB ROCAUC Score:', rocauc_xg * 100)
    print('XGB Recall score:', recall_xg * 100)
    print('XGB Precision Score:', precisions_xg * 100)
    ...
    rf_end = time.time()
    print("====RandomForest with Tfidf NearMiss ", args.group, df5_l, i)
    print('RFC F1 score', frfc * 100)
    print('RFC ROCAUC Score:', rocauc_rf * 100)
    print('RFC Recall score:', recalls_rf * 100)
    print('RFC Precision Score:', precisions_rf * 100)
    ...
    print("Array of Prob Scores LR-Nea:", df5_l, ":", probs_lr_scol4)
    print("Array of F1 Scores LR-Nea:", df5_l, ":", f1_lr_scol4)
    print("Array of ROCAUC Scores LR-Nea:", df5_l, ":", rocauc_lr_scol4)
    print("Array of Recall Scores LR-Nea:", df5_l, ":", recall_lr_scol4)
    print("Array of Precision Scores LR-Nea:", df5_l, ":", precision_lr_scol4)
    print("Array of Accuracy Scores LR-Nea:", df5_l, ":", accuracy_lr_scol4)

    print("Array of Prob Scores DT-Nea:", df5_l, ":", probs_dt_scol4)
    print("Array of F1 Scores DT-Nea:", df5_l, ":", f1_dt_scol4)
    print("Array of ROCAUC Scores DT-Nea:", df5_l, ":", rocauc_dt_scol4)
    print("Array of Recall Scores DT-Nea:", df5_l, ":", recall_dt_scol4)
    print("Array of Precision Scores DT-Nea:", df5_l, ":", precision_dt_scol4)
    print("Array of Accuracy Scores DT-Nea:", df5_l, ":", accuracy_dt_scol4)

    print("Array of Prob Scores NB-Nea:", df5_l, ":", probs_nb_scol4)
    print("Array of F1 Scores NB-Nea:", df5_l, ":", f1_nb_scol4)
    print("Array of ROCAUC Scores NB-Nea:", df5_l, ":", rocauc_nb_scol4)
    print("Array of Recall Scores NB-Nea:", df5_l, ":", recall_nb_scol4)
    print("Array of Precision Scores NB-Nea:", df5_l, ":", precision_nb_scol4)
    print("Array of Accuracy Scores NB-Nea:", df5_l, ":", accuracy_nb_scol4)

    print("Array of Prob Scores XG-Nea:", df5_l, ":", probs_xg_scol4)
    print("Array of F1 Scores XG-Nea:", df5_l, ":", f1_xg_scol4)
    print("Array of ROCAUC Scores XG-Nea:", df5_l, ":", rocauc_xg_scol4)
    print("Array of Recall Scores XG-Nea:", df5_l, ":", recall_xg_scol4)
    print("Array of Precision Scores XG-Nea:", df5_l, ":", precision_xg_scol4)
    print("Array of Accuracy Scores XG-Nea:", df5_l, ":", accuracy_xg_scol4)

    print("Array of Prob Scores RF-Nea:", df5_l, ":", probs_rf_scol4)
    print("Array of F1 Scores RF-Nea:", df5_l, ":", f1_rf_scol4)
    print("Array of ROCAUC Scores RF-Nea:", df5_l, ":", rocauc_rf_scol4)
    print("Array of Recall Scores RF-Nea:", df5_l, ":", recall_rf_scol4)
    print("Array of Precision Scores RF-Nea:", df5_l, ":", precision_rf_scol4)
    print("Array of Accuracy Scores RF-Nea:", df5_l, ":", accuracy_rf_scol4)


year4 = [ args.group for t in range(25)]
sampling4 =['Undersampling' for t in range(25)]
technique4 = ['NearMiss' for t in range(25)]
...
x_nm5, y_nm5 = nm.fit_resample(x_tfidf5, df6["label"])
...
for i in train_values:
    ...
    x_train, x_test, y_train, y_test = train_test_split(x_nm5, y_nm5, train_size=i, stratify=y_nm5)
    ...
    print("===Logistic Regression with TfidfVectorizer NearMiss - ", args.group, df6_l, i)
    lr_end = time.time()
    print('Logistic F1-score', fly * 100)
    print('Logistic ROCAUC score:', rocauc_lr * 100)
    print('Logistic Recall score:', recalls_lr * 100)
    ...
    print("===DecisionTreeClassifier with TfidfVectorizer NearMiss - ", args.group, df6_l, i)
    dt_end = time.time()
    print('DCT F1-score', fdct * 100)
    print('DCT ROCAUC score:', rocauc_dt * 100)
    print('DCT Recall score:', recalls_dt * 100)
    ...
    nb_end = time.time()
    # Use accuracy_score function to get the accuracy
    print("===Naive Bayes with TfidfVectorizer NearMiss - ", args.group, df6_l, i)
    print('Naive F1-score', fnb * 100)
    print('Naive ROCAUC score:', rocauc_nb * 100)
    print('Naive Recall score:', recalls_nb * 100)
    print('Naive Precision Score:', precisions_nb * 100)
    ...
    xg_end = time.time()
    print("===XGB with TfidfVectorizer NearMiss - ", args.group, df6_l, i)
    print('XGB F1-Score', fxg * 100)
    print('XGB ROCAUC Score:', rocauc_xg * 100)
    print('XGB Recall score:', recall_xg * 100)
    print('XGB Precision Score:', precisions_xg * 100)
    ...
    rf_end = time.time()
    print("====RandomForest with Tfidf NearMiss ", args.group, df6_l, i)
    print('RFC F1 score', frfc * 100)
    print('RFC ROCAUC Score:', rocauc_rf * 100)
    print('RFC Recall score:', recalls_rf * 100)
    print('RFC Precision Score:', precisions_rf * 100)
    ...
    print("Array of Prob Scores LR-Nea:", df6_l, ":", probs_lr_scol5)
    print("Array of F1 Scores LR-Nea:", df6_l, ":", f1_lr_scol5)
    print("Array of ROCAUC Scores LR-Nea:", df6_l, ":", rocauc_lr_scol5)
    print("Array of Recall Scores LR-Nea:", df6_l, ":", recall_lr_scol5)
    print("Array of Precision Scores LR-Nea:", df6_l, ":", precision_lr_scol5)
    print("Array of Accuracy Scores LR-Nea:", df6_l, ":", accuracy_lr_scol5)

    print("Array of Prob Scores DT-Nea:", df6_l, ":", probs_dt_scol5)
    print("Array of F1 Scores DT-Nea:", df6_l, ":", f1_dt_scol5)
    print("Array of ROCAUC Scores DT-Nea:", df6_l, ":", rocauc_dt_scol5)
    print("Array of Recall Scores DT-Nea:", df6_l, ":", recall_dt_scol5)
    print("Array of Precision Scores DT-Nea:", df6_l, ":", precision_dt_scol5)
    print("Array of Accuracy Scores DT-Nea:", df6_l, ":", accuracy_dt_scol5)

    print("Array of Prob Scores NB-Nea:", df6_l, ":", probs_nb_scol5)
    print("Array of F1 Scores NB-Nea:", df6_l, ":", f1_nb_scol5)
    print("Array of ROCAUC Scores NB-Nea:", df6_l, ":", rocauc_nb_scol5)
    print("Array of Recall Scores NB-Nea:", df6_l, ":", recall_nb_scol5)
    print("Array of Precision Scores NB-Nea:", df6_l, ":", precision_nb_scol5)
    print("Array of Accuracy Scores NB-Nea:", df6_l, ":", accuracy_nb_scol5)

    print("Array of Prob Scores XG-Nea:", df6_l, ":", probs_xg_scol5)
    print("Array of F1 Scores XG-Nea:", df6_l, ":", f1_xg_scol5)
    print("Array of ROCAUC Scores XG-Nea:", df6_l, ":", rocauc_xg_scol5)
    print("Array of Recall Scores XG-Nea:", df6_l, ":", recall_xg_scol5)
    print("Array of Precision Scores XG-Nea:", df6_l, ":", precision_xg_scol5)
    print("Array of Accuracy Scores XG-Nea:", df6_l, ":", accuracy_xg_scol5)

    print("Array of Prob Scores RF-Nea:", df6_l, ":", probs_rf_scol5)
    print("Array of F1 Scores RF-Nea:", df6_l, ":", f1_rf_scol5)
    print("Array of ROCAUC Scores RF-Nea:", df6_l, ":", rocauc_rf_scol5)
    print("Array of Recall Scores RF-Nea:", df6_l, ":", recall_rf_scol5)
    print("Array of Precision Scores RF-Nea:", df6_l, ":", precision_rf_scol5)
    print("Array of Accuracy Scores RF-Nea:", df6_l, ":", accuracy_rf_scol5)
    

year5 = [ args.group for t in range(25)]
sampling5 =['Undersampling' for t in range(25)]
technique5 = ['NearMiss' for t in range(25)]
...
x_nm6, y_nm6 = nm.fit_resample(x_tfidf6, df7["label"])
...
for i in train_values:
    ...
    x_train, x_test, y_train, y_test = train_test_split(x_nm6, y_nm6, train_size=i, stratify=y_nm6)
    ...
    print("===Logistic Regression with TfidfVectorizer NearMiss - ", args.group, df7_l, i)
    lr_end = time.time()
    print('Logistic F1-score', fly * 100)
    print('Logistic ROCAUC score:', rocauc_lr * 100)
    print('Logistic Recall score:', recalls_lr * 100)
    ...
    print("===DecisionTreeClassifier with TfidfVectorizer NearMiss - ", args.group, df7_l, i)
    dt_end = time.time()
    print('DCT F1-score', fdct * 100)
    print('DCT ROCAUC score:', rocauc_dt * 100)
    print('DCT Recall score:', recalls_dt * 100)
    ...
    nb_end = time.time()
    # Use accuracy_score function to get the accuracy
    print("===Naive Bayes with TfidfVectorizer NearMiss - ", args.group, df7_l, i)
    print('Naive F1-score', fnb * 100)
    print('Naive ROCAUC score:', rocauc_nb * 100)
    print('Naive Recall score:', recalls_nb * 100)
    print('Naive Precision Score:', precisions_nb * 100)
    ...
    xg_end = time.time()
    print("===XGB with TfidfVectorizer NearMiss - ", args.group, df7_l, i)
    print('XGB F1-Score', fxg * 100)
    print('XGB ROCAUC Score:', rocauc_xg * 100)
    print('XGB Recall score:', recall_xg * 100)
    print('XGB Precision Score:', precisions_xg * 100)
    ...
    rf_end = time.time()
    print("====RandomForest with Tfidf NearMiss ", args.group, df7_l, i)
    print('RFC F1 score', frfc * 100)
    print('RFC ROCAUC Score:', rocauc_rf * 100)
    print('RFC Recall score:', recalls_rf * 100)
    print('RFC Precision Score:', precisions_rf * 100)
    ...
    print("Array of Prob Scores LR-Nea:", df7_l, ":", probs_lr_scol6)
    print("Array of F1 Scores LR-Nea:", df7_l, ":", f1_lr_scol6)
    print("Array of ROCAUC Scores LR-Nea:", df7_l, ":", rocauc_lr_scol6)
    print("Array of Recall Scores LR-Nea:", df7_l, ":", recall_lr_scol6)
    print("Array of Precision Scores LR-Nea:", df7_l, ":", precision_lr_scol6)
    print("Array of Accuracy Scores LR-Nea:", df7_l, ":", accuracy_lr_scol6)

    print("Array of Prob Scores DT-Nea:", df7_l, ":", probs_dt_scol6)
    print("Array of F1 Scores DT-Nea:", df7_l, ":", f1_dt_scol6)
    print("Array of ROCAUC Scores DT-Nea:", df7_l, ":", rocauc_dt_scol6)
    print("Array of Recall Scores DT-Nea:", df7_l, ":", recall_dt_scol6)
    print("Array of Precision Scores DT-Nea:", df7_l, ":", precision_dt_scol6)
    print("Array of Accuracy Scores DT-Nea:", df7_l, ":", accuracy_dt_scol6)

    print("Array of Prob Scores NB-Nea:", df7_l, ":", probs_nb_scol6)
    print("Array of F1 Scores NB-Nea:", df7_l, ":", f1_nb_scol6)
    print("Array of ROCAUC Scores NB-Nea:", df7_l, ":", rocauc_nb_scol6)
    print("Array of Recall Scores NB-Nea:", df7_l, ":", recall_nb_scol6)
    print("Array of Precision Scores NB-Nea:", df7_l, ":", precision_nb_scol6)
    print("Array of Accuracy Scores NB-Nea:", df7_l, ":", accuracy_nb_scol6)

    print("Array of Prob Scores XG-Nea:", df7_l, ":", probs_xg_scol6)
    print("Array of F1 Scores XG-Nea:", df7_l, ":", f1_xg_scol6)
    print("Array of ROCAUC Scores XG-Nea:", df7_l, ":", rocauc_xg_scol6)
    print("Array of Recall Scores XG-Nea:", df7_l, ":", recall_xg_scol6)
    print("Array of Precision Scores XG-Nea:", df7_l, ":", precision_xg_scol6)
    print("Array of Accuracy Scores XG-Nea:", df7_l, ":", accuracy_xg_scol6)

    print("Array of Prob Scores RF-Nea:", df7_l, ":", probs_rf_scol6)
    print("Array of F1 Scores RF-Nea:", df7_l, ":", f1_rf_scol6)
    print("Array of ROCAUC Scores RF-Nea:", df7_l, ":", rocauc_rf_scol6)
    print("Array of Recall Scores RF-Nea:", df7_l, ":", recall_rf_scol6)
    print("Array of Precision Scores RF-Nea:", df7_l, ":", precision_rf_scol6)
    print("Array of Accuracy Scores RF-Nea:", df7_l, ":", accuracy_rf_scol6)

year6 = [ args.group for t in range(25)]
sampling6 =['Undersampling' for t in range(25)]
technique6 = ['NearMiss' for t in range(25)]
...
x_nm7, y_nm7 = nm.fit_resample(x_tfidf7, df8["label"])
...
for i in train_values:
    ...
    x_train, x_test, y_train, y_test = train_test_split(x_nm7, y_nm7, train_size=i, stratify=y_nm7)
    ...
    print("===Logistic Regression with TfidfVectorizer NearMiss - ", args.group, df8_l, i)
    lr_end = time.time()
    print('Logistic F1-score', fly * 100)
    print('Logistic ROCAUC score:', rocauc_lr * 100)
    print('Logistic Recall score:', recalls_lr * 100)
    ...
    print("===DecisionTreeClassifier with TfidfVectorizer NearMiss - ", args.group, df8_l, i)
    dt_end = time.time()
    print('DCT F1-score', fdct * 100)
    print('DCT ROCAUC score:', rocauc_dt * 100)
    print('DCT Recall score:', recalls_dt * 100)
    ...
    nb_end = time.time()
    # Use accuracy_score function to get the accuracy
    print("===Naive Bayes with TfidfVectorizer NearMiss - ", args.group, df8_l, i)
    print('Naive F1-score', fnb * 100)
    print('Naive ROCAUC score:', rocauc_nb * 100)
    print('Naive Recall score:', recalls_nb * 100)
    print('Naive Precision Score:', precisions_nb * 100)
    ...
    xg_end = time.time()
    print("===XGB with TfidfVectorizer NearMiss - ", args.group, df8_l, i)
    print('XGB F1-Score', fxg * 100)
    print('XGB ROCAUC Score:', rocauc_xg * 100)
    print('XGB Recall score:', recall_xg * 100)
    print('XGB Precision Score:', precisions_xg * 100)
    ...
    rf_end = time.time()
    print("====RandomForest with Tfidf NearMiss ", args.group, df8_l, i)
    print('RFC F1 score', frfc * 100)
    print('RFC ROCAUC Score:', rocauc_rf * 100)
    print('RFC Recall score:', recalls_rf * 100)
    print('RFC Precision Score:', precisions_rf * 100)
    ...
    print("Array of Prob Scores LR-Nea:", df8_l, ":", probs_lr_scol7)
    print("Array of F1 Scores LR-Nea:", df8_l, ":", f1_lr_scol7)
    print("Array of ROCAUC Scores LR-Nea:", df8_l, ":", rocauc_lr_scol7)
    print("Array of Recall Scores LR-Nea:", df8_l, ":", recall_lr_scol7)
    print("Array of Precision Scores LR-Nea:", df8_l, ":", precision_lr_scol7)
    print("Array of Accuracy Scores LR-Nea:", df8_l, ":", accuracy_lr_scol7)

    print("Array of Prob Scores DT-Nea:", df8_l, ":", probs_dt_scol7)
    print("Array of F1 Scores DT-Nea:", df8_l, ":", f1_dt_scol7)
    print("Array of ROCAUC Scores DT-Nea:", df8_l, ":", rocauc_dt_scol7)
    print("Array of Recall Scores DT-Nea:", df8_l, ":", recall_dt_scol7)
    print("Array of Precision Scores DT-Nea:", df8_l, ":", precision_dt_scol7)
    print("Array of Accuracy Scores DT-Nea:", df8_l, ":", accuracy_dt_scol7)

    print("Array of Prob Scores NB-Nea:", df8_l, ":", probs_nb_scol7)
    print("Array of F1 Scores NB-Nea:", df8_l, ":", f1_nb_scol7)
    print("Array of ROCAUC Scores NB-Nea:", df8_l, ":", rocauc_nb_scol7)
    print("Array of Recall Scores NB-Nea:", df8_l, ":", recall_nb_scol7)
    print("Array of Precision Scores NB-Nea:", df8_l, ":", precision_nb_scol7)
    print("Array of Accuracy Scores NB-Nea:", df8_l, ":", accuracy_nb_scol7)

    print("Array of Prob Scores XG-Nea:", df8_l, ":", probs_xg_scol7)
    print("Array of F1 Scores XG-Nea:", df8_l, ":", f1_xg_scol7)
    print("Array of ROCAUC Scores XG-Nea:", df8_l, ":", rocauc_xg_scol7)
    print("Array of Recall Scores XG-Nea:", df8_l, ":", recall_xg_scol7)
    print("Array of Precision Scores XG-Nea:", df8_l, ":", precision_xg_scol7)
    print("Array of Accuracy Scores XG-Nea:", df8_l, ":", accuracy_xg_scol7)

    print("Array of Prob Scores RF-Nea:", df8_l, ":", probs_rf_scol7)
    print("Array of F1 Scores RF-Nea:", df8_l, ":", f1_rf_scol7)
    print("Array of ROCAUC Scores RF-Nea:", df8_l, ":", rocauc_rf_scol7)
    print("Array of Recall Scores RF-Nea:", df8_l, ":", recall_rf_scol7)
    print("Array of Precision Scores RF-Nea:", df8_l, ":", precision_rf_scol7)
    print("Array of Accuracy Scores RF-Nea:", df8_l, ":", accuracy_rf_scol7)

year7 = [ args.group for t in range(25)]
sampling7 =['Undersampling' for t in range(25)]
technique7 = ['NearMiss' for t in range(25)]
...
x_nm8, y_nm8 = nm.fit_resample(x_tfidf8, df9["label"])
...
for i in train_values:
    ...
    x_train, x_test, y_train, y_test = train_test_split(x_nm8, y_nm8, train_size=i, stratify=y_nm8)
    ...
    print("===Logistic Regression with TfidfVectorizer NearMiss - ", args.group, df9_l, i)
    lr_end = time.time()
    print('Logistic F1-score', fly * 100)
    print('Logistic ROCAUC score:', rocauc_lr * 100)
    print('Logistic Recall score:', recalls_lr * 100)
    ...
    print("===DecisionTreeClassifier with TfidfVectorizer NearMiss - ", args.group, df9_l, i)
    dt_end = time.time()
    print('DCT F1-score', fdct * 100)
    print('DCT ROCAUC score:', rocauc_dt * 100)
    print('DCT Recall score:', recalls_dt * 100)
    ...
    nb_end = time.time()
    # Use accuracy_score function to get the accuracy
    print("===Naive Bayes with TfidfVectorizer NearMiss - ", args.group, df9_l, i)
    print('Naive F1-score', fnb * 100)
    print('Naive ROCAUC score:', rocauc_nb * 100)
    print('Naive Recall score:', recalls_nb * 100)
    print('Naive Precision Score:', precisions_nb * 100)
    ...
    xg_end = time.time()
    print("===XGB with TfidfVectorizer NearMiss - ", args.group, df9_l, i)
    print('XGB F1-Score', fxg * 100)
    print('XGB ROCAUC Score:', rocauc_xg * 100)
    print('XGB Recall score:', recall_xg * 100)
    print('XGB Precision Score:', precisions_xg * 100)
    ...
    rf_end = time.time()
    print("====RandomForest with Tfidf NearMiss ", args.group, df9_l, i)
    print('RFC F1 score', frfc * 100)
    print('RFC ROCAUC Score:', rocauc_rf * 100)
    print('RFC Recall score:', recalls_rf * 100)
    print('RFC Precision Score:', precisions_rf * 100)
    ...
    print("Array of Prob Scores LR-Nea:", df9_l, ":", probs_lr_scol8)
    print("Array of F1 Scores LR-Nea:", df9_l, ":", f1_lr_scol8)
    print("Array of ROCAUC Scores LR-Nea:", df9_l, ":", rocauc_lr_scol8)
    print("Array of Recall Scores LR-Nea:", df9_l, ":", recall_lr_scol8)
    print("Array of Precision Scores LR-Nea:", df9_l, ":", precision_lr_scol8)
    print("Array of Accuracy Scores LR-Nea:", df9_l, ":", accuracy_lr_scol8)

    print("Array of Prob Scores DT-Nea:", df9_l, ":", probs_dt_scol8)
    print("Array of F1 Scores DT-Nea:", df9_l, ":", f1_dt_scol8)
    print("Array of ROCAUC Scores DT-Nea:", df9_l, ":", rocauc_dt_scol8)
    print("Array of Recall Scores DT-Nea:", df9_l, ":", recall_dt_scol8)
    print("Array of Precision Scores DT-Nea:", df9_l, ":", precision_dt_scol8)
    print("Array of Accuracy Scores DT-Nea:", df9_l, ":", accuracy_dt_scol8)

    print("Array of Prob Scores NB-Nea:", df9_l, ":", probs_nb_scol8)
    print("Array of F1 Scores NB-Nea:", df9_l, ":", f1_nb_scol8)
    print("Array of ROCAUC Scores NB-Nea:", df9_l, ":", rocauc_nb_scol8)
    print("Array of Recall Scores NB-Nea:", df9_l, ":", recall_nb_scol8)
    print("Array of Precision Scores NB-Nea:", df9_l, ":", precision_nb_scol8)
    print("Array of Accuracy Scores NB-Nea:", df9_l, ":", accuracy_nb_scol8)

    print("Array of Prob Scores XG-Nea:", df9_l, ":", probs_xg_scol8)
    print("Array of F1 Scores XG-Nea:", df9_l, ":", f1_xg_scol8)
    print("Array of ROCAUC Scores XG-Nea:", df9_l, ":", rocauc_xg_scol8)
    print("Array of Recall Scores XG-Nea:", df9_l, ":", recall_xg_scol8)
    print("Array of Precision Scores XG-Nea:", df9_l, ":", precision_xg_scol8)
    print("Array of Accuracy Scores XG-Nea:", df9_l, ":", accuracy_xg_scol8)

    print("Array of Prob Scores RF-Nea:", df9_l, ":", probs_rf_scol8)
    print("Array of F1 Scores RF-Nea:", df9_l, ":", f1_rf_scol8)
    print("Array of ROCAUC Scores RF-Nea:", df9_l, ":", rocauc_rf_scol8)
    print("Array of Recall Scores RF-Nea:", df9_l, ":", recall_rf_scol8)
    print("Array of Precision Scores RF-Nea:", df9_l, ":", precision_rf_scol8)
    print("Array of Accuracy Scores RF-Nea:", df9_l, ":", accuracy_rf_scol8)

year8 = [ args.group for t in range(25)]
sampling8 =['Undersampling' for t in range(25)]
technique8 = ['NearMiss' for t in range(25)]
...
x_nm9, y_nm9 = nm.fit_resample(x_tfidf9, df10["label"])
...
for i in train_values:
    ...
    x_train, x_test, y_train, y_test = train_test_split(x_nm9, y_nm9, train_size=i, stratify=y_nm9)
    ...
    print("===Logistic Regression with TfidfVectorizer NearMiss - ", args.group, df10_l, i)
    lr_end = time.time()
    print('Logistic F1-score', fly * 100)
    print('Logistic ROCAUC score:', rocauc_lr * 100)
    print('Logistic Recall score:', recalls_lr * 100)
    ...
    print("===DecisionTreeClassifier with TfidfVectorizer NearMiss - ", args.group, df10_l, i)
    dt_end = time.time()
    print('DCT F1-score', fdct * 100)
    print('DCT ROCAUC score:', rocauc_dt * 100)
    print('DCT Recall score:', recalls_dt * 100)
    ...
    nb_end = time.time()
    # Use accuracy_score function to get the accuracy
    print("===Naive Bayes with TfidfVectorizer NearMiss - ", args.group, df10_l, i)
    print('Naive F1-score', fnb * 100)
    print('Naive ROCAUC score:', rocauc_nb * 100)
    print('Naive Recall score:', recalls_nb * 100)
    print('Naive Precision Score:', precisions_nb * 100)
    ...
    xg_end = time.time()
    print("===XGB with TfidfVectorizer NearMiss - ", args.group, df10_l, i)
    print('XGB F1-Score', fxg * 100)
    print('XGB ROCAUC Score:', rocauc_xg * 100)
    print('XGB Recall score:', recall_xg * 100)
    print('XGB Precision Score:', precisions_xg * 100)
    ...
    rf_end = time.time()
    print("====RandomForest with Tfidf NearMiss ", args.group, df10_l, i)
    print('RFC F1 score', frfc * 100)
    print('RFC ROCAUC Score:', rocauc_rf * 100)
    print('RFC Recall score:', recalls_rf * 100)
    print('RFC Precision Score:', precisions_rf * 100)
    ...
    print("Array of Prob Scores LR-Nea:", df10_l, ":", probs_lr_scol9)
    print("Array of F1 Scores LR-Nea:", df10_l, ":", f1_lr_scol9)
    print("Array of ROCAUC Scores LR-Nea:", df10_l, ":", rocauc_lr_scol9)
    print("Array of Recall Scores LR-Nea:", df10_l, ":", recall_lr_scol9)
    print("Array of Precision Scores LR-Nea:", df10_l, ":", precision_lr_scol9)
    print("Array of Accuracy Scores LR-Nea:", df10_l, ":", accuracy_lr_scol9)

    print("Array of Prob Scores DT-Nea:", df10_l, ":", probs_dt_scol9)
    print("Array of F1 Scores DT-Nea:", df10_l, ":", f1_dt_scol9)
    print("Array of ROCAUC Scores DT-Nea:", df10_l, ":", rocauc_dt_scol9)
    print("Array of Recall Scores DT-Nea:", df10_l, ":", recall_dt_scol9)
    print("Array of Precision Scores DT-Nea:", df10_l, ":", precision_dt_scol9)
    print("Array of Accuracy Scores DT-Nea:", df10_l, ":", accuracy_dt_scol9)

    print("Array of Prob Scores NB-Nea:", df10_l, ":", probs_nb_scol9)
    print("Array of F1 Scores NB-Nea:", df10_l, ":", f1_nb_scol9)
    print("Array of ROCAUC Scores NB-Nea:", df10_l, ":", rocauc_nb_scol9)
    print("Array of Recall Scores NB-Nea:", df10_l, ":", recall_nb_scol9)
    print("Array of Precision Scores NB-Nea:", df10_l, ":", precision_nb_scol9)
    print("Array of Accuracy Scores NB-Nea:", df10_l, ":", accuracy_nb_scol9)

    print("Array of Prob Scores XG-Nea:", df10_l, ":", probs_xg_scol9)
    print("Array of F1 Scores XG-Nea:", df10_l, ":", f1_xg_scol9)
    print("Array of ROCAUC Scores XG-Nea:", df10_l, ":", rocauc_xg_scol9)
    print("Array of Recall Scores XG-Nea:", df10_l, ":", recall_xg_scol9)
    print("Array of Precision Scores XG-Nea:", df10_l, ":", precision_xg_scol9)
    print("Array of Accuracy Scores XG-Nea:", df10_l, ":", accuracy_xg_scol9)

    print("Array of Prob Scores RF-Nea:", df10_l, ":", probs_rf_scol9)
    print("Array of F1 Scores RF-Nea:", df10_l, ":", f1_rf_scol9)
    print("Array of ROCAUC Scores RF-Nea:", df10_l, ":", rocauc_rf_scol9)
    print("Array of Recall Scores RF-Nea:", df10_l, ":", recall_rf_scol9)
    print("Array of Precision Scores RF-Nea:", df10_l, ":", precision_rf_scol9)
    print("Array of Accuracy Scores RF-Nea:", df10_l, ":", accuracy_rf_scol9)

year9 = [ args.group for t in range(25)]
sampling9 =['Undersampling' for t in range(25)]
technique9 = ['NearMiss' for t in range(25)]
...
x_nm10, y_nm10 = nm.fit_resample(x_tfidf10, df11["label"])
...
for i in train_values:
    ...
    x_train, x_test, y_train, y_test = train_test_split(x_nm10, y_nm10, train_size=i, stratify=y_nm10)
    ...
    print("===Logistic Regression with TfidfVectorizer NearMiss - ", args.group, df11_l, i)
    lr_end = time.time()
    print('Logistic F1-score', fly * 100)
    print('Logistic ROCAUC score:', rocauc_lr * 100)
    print('Logistic Recall score:', recalls_lr * 100)
    ...
    print("===DecisionTreeClassifier with TfidfVectorizer NearMiss - ", args.group, df11_l, i)
    dt_end = time.time()
    print('DCT F1-score', fdct * 100)
    print('DCT ROCAUC score:', rocauc_dt * 100)
    print('DCT Recall score:', recalls_dt * 100)
    ...
    nb_end = time.time()
    # Use accuracy_score function to get the accuracy
    print("===Naive Bayes with TfidfVectorizer NearMiss - ", args.group, df11_l, i)
    print('Naive F1-score', fnb * 100)
    print('Naive ROCAUC score:', rocauc_nb * 100)
    print('Naive Recall score:', recalls_nb * 100)
    print('Naive Precision Score:', precisions_nb * 100)
    ...
    xg_end = time.time()
    print("===XGB with TfidfVectorizer NearMiss - ", args.group, df11_l, i)
    print('XGB F1-Score', fxg * 100)
    print('XGB ROCAUC Score:', rocauc_xg * 100)
    print('XGB Recall score:', recall_xg * 100)
    print('XGB Precision Score:', precisions_xg * 100)
    ...
    rf_end = time.time()
    print("====RandomForest with Tfidf NearMiss ", args.group, df11_l, i)
    print('RFC F1 score', frfc * 100)
    print('RFC ROCAUC Score:', rocauc_rf * 100)
    print('RFC Recall score:', recalls_rf * 100)
    print('RFC Precision Score:', precisions_rf * 100)
    ...
    print("Array of Prob Scores LR-Nea:", df11_l, ":", probs_lr_scol10)
    print("Array of F1 Scores LR-Nea:", df11_l, ":", f1_lr_scol10)
    print("Array of ROCAUC Scores LR-Nea:", df11_l, ":", rocauc_lr_scol10)
    print("Array of Recall Scores LR-Nea:", df11_l, ":", recall_lr_scol10)
    print("Array of Precision Scores LR-Nea:", df11_l, ":", precision_lr_scol10)
    print("Array of Accuracy Scores LR-Nea:", df11_l, ":", accuracy_lr_scol10)

    print("Array of Prob Scores DT-Nea:", df11_l, ":", probs_dt_scol10)
    print("Array of F1 Scores DT-Nea:", df11_l, ":", f1_dt_scol10)
    print("Array of ROCAUC Scores DT-Nea:", df11_l, ":", rocauc_dt_scol10)
    print("Array of Recall Scores DT-Nea:", df11_l, ":", recall_dt_scol10)
    print("Array of Precision Scores DT-Nea:", df11_l, ":", precision_dt_scol10)
    print("Array of Accuracy Scores DT-Nea:", df11_l, ":", accuracy_dt_scol10)

    print("Array of Prob Scores NB-Nea:", df11_l, ":", probs_nb_scol10)
    print("Array of F1 Scores NB-Nea:", df11_l, ":", f1_nb_scol10)
    print("Array of ROCAUC Scores NB-Nea:", df11_l, ":", rocauc_nb_scol10)
    print("Array of Recall Scores NB-Nea:", df11_l, ":", recall_nb_scol10)
    print("Array of Precision Scores NB-Nea:", df11_l, ":", precision_nb_scol10)
    print("Array of Accuracy Scores NB-Nea:", df11_l, ":", accuracy_nb_scol10)

    print("Array of Prob Scores XG-Nea:", df11_l, ":", probs_xg_scol10)
    print("Array of F1 Scores XG-Nea:", df11_l, ":", f1_xg_scol10)
    print("Array of ROCAUC Scores XG-Nea:", df11_l, ":", rocauc_xg_scol10)
    print("Array of Recall Scores XG-Nea:", df11_l, ":", recall_xg_scol10)
    print("Array of Precision Scores XG-Nea:", df11_l, ":", precision_xg_scol10)
    print("Array of Accuracy Scores XG-Nea:", df11_l, ":", accuracy_xg_scol10)

    print("Array of Prob Scores RF-Nea:", df11_l, ":", probs_rf_scol10)
    print("Array of F1 Scores RF-Nea:", df11_l, ":", f1_rf_scol10)
    print("Array of ROCAUC Scores RF-Nea:", df11_l, ":", rocauc_rf_scol10)
    print("Array of Recall Scores RF-Nea:", df11_l, ":", recall_rf_scol10)
    print("Array of Precision Scores RF-Nea:", df11_l, ":", precision_rf_scol10)
    print("Array of Accuracy Scores RF-Nea:", df11_l, ":", accuracy_rf_scol10)
    

year10 = [ args.group for t in range(25)]
sampling10 =['Undersampling' for t in range(25)]
technique10 = ['NearMiss' for t in range(25)]
...
x_nm11, y_nm11 = nm.fit_resample(x_tfidf11, df12["label"])
...
for i in train_values:
    ...
    x_train, x_test, y_train, y_test = train_test_split(x_nm11, y_nm11, train_size=i, stratify=y_nm11)
    ...
    print("===Logistic Regression with TfidfVectorizer NearMiss - ", args.group, df12_l, i)
    lr_end = time.time()
    print('Logistic F1-score', fly * 100)
    print('Logistic ROCAUC score:', rocauc_lr * 100)
    print('Logistic Recall score:', recalls_lr * 100)
    ...
    print("===DecisionTreeClassifier with TfidfVectorizer NearMiss - ", args.group, df12_l, i)
    dt_end = time.time()
    print('DCT F1-score', fdct * 100)
    print('DCT ROCAUC score:', rocauc_dt * 100)
    print('DCT Recall score:', recalls_dt * 100)
    ...
    nb_end = time.time()
    # Use accuracy_score function to get the accuracy
    print("===Naive Bayes with TfidfVectorizer NearMiss - ", args.group, df12_l, i)
    print('Naive F1-score', fnb * 100)
    print('Naive ROCAUC score:', rocauc_nb * 100)
    print('Naive Recall score:', recalls_nb * 100)
    print('Naive Precision Score:', precisions_nb * 100)
    ...
    xg_end = time.time()
    print("===XGB with TfidfVectorizer NearMiss - ", args.group, df12_l, i)
    print('XGB F1-Score', fxg * 100)
    print('XGB ROCAUC Score:', rocauc_xg * 100)
    print('XGB Recall score:', recall_xg * 100)
    print('XGB Precision Score:', precisions_xg * 100)
    ...
    rf_end = time.time()
    print("====RandomForest with Tfidf NearMiss ", args.group, df12_l, i)
    print('RFC F1 score', frfc * 100)
    print('RFC ROCAUC Score:', rocauc_rf * 100)
    print('RFC Recall score:', recalls_rf * 100)
    print('RFC Precision Score:', precisions_rf * 100)
    ...
    print("Array of Prob Scores LR-Nea:", df12_l, ":", probs_lr_scol11)
    print("Array of F1 Scores LR-Nea:", df12_l, ":", f1_lr_scol11)
    print("Array of ROCAUC Scores LR-Nea:", df12_l, ":", rocauc_lr_scol11)
    print("Array of Recall Scores LR-Nea:", df12_l, ":", recall_lr_scol11)
    print("Array of Precision Scores LR-Nea:", df12_l, ":", precision_lr_scol11)
    print("Array of Accuracy Scores LR-Nea:", df12_l, ":", accuracy_lr_scol11)

    print("Array of Prob Scores DT-Nea:", df12_l, ":", probs_dt_scol11)
    print("Array of F1 Scores DT-Nea:", df12_l, ":", f1_dt_scol11)
    print("Array of ROCAUC Scores DT-Nea:", df12_l, ":", rocauc_dt_scol11)
    print("Array of Recall Scores DT-Nea:", df12_l, ":", recall_dt_scol11)
    print("Array of Precision Scores DT-Nea:", df12_l, ":", precision_dt_scol11)
    print("Array of Accuracy Scores DT-Nea:", df12_l, ":", accuracy_dt_scol11)

    print("Array of Prob Scores NB-Nea:", df12_l, ":", probs_nb_scol11)
    print("Array of F1 Scores NB-Nea:", df12_l, ":", f1_nb_scol11)
    print("Array of ROCAUC Scores NB-Nea:", df12_l, ":", rocauc_nb_scol11)
    print("Array of Recall Scores NB-Nea:", df12_l, ":", recall_nb_scol11)
    print("Array of Precision Scores NB-Nea:", df12_l, ":", precision_nb_scol11)
    print("Array of Accuracy Scores NB-Nea:", df12_l, ":", accuracy_nb_scol11)

    print("Array of Prob Scores XG-Nea:", df12_l, ":", probs_xg_scol11)
    print("Array of F1 Scores XG-Nea:", df12_l, ":", f1_xg_scol11)
    print("Array of ROCAUC Scores XG-Nea:", df12_l, ":", rocauc_xg_scol11)
    print("Array of Recall Scores XG-Nea:", df12_l, ":", recall_xg_scol11)
    print("Array of Precision Scores XG-Nea:", df12_l, ":", precision_xg_scol11)
    print("Array of Accuracy Scores XG-Nea:", df12_l, ":", accuracy_xg_scol11)

    print("Array of Prob Scores RF-Nea:", df12_l, ":", probs_rf_scol11)
    print("Array of F1 Scores RF-Nea:", df12_l, ":", f1_rf_scol11)
    print("Array of ROCAUC Scores RF-Nea:", df12_l, ":", rocauc_rf_scol11)
    print("Array of Recall Scores RF-Nea:", df12_l, ":", recall_rf_scol11)
    print("Array of Precision Scores RF-Nea:", df12_l, ":", precision_rf_scol11)
    print("Array of Accuracy Scores RF-Nea:", df12_l, ":", accuracy_rf_scol11)

year11 = [ args.group for t in range(25)]
sampling11 =['Undersampling' for t in range(25)]
technique11 = ['NearMiss' for t in range(25)]
...
x_nm12, y_nm12 = nm.fit_resample(x_tfidf12, df13["label"])
...
for i in train_values:
    ...
    x_train, x_test, y_train, y_test = train_test_split(x_nm12, y_nm12, train_size=i, stratify=y_nm12)
    ...
    print("===Logistic Regression with TfidfVectorizer NearMiss - ", args.group, df13_l, i)
    lr_end = time.time()
    print('Logistic F1-score', fly * 100)
    print('Logistic ROCAUC score:', rocauc_lr * 100)
    print('Logistic Recall score:', recalls_lr * 100)
    ...
    print("===DecisionTreeClassifier with TfidfVectorizer NearMiss - ", args.group, df13_l, i)
    dt_end = time.time()
    print('DCT F1-score', fdct * 100)
    print('DCT ROCAUC score:', rocauc_dt * 100)
    print('DCT Recall score:', recalls_dt * 100)
    ...
    nb_end = time.time()
    # Use accuracy_score function to get the accuracy
    print("===Naive Bayes with TfidfVectorizer NearMiss - ", args.group, df13_l, i)
    print('Naive F1-score', fnb * 100)
    print('Naive ROCAUC score:', rocauc_nb * 100)
    print('Naive Recall score:', recalls_nb * 100)
    print('Naive Precision Score:', precisions_nb * 100)
    ...
    xg_end = time.time()
    print("===XGB with TfidfVectorizer NearMiss - ", args.group, df13_l, i)
    print('XGB F1-Score', fxg * 100)
    print('XGB ROCAUC Score:', rocauc_xg * 100)
    print('XGB Recall score:', recall_xg * 100)
    print('XGB Precision Score:', precisions_xg * 100)
    ...
    rf_end = time.time()
    print("====RandomForest with Tfidf NearMiss ", args.group, df13_l, i)
    print('RFC F1 score', frfc * 100)
    print('RFC ROCAUC Score:', rocauc_rf * 100)
    print('RFC Recall score:', recalls_rf * 100)
    print('RFC Precision Score:', precisions_rf * 100)
    ...
    print("Array of Prob Scores LR-Nea:", df13_l, ":", probs_lr_scol12)
    print("Array of F1 Scores LR-Nea:", df13_l, ":", f1_lr_scol12)
    print("Array of ROCAUC Scores LR-Nea:", df13_l, ":", rocauc_lr_scol12)
    print("Array of Recall Scores LR-Nea:", df13_l, ":", recall_lr_scol12)
    print("Array of Precision Scores LR-Nea:", df13_l, ":", precision_lr_scol12)
    print("Array of Accuracy Scores LR-Nea:", df13_l, ":", accuracy_lr_scol12)

    print("Array of Prob Scores DT-Nea:", df13_l, ":", probs_dt_scol12)
    print("Array of F1 Scores DT-Nea:", df13_l, ":", f1_dt_scol12)
    print("Array of ROCAUC Scores DT-Nea:", df13_l, ":", rocauc_dt_scol12)
    print("Array of Recall Scores DT-Nea:", df13_l, ":", recall_dt_scol12)
    print("Array of Precision Scores DT-Nea:", df13_l, ":", precision_dt_scol12)
    print("Array of Accuracy Scores DT-Nea:", df13_l, ":", accuracy_dt_scol12)

    print("Array of Prob Scores NB-Nea:", df13_l, ":", probs_nb_scol12)
    print("Array of F1 Scores NB-Nea:", df13_l, ":", f1_nb_scol12)
    print("Array of ROCAUC Scores NB-Nea:", df13_l, ":", rocauc_nb_scol12)
    print("Array of Recall Scores NB-Nea:", df13_l, ":", recall_nb_scol12)
    print("Array of Precision Scores NB-Nea:", df13_l, ":", precision_nb_scol12)
    print("Array of Accuracy Scores NB-Nea:", df13_l, ":", accuracy_nb_scol12)

    print("Array of Prob Scores XG-Nea:", df13_l, ":", probs_xg_scol12)
    print("Array of F1 Scores XG-Nea:", df13_l, ":", f1_xg_scol12)
    print("Array of ROCAUC Scores XG-Nea:", df13_l, ":", rocauc_xg_scol12)
    print("Array of Recall Scores XG-Nea:", df13_l, ":", recall_xg_scol12)
    print("Array of Precision Scores XG-Nea:", df13_l, ":", precision_xg_scol12)
    print("Array of Accuracy Scores XG-Nea:", df13_l, ":", accuracy_xg_scol12)

    print("Array of Prob Scores RF-Nea:", df13_l, ":", probs_rf_scol12)
    print("Array of F1 Scores RF-Nea:", df13_l, ":", f1_rf_scol12)
    print("Array of ROCAUC Scores RF-Nea:", df13_l, ":", rocauc_rf_scol12)
    print("Array of Recall Scores RF-Nea:", df13_l, ":", recall_rf_scol12)
    print("Array of Precision Scores RF-Nea:", df13_l, ":", precision_rf_scol12)
    print("Array of Accuracy Scores RF-Nea:", df13_l, ":", accuracy_rf_scol12)

year12 = [ args.group for t in range(25)]
sampling12 =['Undersampling' for t in range(25)]
technique12 = ['NearMiss' for t in range(25)]
...
x_nm13, y_nm13 = nm.fit_resample(x_tfidf13, df14["label"])
...
for i in train_values:
    ...
    x_train, x_test, y_train, y_test = train_test_split(x_nm13, y_nm13, train_size=i, stratify=y_nm13)
    ...
    print("===Logistic Regression with TfidfVectorizer NearMiss - ", args.group, df14_l, i)
    lr_end = time.time()
    print('Logistic F1-score', fly * 100)
    print('Logistic ROCAUC score:', rocauc_lr * 100)
    print('Logistic Recall score:', recalls_lr * 100)
    ...
    print("===DecisionTreeClassifier with TfidfVectorizer NearMiss - ", args.group, df14_l, i)
    dt_end = time.time()
    print('DCT F1-score', fdct * 100)
    print('DCT ROCAUC score:', rocauc_dt * 100)
    print('DCT Recall score:', recalls_dt * 100)
    ...
    nb_end = time.time()
    # Use accuracy_score function to get the accuracy
    print("===Naive Bayes with TfidfVectorizer NearMiss - ", args.group, df14_l, i)
    print('Naive F1-score', fnb * 100)
    print('Naive ROCAUC score:', rocauc_nb * 100)
    print('Naive Recall score:', recalls_nb * 100)
    print('Naive Precision Score:', precisions_nb * 100)
    ...
    xg_end = time.time()
    print("===XGB with TfidfVectorizer NearMiss - ", args.group, df14_l, i)
    print('XGB F1-Score', fxg * 100)
    print('XGB ROCAUC Score:', rocauc_xg * 100)
    print('XGB Recall score:', recall_xg * 100)
    print('XGB Precision Score:', precisions_xg * 100)
    ...
    rf_end = time.time()
    print("====RandomForest with Tfidf NearMiss ", args.group, df14_l, i)
    print('RFC F1 score', frfc * 100)
    print('RFC ROCAUC Score:', rocauc_rf * 100)
    print('RFC Recall score:', recalls_rf * 100)
    print('RFC Precision Score:', precisions_rf * 100)
    ...
    print("Array of Prob Scores LR-Nea:", df14_l, ":", probs_lr_scol13)
    print("Array of F1 Scores LR-Nea:", df14_l, ":", f1_lr_scol13)
    print("Array of ROCAUC Scores LR-Nea:", df14_l, ":", rocauc_lr_scol13)
    print("Array of Recall Scores LR-Nea:", df14_l, ":", recall_lr_scol13)
    print("Array of Precision Scores LR-Nea:", df14_l, ":", precision_lr_scol13)
    print("Array of Accuracy Scores LR-Nea:", df14_l, ":", accuracy_lr_scol13)

    print("Array of Prob Scores DT-Nea:", df14_l, ":", probs_dt_scol13)
    print("Array of F1 Scores DT-Nea:", df14_l, ":", f1_dt_scol13)
    print("Array of ROCAUC Scores DT-Nea:", df14_l, ":", rocauc_dt_scol13)
    print("Array of Recall Scores DT-Nea:", df14_l, ":", recall_dt_scol13)
    print("Array of Precision Scores DT-Nea:", df14_l, ":", precision_dt_scol13)
    print("Array of Accuracy Scores DT-Nea:", df14_l, ":", accuracy_dt_scol13)

    print("Array of Prob Scores NB-Nea:", df14_l, ":", probs_nb_scol13)
    print("Array of F1 Scores NB-Nea:", df14_l, ":", f1_nb_scol13)
    print("Array of ROCAUC Scores NB-Nea:", df14_l, ":", rocauc_nb_scol13)
    print("Array of Recall Scores NB-Nea:", df14_l, ":", recall_nb_scol13)
    print("Array of Precision Scores NB-Nea:", df14_l, ":", precision_nb_scol13)
    print("Array of Accuracy Scores NB-Nea:", df14_l, ":", accuracy_nb_scol13)

    print("Array of Prob Scores XG-Nea:", df14_l, ":", probs_xg_scol13)
    print("Array of F1 Scores XG-Nea:", df14_l, ":", f1_xg_scol13)
    print("Array of ROCAUC Scores XG-Nea:", df14_l, ":", rocauc_xg_scol13)
    print("Array of Recall Scores XG-Nea:", df14_l, ":", recall_xg_scol13)
    print("Array of Precision Scores XG-Nea:", df14_l, ":", precision_xg_scol13)
    print("Array of Accuracy Scores XG-Nea:", df14_l, ":", accuracy_xg_scol13)

    print("Array of Prob Scores RF-Nea:", df14_l, ":", probs_rf_scol13)
    print("Array of F1 Scores RF-Nea:", df14_l, ":", f1_rf_scol13)
    print("Array of ROCAUC Scores RF-Nea:", df14_l, ":", rocauc_rf_scol13)
    print("Array of Recall Scores RF-Nea:", df14_l, ":", recall_rf_scol13)
    print("Array of Precision Scores RF-Nea:", df14_l, ":", precision_rf_scol13)
    print("Array of Accuracy Scores RF-Nea:", df14_l, ":", accuracy_rf_scol13)

year13 = [ args.group for t in range(25)]
sampling13 =['Undersampling' for t in range(25)]
technique13 = ['NearMiss' for t in range(25)]
...
x_nm14, y_nm14 = nm.fit_resample(x_tfidf14, df15["label"])
...
for i in train_values:
    ...
    x_train, x_test, y_train, y_test = train_test_split(x_nm14, y_nm14, train_size=i, stratify=y_nm14)
    ...
    print("===Logistic Regression with TfidfVectorizer NearMiss - ", args.group, df15_l, i)
    lr_end = time.time()
    print('Logistic F1-score', fly * 100)
    print('Logistic ROCAUC score:', rocauc_lr * 100)
    print('Logistic Recall score:', recalls_lr * 100)
    ...
    print("===DecisionTreeClassifier with TfidfVectorizer NearMiss - ", args.group, df15_l, i)
    dt_end = time.time()
    print('DCT F1-score', fdct * 100)
    print('DCT ROCAUC score:', rocauc_dt * 100)
    print('DCT Recall score:', recalls_dt * 100)
    ...
    nb_end = time.time()
    # Use accuracy_score function to get the accuracy
    print("===Naive Bayes with TfidfVectorizer NearMiss - ", args.group, df15_l, i)
    print('Naive F1-score', fnb * 100)
    print('Naive ROCAUC score:', rocauc_nb * 100)
    print('Naive Recall score:', recalls_nb * 100)
    print('Naive Precision Score:', precisions_nb * 100)
    ...
    xg_end = time.time()
    print("===XGB with TfidfVectorizer NearMiss - ", args.group, df15_l, i)
    print('XGB F1-Score', fxg * 100)
    print('XGB ROCAUC Score:', rocauc_xg * 100)
    print('XGB Recall score:', recall_xg * 100)
    print('XGB Precision Score:', precisions_xg * 100)
    ...
    rf_end = time.time()
    print("====RandomForest with Tfidf NearMiss ", args.group, df15_l, i)
    print('RFC F1 score', frfc * 100)
    print('RFC ROCAUC Score:', rocauc_rf * 100)
    print('RFC Recall score:', recalls_rf * 100)
    print('RFC Precision Score:', precisions_rf * 100)
    ...
    print("Array of Prob Scores LR-Nea:", df15_l, ":", probs_lr_scol14)
    print("Array of F1 Scores LR-Nea:", df15_l, ":", f1_lr_scol14)
    print("Array of ROCAUC Scores LR-Nea:", df15_l, ":", rocauc_lr_scol14)
    print("Array of Recall Scores LR-Nea:", df15_l, ":", recall_lr_scol14)
    print("Array of Precision Scores LR-Nea:", df15_l, ":", precision_lr_scol14)
    print("Array of Accuracy Scores LR-Nea:", df15_l, ":", accuracy_lr_scol14)

    print("Array of Prob Scores DT-Nea:", df15_l, ":", probs_dt_scol14)
    print("Array of F1 Scores DT-Nea:", df15_l, ":", f1_dt_scol14)
    print("Array of ROCAUC Scores DT-Nea:", df15_l, ":", rocauc_dt_scol14)
    print("Array of Recall Scores DT-Nea:", df15_l, ":", recall_dt_scol14)
    print("Array of Precision Scores DT-Nea:", df15_l, ":", precision_dt_scol14)
    print("Array of Accuracy Scores DT-Nea:", df15_l, ":", accuracy_dt_scol14)

    print("Array of Prob Scores NB-Nea:", df15_l, ":", probs_nb_scol14)
    print("Array of F1 Scores NB-Nea:", df15_l, ":", f1_nb_scol14)
    print("Array of ROCAUC Scores NB-Nea:", df15_l, ":", rocauc_nb_scol14)
    print("Array of Recall Scores NB-Nea:", df15_l, ":", recall_nb_scol14)
    print("Array of Precision Scores NB-Nea:", df15_l, ":", precision_nb_scol14)
    print("Array of Accuracy Scores NB-Nea:", df15_l, ":", accuracy_nb_scol14)

    print("Array of Prob Scores XG-Nea:", df15_l, ":", probs_xg_scol14)
    print("Array of F1 Scores XG-Nea:", df15_l, ":", f1_xg_scol14)
    print("Array of ROCAUC Scores XG-Nea:", df15_l, ":", rocauc_xg_scol14)
    print("Array of Recall Scores XG-Nea:", df15_l, ":", recall_xg_scol14)
    print("Array of Precision Scores XG-Nea:", df15_l, ":", precision_xg_scol14)
    print("Array of Accuracy Scores XG-Nea:", df15_l, ":", accuracy_xg_scol14)

    print("Array of Prob Scores RF-Nea:", df15_l, ":", probs_rf_scol14)
    print("Array of F1 Scores RF-Nea:", df15_l, ":", f1_rf_scol14)
    print("Array of ROCAUC Scores RF-Nea:", df15_l, ":", rocauc_rf_scol14)
    print("Array of Recall Scores RF-Nea:", df15_l, ":", recall_rf_scol14)
    print("Array of Precision Scores RF-Nea:", df15_l, ":", precision_rf_scol14)
    print("Array of Accuracy Scores RF-Nea:", df15_l, ":", accuracy_rf_scol14)

year14 = [ args.group for t in range(25)]
sampling14 =['Undersampling' for t in range(25)]
technique14 = ['NearMiss' for t in range(25)]
...
x_nm15, y_nm15 = nm.fit_resample(x_tfidf15, df16["label"])
...
for i in train_values:
    ...
    x_train, x_test, y_train, y_test = train_test_split(x_nm15, y_nm15, train_size=i, stratify=y_nm15)
    ...
    print("===Logistic Regression with TfidfVectorizer NearMiss - ", args.group, df16_l, i)
    lr_end = time.time()
    print('Logistic F1-score', fly * 100)
    print('Logistic ROCAUC score:', rocauc_lr * 100)
    print('Logistic Recall score:', recalls_lr * 100)
    ...
    print("===DecisionTreeClassifier with TfidfVectorizer NearMiss - ", args.group, df16_l, i)
    dt_end = time.time()
    print('DCT F1-score', fdct * 100)
    print('DCT ROCAUC score:', rocauc_dt * 100)
    print('DCT Recall score:', recalls_dt * 100)
    ...
    nb_end = time.time()
    # Use accuracy_score function to get the accuracy
    print("===Naive Bayes with TfidfVectorizer NearMiss - ", args.group, df16_l, i)
    print('Naive F1-score', fnb * 100)
    print('Naive ROCAUC score:', rocauc_nb * 100)
    print('Naive Recall score:', recalls_nb * 100)
    print('Naive Precision Score:', precisions_nb * 100)
    ...
    xg_end = time.time()
    print("===XGB with TfidfVectorizer NearMiss - ", args.group, df16_l, i)
    print('XGB F1-Score', fxg * 100)
    print('XGB ROCAUC Score:', rocauc_xg * 100)
    print('XGB Recall score:', recall_xg * 100)
    print('XGB Precision Score:', precisions_xg * 100)
    ...
    rf_end = time.time()
    print("====RandomForest with Tfidf NearMiss ", args.group, df16_l, i)
    print('RFC F1 score', frfc * 100)
    print('RFC ROCAUC Score:', rocauc_rf * 100)
    print('RFC Recall score:', recalls_rf * 100)
    print('RFC Precision Score:', precisions_rf * 100)
    ...
    print("Array of Prob Scores LR-Nea:", df16_l, ":", probs_lr_scol15)
    print("Array of F1 Scores LR-Nea:", df16_l, ":", f1_lr_scol15)
    print("Array of ROCAUC Scores LR-Nea:", df16_l, ":", rocauc_lr_scol15)
    print("Array of Recall Scores LR-Nea:", df16_l, ":", recall_lr_scol15)
    print("Array of Precision Scores LR-Nea:", df16_l, ":", precision_lr_scol15)
    print("Array of Accuracy Scores LR-Nea:", df16_l, ":", accuracy_lr_scol15)

    print("Array of Prob Scores DT-Nea:", df16_l, ":", probs_dt_scol15)
    print("Array of F1 Scores DT-Nea:", df16_l, ":", f1_dt_scol15)
    print("Array of ROCAUC Scores DT-Nea:", df16_l, ":", rocauc_dt_scol15)
    print("Array of Recall Scores DT-Nea:", df16_l, ":", recall_dt_scol15)
    print("Array of Precision Scores DT-Nea:", df16_l, ":", precision_dt_scol15)
    print("Array of Accuracy Scores DT-Nea:", df16_l, ":", accuracy_dt_scol15)

    print("Array of Prob Scores NB-Nea:", df16_l, ":", probs_nb_scol15)
    print("Array of F1 Scores NB-Nea:", df16_l, ":", f1_nb_scol15)
    print("Array of ROCAUC Scores NB-Nea:", df16_l, ":", rocauc_nb_scol15)
    print("Array of Recall Scores NB-Nea:", df16_l, ":", recall_nb_scol15)
    print("Array of Precision Scores NB-Nea:", df16_l, ":", precision_nb_scol15)
    print("Array of Accuracy Scores NB-Nea:", df16_l, ":", accuracy_nb_scol15)

    print("Array of Prob Scores XG-Nea:", df16_l, ":", probs_xg_scol15)
    print("Array of F1 Scores XG-Nea:", df16_l, ":", f1_xg_scol15)
    print("Array of ROCAUC Scores XG-Nea:", df16_l, ":", rocauc_xg_scol15)
    print("Array of Recall Scores XG-Nea:", df16_l, ":", recall_xg_scol15)
    print("Array of Precision Scores XG-Nea:", df16_l, ":", precision_xg_scol15)
    print("Array of Accuracy Scores XG-Nea:", df16_l, ":", accuracy_xg_scol15)

    print("Array of Prob Scores RF-Nea:", df16_l, ":", probs_rf_scol15)
    print("Array of F1 Scores RF-Nea:", df16_l, ":", f1_rf_scol15)
    print("Array of ROCAUC Scores RF-Nea:", df16_l, ":", rocauc_rf_scol15)
    print("Array of Recall Scores RF-Nea:", df16_l, ":", recall_rf_scol15)
    print("Array of Precision Scores RF-Nea:", df16_l, ":", precision_rf_scol15)
    print("Array of Accuracy Scores RF-Nea:", df16_l, ":", accuracy_rf_scol15)
    

year15 = [ args.group for t in range(25)]
sampling15 = ['Undersampling' for t in range(25)]
technique15 = ['NearMiss' for t in range(25)]
...
x_nm16, y_nm16 = nm.fit_resample(x_tfidf16, df17["label"])
...
for i in train_values:
    ...
    x_train, x_test, y_train, y_test = train_test_split(x_nm16, y_nm16, train_size=i, stratify=y_nm16)
    ...
    print("===Logistic Regression with TfidfVectorizer NearMiss - ", args.group, df17_l, i)
    lr_end = time.time()
    print('Logistic F1-score', fly * 100)
    print('Logistic ROCAUC score:', rocauc_lr * 100)
    print('Logistic Recall score:', recalls_lr * 100)
    ...
    print("===DecisionTreeClassifier with TfidfVectorizer NearMiss - ", args.group, df17_l, i)
    dt_end = time.time()
    print('DCT F1-score', fdct * 100)
    print('DCT ROCAUC score:', rocauc_dt * 100)
    print('DCT Recall score:', recalls_dt * 100)
    ...
    nb_end = time.time()
    # Use accuracy_score function to get the accuracy
    print("===Naive Bayes with TfidfVectorizer NearMiss - ", args.group, df17_l, i)
    print('Naive F1-score', fnb * 100)
    print('Naive ROCAUC score:', rocauc_nb * 100)
    print('Naive Recall score:', recalls_nb * 100)
    print('Naive Precision Score:', precisions_nb * 100)
    ...
    xg_end = time.time()
    print("===XGB with TfidfVectorizer NearMiss - ", args.group, df17_l, i)
    print('XGB F1-Score', fxg * 100)
    print('XGB ROCAUC Score:', rocauc_xg * 100)
    print('XGB Recall score:', recall_xg * 100)
    print('XGB Precision Score:', precisions_xg * 100)
    ...
    rf_end = time.time()
    print("====RandomForest with Tfidf NearMiss ", args.group, df17_l, i)
    print('RFC F1 score', frfc * 100)
    print('RFC ROCAUC Score:', rocauc_rf * 100)
    print('RFC Recall score:', recalls_rf * 100)
    print('RFC Precision Score:', precisions_rf * 100)
    ...
    print("Array of Prob Scores LR-Nea:", df17_l, ":", probs_lr_scol16)
    print("Array of F1 Scores LR-Nea:", df17_l, ":", f1_lr_scol16)
    print("Array of ROCAUC Scores LR-Nea:", df17_l, ":", rocauc_lr_scol16)
    print("Array of Recall Scores LR-Nea:", df17_l, ":", recall_lr_scol16)
    print("Array of Precision Scores LR-Nea:", df17_l, ":", precision_lr_scol16)
    print("Array of Accuracy Scores LR-Nea:", df17_l, ":", accuracy_lr_scol16)

    print("Array of Prob Scores DT-Nea:", df17_l, ":", probs_dt_scol16)
    print("Array of F1 Scores DT-Nea:", df17_l, ":", f1_dt_scol16)
    print("Array of ROCAUC Scores DT-Nea:", df17_l, ":", rocauc_dt_scol16)
    print("Array of Recall Scores DT-Nea:", df17_l, ":", recall_dt_scol16)
    print("Array of Precision Scores DT-Nea:", df17_l, ":", precision_dt_scol16)
    print("Array of Accuracy Scores DT-Nea:", df17_l, ":", accuracy_dt_scol16)

    print("Array of Prob Scores NB-Nea:", df17_l, ":", probs_nb_scol16)
    print("Array of F1 Scores NB-Nea:", df17_l, ":", f1_nb_scol16)
    print("Array of ROCAUC Scores NB-Nea:", df17_l, ":", rocauc_nb_scol16)
    print("Array of Recall Scores NB-Nea:", df17_l, ":", recall_nb_scol16)
    print("Array of Precision Scores NB-Nea:", df17_l, ":", precision_nb_scol16)
    print("Array of Accuracy Scores NB-Nea:", df17_l, ":", accuracy_nb_scol16)

    print("Array of Prob Scores XG-Nea:", df17_l, ":", probs_xg_scol16)
    print("Array of F1 Scores XG-Nea:", df17_l, ":", f1_xg_scol16)
    print("Array of ROCAUC Scores XG-Nea:", df17_l, ":", rocauc_xg_scol16)
    print("Array of Recall Scores XG-Nea:", df17_l, ":", recall_xg_scol16)
    print("Array of Precision Scores XG-Nea:", df17_l, ":", precision_xg_scol16)
    print("Array of Accuracy Scores XG-Nea:", df17_l, ":", accuracy_xg_scol16)

    print("Array of Prob Scores RF-Nea:", df17_l, ":", probs_rf_scol16)
    print("Array of F1 Scores RF-Nea:", df17_l, ":", f1_rf_scol16)
    print("Array of ROCAUC Scores RF-Nea:", df17_l, ":", rocauc_rf_scol16)
    print("Array of Recall Scores RF-Nea:", df17_l, ":", recall_rf_scol16)
    print("Array of Precision Scores RF-Nea:", df17_l, ":", precision_rf_scol16)
    print("Array of Accuracy Scores RF-Nea:", df17_l, ":", accuracy_rf_scol16)
    

year16 = [ args.group for t in range(25)]
sampling16 = ['Undersampling' for t in range(25)]
technique16 = ['NearMiss' for t in range(25)]
...
x_nm17, y_nm17 = nm.fit_resample(x_tfidf17, df18["label"])
...
for i in train_values:
    ...
    x_train, x_test, y_train, y_test = train_test_split(x_nm17, y_nm17, train_size=i, stratify=y_nm17)
    ...
    print("===Logistic Regression with TfidfVectorizer NearMiss - ", args.group, df18_l, i)
    lr_end = time.time()
    print('Logistic F1-score', fly * 100)
    print('Logistic ROCAUC score:', rocauc_lr * 100)
    print('Logistic Recall score:', recalls_lr * 100)
    ...
    print("===DecisionTreeClassifier with TfidfVectorizer NearMiss - ", args.group, df18_l, i)
    dt_end = time.time()
    print('DCT F1-score', fdct * 100)
    print('DCT ROCAUC score:', rocauc_dt * 100)
    print('DCT Recall score:', recalls_dt * 100)
    ...
    nb_end = time.time()
    # Use accuracy_score function to get the accuracy
    print("===Naive Bayes with TfidfVectorizer NearMiss - ", args.group, df18_l, i)
    print('Naive F1-score', fnb * 100)
    print('Naive ROCAUC score:', rocauc_nb * 100)
    print('Naive Recall score:', recalls_nb * 100)
    print('Naive Precision Score:', precisions_nb * 100)
    ...
    xg_end = time.time()
    print("===XGB with TfidfVectorizer NearMiss - ", args.group, df18_l, i)
    print('XGB F1-Score', fxg * 100)
    print('XGB ROCAUC Score:', rocauc_xg * 100)
    print('XGB Recall score:', recall_xg * 100)
    print('XGB Precision Score:', precisions_xg * 100)
    ...
    rf_end = time.time()
    print("====RandomForest with Tfidf NearMiss ", args.group, df18_l, i)
    print('RFC F1 score', frfc * 100)
    print('RFC ROCAUC Score:', rocauc_rf * 100)
    print('RFC Recall score:', recalls_rf * 100)
    print('RFC Precision Score:', precisions_rf * 100)
    ...
    print("Array of Prob Scores LR-Nea:", df18_l, ":", probs_lr_scol17)
    print("Array of F1 Scores LR-Nea:", df18_l, ":", f1_lr_scol17)
    print("Array of ROCAUC Scores LR-Nea:", df18_l, ":", rocauc_lr_scol17)
    print("Array of Recall Scores LR-Nea:", df18_l, ":", recall_lr_scol17)
    print("Array of Precision Scores LR-Nea:", df18_l, ":", precision_lr_scol17)
    print("Array of Accuracy Scores LR-Nea:", df18_l, ":", accuracy_lr_scol17)

    print("Array of Prob Scores DT-Nea:", df18_l, ":", probs_dt_scol17)
    print("Array of F1 Scores DT-Nea:", df18_l, ":", f1_dt_scol17)
    print("Array of ROCAUC Scores DT-Nea:", df18_l, ":", rocauc_dt_scol17)
    print("Array of Recall Scores DT-Nea:", df18_l, ":", recall_dt_scol17)
    print("Array of Precision Scores DT-Nea:", df18_l, ":", precision_dt_scol17)
    print("Array of Accuracy Scores DT-Nea:", df18_l, ":", accuracy_dt_scol17)

    print("Array of Prob Scores NB-Nea:", df18_l, ":", probs_nb_scol17)
    print("Array of F1 Scores NB-Nea:", df18_l, ":", f1_nb_scol17)
    print("Array of ROCAUC Scores NB-Nea:", df18_l, ":", rocauc_nb_scol17)
    print("Array of Recall Scores NB-Nea:", df18_l, ":", recall_nb_scol17)
    print("Array of Precision Scores NB-Nea:", df18_l, ":", precision_nb_scol17)
    print("Array of Accuracy Scores NB-Nea:", df18_l, ":", accuracy_nb_scol17)

    print("Array of Prob Scores XG-Nea:", df18_l, ":", probs_xg_scol17)
    print("Array of F1 Scores XG-Nea:", df18_l, ":", f1_xg_scol17)
    print("Array of ROCAUC Scores XG-Nea:", df18_l, ":", rocauc_xg_scol17)
    print("Array of Recall Scores XG-Nea:", df18_l, ":", recall_xg_scol17)
    print("Array of Precision Scores XG-Nea:", df18_l, ":", precision_xg_scol17)
    print("Array of Accuracy Scores XG-Nea:", df18_l, ":", accuracy_xg_scol17)

    print("Array of Prob Scores RF-Nea:", df18_l, ":", probs_rf_scol17)
    print("Array of F1 Scores RF-Nea:", df18_l, ":", f1_rf_scol17)
    print("Array of ROCAUC Scores RF-Nea:", df18_l, ":", rocauc_rf_scol17)
    print("Array of Recall Scores RF-Nea:", df18_l, ":", recall_rf_scol17)
    print("Array of Precision Scores RF-Nea:", df18_l, ":", precision_rf_scol17)
    print("Array of Accuracy Scores RF-Nea:", df18_l, ":", accuracy_rf_scol17)

year17 = [ args.group for t in range(25)]
sampling17 = ['Undersampling' for t in range(25)]
technique17 = ['NearMiss' for t in range(25)]
...
x_nm18, y_nm18 = nm.fit_resample(x_tfidf18, df19["label"])
...
for i in train_values:
    ...
    x_train, x_test, y_train, y_test = train_test_split(x_nm18, y_nm18, train_size=i, stratify=y_nm18)
    ...
    print("===Logistic Regression with TfidfVectorizer NearMiss - ", args.group, df19_l, i)
    lr_end = time.time()
    print('Logistic F1-score', fly * 100)
    print('Logistic ROCAUC score:', rocauc_lr * 100)
    print('Logistic Recall score:', recalls_lr * 100)
    ...
    print("===DecisionTreeClassifier with TfidfVectorizer NearMiss - ", args.group, df19_l, i)
    dt_end = time.time()
    print('DCT F1-score', fdct * 100)
    print('DCT ROCAUC score:', rocauc_dt * 100)
    print('DCT Recall score:', recalls_dt * 100)
    ...
    nb_end = time.time()
    # Use accuracy_score function to get the accuracy
    print("===Naive Bayes with TfidfVectorizer NearMiss - ", args.group, df19_l, i)
    print('Naive F1-score', fnb * 100)
    print('Naive ROCAUC score:', rocauc_nb * 100)
    print('Naive Recall score:', recalls_nb * 100)
    print('Naive Precision Score:', precisions_nb * 100)
    ...
    xg_end = time.time()
    print("===XGB with TfidfVectorizer NearMiss - ", args.group, df19_l, i)
    print('XGB F1-Score', fxg * 100)
    print('XGB ROCAUC Score:', rocauc_xg * 100)
    print('XGB Recall score:', recall_xg * 100)
    print('XGB Precision Score:', precisions_xg * 100)
    ...
    rf_end = time.time()
    print("====RandomForest with Tfidf NearMiss ", args.group, df19_l, i)
    print('RFC F1 score', frfc * 100)
    print('RFC ROCAUC Score:', rocauc_rf * 100)
    print('RFC Recall score:', recalls_rf * 100)
    print('RFC Precision Score:', precisions_rf * 100)
    ...
    print("Array of Prob Scores LR-Nea:", df19_l, ":", probs_lr_scol18)
    print("Array of F1 Scores LR-Nea:", df19_l, ":", f1_lr_scol18)
    print("Array of ROCAUC Scores LR-Nea:", df19_l, ":", rocauc_lr_scol18)
    print("Array of Recall Scores LR-Nea:", df19_l, ":", recall_lr_scol18)
    print("Array of Precision Scores LR-Nea:", df19_l, ":", precision_lr_scol18)
    print("Array of Accuracy Scores LR-Nea:", df19_l, ":", accuracy_lr_scol18)

    print("Array of Prob Scores DT-Nea:", df19_l, ":", probs_dt_scol18)
    print("Array of F1 Scores DT-Nea:", df19_l, ":", f1_dt_scol18)
    print("Array of ROCAUC Scores DT-Nea:", df19_l, ":", rocauc_dt_scol18)
    print("Array of Recall Scores DT-Nea:", df19_l, ":", recall_dt_scol18)
    print("Array of Precision Scores DT-Nea:", df19_l, ":", precision_dt_scol18)
    print("Array of Accuracy Scores DT-Nea:", df19_l, ":", accuracy_dt_scol18)

    print("Array of Prob Scores NB-Nea:", df19_l, ":", probs_nb_scol18)
    print("Array of F1 Scores NB-Nea:", df19_l, ":", f1_nb_scol18)
    print("Array of ROCAUC Scores NB-Nea:", df19_l, ":", rocauc_nb_scol18)
    print("Array of Recall Scores NB-Nea:", df19_l, ":", recall_nb_scol18)
    print("Array of Precision Scores NB-Nea:", df19_l, ":", precision_nb_scol18)
    print("Array of Accuracy Scores NB-Nea:", df19_l, ":", accuracy_nb_scol18)

    print("Array of Prob Scores XG-Nea:", df19_l, ":", probs_xg_scol18)
    print("Array of F1 Scores XG-Nea:", df19_l, ":", f1_xg_scol18)
    print("Array of ROCAUC Scores XG-Nea:", df19_l, ":", rocauc_xg_scol18)
    print("Array of Recall Scores XG-Nea:", df19_l, ":", recall_xg_scol18)
    print("Array of Precision Scores XG-Nea:", df19_l, ":", precision_xg_scol18)
    print("Array of Accuracy Scores XG-Nea:", df19_l, ":", accuracy_xg_scol18)

    print("Array of Prob Scores RF-Nea:", df19_l, ":", probs_rf_scol18)
    print("Array of F1 Scores RF-Nea:", df19_l, ":", f1_rf_scol18)
    print("Array of ROCAUC Scores RF-Nea:", df19_l, ":", rocauc_rf_scol18)
    print("Array of Recall Scores RF-Nea:", df19_l, ":", recall_rf_scol18)
    print("Array of Precision Scores RF-Nea:", df19_l, ":", precision_rf_scol18)
    print("Array of Accuracy Scores RF-Nea:", df19_l, ":", accuracy_rf_scol18)
    

year18 = [ args.group for t in range(25)]
sampling18 = ['Undersampling' for t in range(25)]
technique18 = ['NearMiss' for t in range(25)]
...
x_nm19, y_nm19 = nm.fit_resample(x_tfidf19, df20["label"])
...
for i in train_values:
    ...
    x_train, x_test, y_train, y_test = train_test_split(x_nm19, y_nm19, train_size=i, stratify=y_nm19)
    ...
    print("===Logistic Regression with TfidfVectorizer NearMiss - ", args.group, df20_l, i)
    lr_end = time.time()
    print('Logistic F1-score', fly * 100)
    print('Logistic ROCAUC score:', rocauc_lr * 100)
    print('Logistic Recall score:', recalls_lr * 100)
    ...
    print("===DecisionTreeClassifier with TfidfVectorizer NearMiss - ", args.group, df20_l, i)
    dt_end = time.time()
    print('DCT F1-score', fdct * 100)
    print('DCT ROCAUC score:', rocauc_dt * 100)
    print('DCT Recall score:', recalls_dt * 100)
    ...
    nb_end = time.time()
    # Use accuracy_score function to get the accuracy
    print("===Naive Bayes with TfidfVectorizer NearMiss - ", args.group, df20_l, i)
    print('Naive F1-score', fnb * 100)
    print('Naive ROCAUC score:', rocauc_nb * 100)
    print('Naive Recall score:', recalls_nb * 100)
    print('Naive Precision Score:', precisions_nb * 100)
    ...
    xg_end = time.time()
    print("===XGB with TfidfVectorizer NearMiss - ", args.group, df20_l, i)
    print('XGB F1-Score', fxg * 100)
    print('XGB ROCAUC Score:', rocauc_xg * 100)
    print('XGB Recall score:', recall_xg * 100)
    print('XGB Precision Score:', precisions_xg * 100)
    ...
    rf_end = time.time()
    print("====RandomForest with Tfidf NearMiss ", args.group, df20_l, i)
    print('RFC F1 score', frfc * 100)
    print('RFC ROCAUC Score:', rocauc_rf * 100)
    print('RFC Recall score:', recalls_rf * 100)
    print('RFC Precision Score:', precisions_rf * 100)
    ...
    print("Array of Prob Scores LR-Nea:", df20_l, ":", probs_lr_scol19)
    print("Array of F1 Scores LR-Nea:", df20_l, ":", f1_lr_scol19)
    print("Array of ROCAUC Scores LR-Nea:", df20_l, ":", rocauc_lr_scol19)
    print("Array of Recall Scores LR-Nea:", df20_l, ":", recall_lr_scol19)
    print("Array of Precision Scores LR-Nea:", df20_l, ":", precision_lr_scol19)
    print("Array of Accuracy Scores LR-Nea:", df20_l, ":", accuracy_lr_scol19)

    print("Array of Prob Scores DT-Nea:", df20_l, ":", probs_dt_scol19)
    print("Array of F1 Scores DT-Nea:", df20_l, ":", f1_dt_scol19)
    print("Array of ROCAUC Scores DT-Nea:", df20_l, ":", rocauc_dt_scol19)
    print("Array of Recall Scores DT-Nea:", df20_l, ":", recall_dt_scol19)
    print("Array of Precision Scores DT-Nea:", df20_l, ":", precision_dt_scol19)
    print("Array of Accuracy Scores DT-Nea:", df20_l, ":", accuracy_dt_scol19)

    print("Array of Prob Scores NB-Nea:", df20_l, ":", probs_nb_scol19)
    print("Array of F1 Scores NB-Nea:", df20_l, ":", f1_nb_scol19)
    print("Array of ROCAUC Scores NB-Nea:", df20_l, ":", rocauc_nb_scol19)
    print("Array of Recall Scores NB-Nea:", df20_l, ":", recall_nb_scol19)
    print("Array of Precision Scores NB-Nea:", df20_l, ":", precision_nb_scol19)
    print("Array of Accuracy Scores NB-Nea:", df20_l, ":", accuracy_nb_scol19)

    print("Array of Prob Scores XG-Nea:", df20_l, ":", probs_xg_scol19)
    print("Array of F1 Scores XG-Nea:", df20_l, ":", f1_xg_scol19)
    print("Array of ROCAUC Scores XG-Nea:", df20_l, ":", rocauc_xg_scol19)
    print("Array of Recall Scores XG-Nea:", df20_l, ":", recall_xg_scol19)
    print("Array of Precision Scores XG-Nea:", df20_l, ":", precision_xg_scol19)
    print("Array of Accuracy Scores XG-Nea:", df20_l, ":", accuracy_xg_scol19)

    print("Array of Prob Scores RF-Nea:", df20_l, ":", probs_rf_scol19)
    print("Array of F1 Scores RF-Nea:", df20_l, ":", f1_rf_scol19)
    print("Array of ROCAUC Scores RF-Nea:", df20_l, ":", rocauc_rf_scol19)
    print("Array of Recall Scores RF-Nea:", df20_l, ":", recall_rf_scol19)
    print("Array of Precision Scores RF-Nea:", df20_l, ":", precision_rf_scol19)
    print("Array of Accuracy Scores RF-Nea:", df20_l, ":", accuracy_rf_scol19)
    

year19 = [ args.group for t in range(25)]
sampling19 = ['Undersampling' for t in range(25)]
technique19 = ['NearMiss' for t in range(25)]
