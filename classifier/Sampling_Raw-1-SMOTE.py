...
parser = argparse.ArgumentParser(
                    prog = 'Sampling_Raw-1-SMOTE.py',
                    description = 'Run machine learning model with SMOTE for machine learning classifiers')
...
for i in train_values:
    ...
    x_train, x_test, y_train, y_test = train_test_split(x_smote, y_smote, train_size=i, stratify=y_smote)
    ...
    print("===Logistic Regression with TfidfVectorizer SMOTE - ", args.group, df1_l, i)
    lr_end = time.time()
    ...
    print("Execution Time for Logistic Regression SMOTE: ", lr_end - start1, "seconds")
    ...
    print("===DecisionTreeClassifier with TfidfVectorizer SMOTE - ", args.group, df1_l, i)
    dt_end = time.time()
    ...
    print("Execution Time for Decision Tree SMOTE: ", dt_end - start2, "seconds")
    ...
    print("===Naive Bayes with TfidfVectorizer SMOTE - ", args.group, df1_l, i)
    ...
    print("Execution Time for Naive Bayes SMOTE: ", nb_end - start3, "seconds")
...
# XGBoost Classifier
    ...
    xg_end = time.time()
    print("===XGB with TfidfVectorizer SMOTE - ", args.group, df1_l, i)
    ...
    print("Execution Time for XGBoost Classifier SMOTE: ", xg_end - start4, "seconds")
...
# Random Forest Classifier
    ...
    rf_end = time.time()
    print("====RandomForest with Tfidf SMOTE ", args.group, df1_l, i)
    ...
    print("Execution Time for Random Forest Classifier SMOTE: ", rf_end - start5, "seconds")

    print("Array of Prob Scores LR-SMO Test-Size", df1_l,":", probs_lr_scol)
    print("Array of F1 Scores LR-SMO Test-Size:", df1_l,":", f1_lr_scol)
    print("Array of ROCAUC Scores LR-SMO:", df1_l,":", rocauc_lr_scol)
    print("Array of Recall Scores LR-SMO:", df1_l,":", recall_lr_scol)
    print("Array of Precision Scores LR-SMO:", df1_l,":", precision_lr_scol)
    print("Array of Accuracy Scores LR-SMO:", df1_l,":", accuracy_lr_scol)

    print("Array of Prob Scores DT-SMO:", df1_l,":", probs_dt_scol)
    print("Array of F1 Scores DT-SMO:", df1_l,":", f1_dt_scol)
    print("Array of ROCAUC Scores DT-SMO:", df1_l,":", rocauc_dt_scol)
    print("Array of Recall Scores DT-SMO:", df1_l,":", recall_dt_scol)
    print("Array of Precision Scores DT-SMO:", df1_l,":", precision_dt_scol)
    print("Array of Accuracy Scores DT-SMO:", df1_l,":", accuracy_dt_scol)

    print("Array of Prob Scores NB-SMO:", df1_l,":", probs_nb_scol)
    print("Array of F1 Scores NB-SMO:", df1_l,":", f1_nb_scol)
    print("Array of ROCAUC Scores NB-SMO:", df1_l,":", rocauc_nb_scol)
    print("Array of Recall Scores NB-SMO:", df1_l,":", recall_nb_scol)
    print("Array of Precision Scores NB-SMO:", df1_l,":", precision_nb_scol)
    print("Array of Accuracy Scores NB-SMO:", df1_l,":", accuracy_nb_scol)

    print("Array of Prob Scores XG-SMO:", df1_l,":", probs_xg_scol)
    print("Array of F1 Scores XG-SMO:",  df1_l,":", f1_xg_scol)
    print("Array of ROCAUC Scores XG-SMO:",  df1_l,":",  rocauc_xg_scol)
    print("Array of Recall Scores XG-SMO:",  df1_l,":",  recall_xg_scol)
    print("Array of Precision Scores XG-SMO:",  df1_l,":", precision_xg_scol)
    print("Array of Accuracy Scores XG-SMO:",  df1_l,":", accuracy_xg_scol)

    print("Array of Prob Scores RF-SMO:",  df1_l,":", probs_rf_scol)
    print("Array of F1 Scores RF-SMO:", df1_l,":",  f1_rf_scol)
    print("Array of ROCAUC Scores RF-SMO:",  df1_l,":", rocauc_rf_scol)
    print("Array of Recall Scores RF-SMO:", df1_l,":",  recall_rf_scol)
    print("Array of Precision Scores RF-SMO:", df1_l,":",  precision_rf_scol)
    print("Array of Accuracy Scores RF-SMO:", df1_l,":",  accuracy_rf_scol)
...
technique = ['SMOTE' for t in range(25)]
...
x_smote1, y_smote1 = smote.fit_resample(x_tfidf1, df2["label"])
...
for i in train_values:
    ...
    x_train, x_test, y_train, y_test = train_test_split(x_smote1,y_smote1, train_size=i, stratify=y_smote1)
    ...
    print("===Logistic Regression with TfidfVectorizer SMOTE - ", args.group, df2_l, i)
    lr_end = time.time()
    print('Logistic F1-score',fly*100)
    print('Logistic ROCAUC score:',rocauc_lr*100)
    print('Logistic Recall score:', recalls_lr*100)
    ...
    print("===DecisionTreeClassifier with TfidfVectorizer SMOTE - ", args.group, df2_l, i)
    dt_end = time.time()
    print('DCT F1-score',fdct*100)
    print('DCT ROCAUC score:',rocauc_dt*100)
    print('DCT Recall score:', recalls_dt*100)
    ...
    nb_end = time.time()
    # Use accuracy_score function to get the accuracy
    print("===Naive Bayes with TfidfVectorizer SMOTE - ", args.group, df2_l, i)
    print('Naive F1-score',fnb*100)
    print('Naive ROCAUC score:',rocauc_nb*100)
    print('Naive Recall score:', recalls_nb*100)
    print('Naive Precision Score:', precisions_nb*100)
...
# XGBoost Classifier
    ...
    xg_end = time.time()
    print("===XGB with TfidfVectorizer SMOTE - ", args.group, df2_l, i)
    print('XGB F1-Score', fxg*100)
    print('XGB ROCAUC Score:', rocauc_xg*100)
    print('XGB Recall score:', recall_xg*100)
    print('XGB Precision Score:', precisions_xg *100)
...
# Random Forest Classifier
    ...
    rf_end = time.time()
    print("====RandomForest with Tfidf SMOTE ", args.group, df2_l, i)
    print('RFC F1 score', frfc*100)
    print('RFC ROCAUC Score:', rocauc_rf*100)
    print('RFC Recall score:', recalls_rf*100)
    print('RFC Precision Score:', precisions_rf*100)
    ...
    print("Array of Prob Scores LR-SMO:",  df2_l,":",  probs_lr_scol1)
    print("Array of F1 Scores LR-SMO:",  df2_l,":",  f1_lr_scol1)
    print("Array of ROCAUC Scores LR-SMO:",  df2_l,":",  rocauc_lr_scol1)
    print("Array of Recall Scores LR-SMO:",  df2_l,":",  recall_lr_scol1)
    print("Array of Precision Scores LR-SMO:",  df2_l,":", precision_lr_scol1)
    print("Array of Accuracy Scores LR-SMO:", df2_l,":", accuracy_lr_scol1)

    print("Array of Prob Scores DT-SMO:", df2_l,":", probs_dt_scol1)
    print("Array of F1 Scores DT-SMO:", df2_l,":", f1_dt_scol1)
    print("Array of ROCAUC Scores DT-SMO:", df2_l,":", rocauc_dt_scol1)
    print("Array of Recall Scores DT-SMO:",df2_l,":", recall_dt_scol1)
    print("Array of Precision Scores DT-SMO:", df2_l,":", precision_dt_scol1)
    print("Array of Accuracy Scores DT-SMO:", df2_l,":", accuracy_dt_scol1)

    print("Array of Prob Scores NB-SMO:", df2_l,":", probs_nb_scol1)
    print("Array of F1 Scores NB-SMO:", df2_l,":", f1_nb_scol1)
    print("Array of ROCAUC Scores NB-SMO:", df2_l,":", rocauc_nb_scol1)
    print("Array of Recall Scores NB-SMO:", df2_l,":", recall_nb_scol1)
    print("Array of Precision Scores NB-SMO:", df2_l,":", precision_nb_scol1)
    print("Array of Accuracy Scores NB-SMO:", df2_l,":", accuracy_nb_scol1)

    print("Array of Prob Scores XG-SMO:", df2_l,":", probs_xg_scol1)
    print("Array of F1 Scores XG-SMO:", df2_l,":", f1_xg_scol1)
    print("Array of ROCAUC Scores XG-SMO:", df2_l,":", rocauc_xg_scol1)
    print("Array of Recall Scores XG-SMO:", df2_l,":", recall_xg_scol1)
    print("Array of Precision Scores XG-SMO:", df2_l,":", precision_xg_scol1)
    print("Array of Accuracy Scores XG-SMO:", df2_l,":", accuracy_xg_scol1)

    print("Array of Prob Scores RF-SMO:", df2_l,":", probs_rf_scol1)
    print("Array of F1 Scores RF-SMO:", df2_l,":", f1_rf_scol1)
    print("Array of ROCAUC Scores RF-SMO:", df2_l,":", rocauc_rf_scol1)
    print("Array of Recall Scores RF-SMO:", df2_l,":", recall_rf_scol1)
    print("Array of Precision Scores RF-SMO:", df2_l,":", precision_rf_scol1)
    print("Array of Accuracy Scores RF-SMO:", df2_l,":", accuracy_rf_scol1)
'''
classifier_list = ['Logistic Regression', 'Decision Tree', 'Naive Bayes', 'XGBoost', 'Random Forest']
test_sizes_num = [0.17, 0.33, 0.50, 0.67, 0.83]
train_sizes_num = [0.83, 0.67, 0.50, 0.33, 0.17]
...
technique1 = ['SMOTE' for t in range(25)]
...
x_smote2, y_smote2 = smote.fit_resample(x_tfidf2, df3["label"])
...
for i in train_values:
    ...
    x_train, x_test, y_train, y_test = train_test_split(x_smote2, y_smote2, train_size=i, stratify=y_smote2)
    ...
    print("===Logistic Regression with TfidfVectorizer SMOTE - ", args.group, df3_l, i)
    lr_end = time.time()
    print('Logistic F1-score',fly*100)
    print('Logistic ROCAUC score:',rocauc_lr*100)
    print('Logistic Recall score:', recalls_lr*100)
    ...
    print("===DecisionTreeClassifier with TfidfVectorizer SMOTE - ", args.group, df3_l, i)
    dt_end = time.time()
    print('DCT F1-score',fdct*100)
    print('DCT ROCAUC score:',rocauc_dt*100)
    print('DCT Recall score:', recalls_dt*100)
    ...
    nb_end = time.time()
    # Use accuracy_score function to get the accuracy
    print("===Naive Bayes with TfidfVectorizer SMOTE - ", args.group, df3_l, i)
    print('Naive F1-score',fnb*100)
    print('Naive ROCAUC score:',rocauc_nb*100)
    print('Naive Recall score:', recalls_nb*100)
    print('Naive Precision Score:', precisions_nb*100)
...
# XGBoost Classifier
    ...
    xg_end = time.time()
    print("===XGB with TfidfVectorizer SMOTE - ", args.group, df3_l, i)
    print('XGB F1-Score', fxg*100)
    print('XGB ROCAUC Score:', rocauc_xg*100)
    print('XGB Recall score:', recall_xg*100)
    print('XGB Precision Score:', precisions_xg *100)
...
# Random Forest Classifier
    ...
    rf_end = time.time()
    print("====RandomForest with Tfidf SMOTE ", args.group, df3_l, i)
    print('RFC F1 score', frfc*100)
    print('RFC ROCAUC Score:', rocauc_rf*100)
    print('RFC Recall score:', recalls_rf*100)
    print('RFC Precision Score:', precisions_rf*100)
    ...
    print("Array of Prob Scores LR-SMO:",  df3_l,":",  probs_lr_scol2)
    print("Array of F1 Scores LR-SMO:",  df3_l,":",  f1_lr_scol2)
    print("Array of ROCAUC Scores LR-SMO:",  df3_l,":",  rocauc_lr_scol2)
    print("Array of Recall Scores LR-SMO:",  df3_l,":",  recall_lr_scol2)
    print("Array of Precision Scores LR-SMO:",  df3_l,":", precision_lr_scol2)
    print("Array of Accuracy Scores LR-SMO:", df3_l,":", accuracy_lr_scol2)

    print("Array of Prob Scores DT-SMO:", df3_l,":", probs_dt_scol2)
    print("Array of F1 Scores DT-SMO:", df3_l,":", f1_dt_scol2)
    print("Array of ROCAUC Scores DT-SMO:", df3_l,":", rocauc_dt_scol2)
    print("Array of Recall Scores DT-SMO:",df3_l,":", recall_dt_scol2)
    print("Array of Precision Scores DT-SMO:", df3_l,":", precision_dt_scol2)
    print("Array of Accuracy Scores DT-SMO:", df3_l,":", accuracy_dt_scol2)

    print("Array of Prob Scores NB-SMO:", df3_l,":", probs_nb_scol2)
    print("Array of F1 Scores NB-SMO:", df3_l,":", f1_nb_scol2)
    print("Array of ROCAUC Scores NB-SMO:", df3_l,":", rocauc_nb_scol2)
    print("Array of Recall Scores NB-SMO:", df3_l,":", recall_nb_scol2)
    print("Array of Precision Scores NB-SMO:", df3_l,":", precision_nb_scol2)
    print("Array of Accuracy Scores NB-SMO:", df3_l,":", accuracy_nb_scol2)

    print("Array of Prob Scores XG-SMO:", df3_l,":", probs_xg_scol2)
    print("Array of F1 Scores XG-SMO:", df3_l,":", f1_xg_scol2)
    print("Array of ROCAUC Scores XG-SMO:", df3_l,":", rocauc_xg_scol2)
    print("Array of Recall Scores XG-SMO:", df3_l,":", recall_xg_scol2)
    print("Array of Precision Scores XG-SMO:", df3_l,":", precision_xg_scol2)
    print("Array of Accuracy Scores XG-SMO:", df3_l,":", accuracy_xg_scol2)

    print("Array of Prob Scores RF-SMO:", df3_l,":", probs_rf_scol2)
    print("Array of F1 Scores RF-SMO:", df3_l,":", f1_rf_scol2)
    print("Array of ROCAUC Scores RF-SMO:", df3_l,":", rocauc_rf_scol2)
    print("Array of Recall Scores RF-SMO:", df3_l,":", recall_rf_scol2)
    print("Array of Precision Scores RF-SMO:", df3_l,":", precision_rf_scol2)
    print("Array of Accuracy Scores RF-SMO:", df3_l,":", accuracy_rf_scol2)
    

from itertools import chain
year2 = [ args.group for t in range(25)]
sampling2 =['Oversampling' for t in range(25)]
technique2 = ['SMOTE' for t in range(25)]
...
x_smote3, y_smote3 = smote.fit_resample(x_tfidf3, df4["label"])
...
for i in train_values:
    ...
    x_train, x_test, y_train, y_test = train_test_split(x_smote3, y_smote3, train_size=i, stratify=y_smote3)
    ...
    print("===Logistic Regression with TfidfVectorizer SMOTE - ", args.group, df4_l, i)
    lr_end = time.time()
    print('Logistic F1-score', fly * 100)
    print('Logistic ROCAUC score:', rocauc_lr * 100)
    print('Logistic Recall score:', recalls_lr * 100)
    ...
    print("===DecisionTreeClassifier with TfidfVectorizer SMOTE - ", args.group, df4_l, i)
    dt_end = time.time()
    print('DCT F1-score', fdct * 100)
    print('DCT ROCAUC score:', rocauc_dt * 100)
    print('DCT Recall score:', recalls_dt * 100)
    ...
    nb_end = time.time()
    # Use accuracy_score function to get the accuracy
    print("===Naive Bayes with TfidfVectorizer SMOTE - ", args.group, df4_l, i)
    print('Naive F1-score', fnb * 100)
    print('Naive ROCAUC score:', rocauc_nb * 100)
    print('Naive Recall score:', recalls_nb * 100)
    print('Naive Precision Score:', precisions_nb * 100)
    ...
    xg_end = time.time()
    print("===XGB with TfidfVectorizer SMOTE - ", args.group, df4_l, i)
    print('XGB F1-Score', fxg * 100)
    print('XGB ROCAUC Score:', rocauc_xg * 100)
    print('XGB Recall score:', recall_xg * 100)
    print('XGB Precision Score:', precisions_xg * 100)
    ...
    rf_end = time.time()
    print("====RandomForest with Tfidf SMOTE ", args.group, df4_l, i)
    print('RFC F1 score', frfc * 100)
    print('RFC ROCAUC Score:', rocauc_rf * 100)
    print('RFC Recall score:', recalls_rf * 100)
    print('RFC Precision Score:', precisions_rf * 100)
    ...
    print("Array of Prob Scores LR-SMO:", df4_l, ":", probs_lr_scol3)
    print("Array of F1 Scores LR-SMO:", df4_l, ":", f1_lr_scol3)
    print("Array of ROCAUC Scores LR-SMO:", df4_l, ":", rocauc_lr_scol3)
    print("Array of Recall Scores LR-SMO:", df4_l, ":", recall_lr_scol3)
    print("Array of Precision Scores LR-SMO:", df4_l, ":", precision_lr_scol3)
    print("Array of Accuracy Scores LR-SMO:", df4_l, ":", accuracy_lr_scol3)

    print("Array of Prob Scores DT-SMO:", df4_l, ":", probs_dt_scol3)
    print("Array of F1 Scores DT-SMO:", df4_l, ":", f1_dt_scol3)
    print("Array of ROCAUC Scores DT-SMO:", df4_l, ":", rocauc_dt_scol3)
    print("Array of Recall Scores DT-SMO:", df4_l, ":", recall_dt_scol3)
    print("Array of Precision Scores DT-SMO:", df4_l, ":", precision_dt_scol3)
    print("Array of Accuracy Scores DT-SMO:", df4_l, ":", accuracy_dt_scol3)

    print("Array of Prob Scores NB-SMO:", df4_l, ":", probs_nb_scol3)
    print("Array of F1 Scores NB-SMO:", df4_l, ":", f1_nb_scol3)
    print("Array of ROCAUC Scores NB-SMO:", df4_l, ":", rocauc_nb_scol3)
    print("Array of Recall Scores NB-SMO:", df4_l, ":", recall_nb_scol3)
    print("Array of Precision Scores NB-SMO:", df4_l, ":", precision_nb_scol3)
    print("Array of Accuracy Scores NB-SMO:", df4_l, ":", accuracy_nb_scol3)

    print("Array of Prob Scores XG-SMO:", df4_l, ":", probs_xg_scol3)
    print("Array of F1 Scores XG-SMO:", df4_l, ":", f1_xg_scol3)
    print("Array of ROCAUC Scores XG-SMO:", df4_l, ":", rocauc_xg_scol3)
    print("Array of Recall Scores XG-SMO:", df4_l, ":", recall_xg_scol3)
    print("Array of Precision Scores XG-SMO:", df4_l, ":", precision_xg_scol3)
    print("Array of Accuracy Scores XG-SMO:", df4_l, ":", accuracy_xg_scol3)

    print("Array of Prob Scores RF-SMO:", df4_l, ":", probs_rf_scol3)
    print("Array of F1 Scores RF-SMO:", df4_l, ":", f1_rf_scol3)
    print("Array of ROCAUC Scores RF-SMO:", df4_l, ":", rocauc_rf_scol3)
    print("Array of Recall Scores RF-SMO:", df4_l, ":", recall_rf_scol3)
    print("Array of Precision Scores RF-SMO:", df4_l, ":", precision_rf_scol3)
    print("Array of Accuracy Scores RF-SMO:", df4_l, ":", accuracy_rf_scol3)
    

year3 = [ args.group for t in range(25)]
sampling3 =['Oversampling' for t in range(25)]
technique3 = ['SMOTE' for t in range(25)]
...
x_smote4, y_smote4 = smote.fit_resample(x_tfidf4, df5["label"])
...
for i in train_values:
    ...
    x_train, x_test, y_train, y_test = train_test_split(x_smote4, y_smote4, train_size=i, stratify=y_smote4)
    ...
    print("===Logistic Regression with TfidfVectorizer SMOTE - ", args.group, df5_l, i)
    lr_end = time.time()
    print('Logistic F1-score', fly * 100)
    print('Logistic ROCAUC score:', rocauc_lr * 100)
    print('Logistic Recall score:', recalls_lr * 100)
    ...
    print("===DecisionTreeClassifier with TfidfVectorizer SMOTE - ", args.group, df5_l, i)
    dt_end = time.time()
    print('DCT F1-score', fdct * 100)
    print('DCT ROCAUC score:', rocauc_dt * 100)
    print('DCT Recall score:', recalls_dt * 100)
    ...
    nb_end = time.time()
    # Use accuracy_score function to get the accuracy
    print("===Naive Bayes with TfidfVectorizer SMOTE - ", args.group, df5_l, i)
    print('Naive F1-score', fnb * 100)
    print('Naive ROCAUC score:', rocauc_nb * 100)
    print('Naive Recall score:', recalls_nb * 100)
    print('Naive Precision Score:', precisions_nb * 100)
    ...
    xg_end = time.time()
    print("===XGB with TfidfVectorizer SMOTE - ", args.group, df5_l, i)
    print('XGB F1-Score', fxg * 100)
    print('XGB ROCAUC Score:', rocauc_xg * 100)
    print('XGB Recall score:', recall_xg * 100)
    print('XGB Precision Score:', precisions_xg * 100)
    ...
    rf_end = time.time()
    print("====RandomForest with Tfidf SMOTE ", args.group, df5_l, i)
    print('RFC F1 score', frfc * 100)
    print('RFC ROCAUC Score:', rocauc_rf * 100)
    print('RFC Recall score:', recalls_rf * 100)
    print('RFC Precision Score:', precisions_rf * 100)
    ...
    print("Array of Prob Scores LR-SMO:", df5_l, ":", probs_lr_scol4)
    print("Array of F1 Scores LR-SMO:", df5_l, ":", f1_lr_scol4)
    print("Array of ROCAUC Scores LR-SMO:", df5_l, ":", rocauc_lr_scol4)
    print("Array of Recall Scores LR-SMO:", df5_l, ":", recall_lr_scol4)
    print("Array of Precision Scores LR-SMO:", df5_l, ":", precision_lr_scol4)
    print("Array of Accuracy Scores LR-SMO:", df5_l, ":", accuracy_lr_scol4)

    print("Array of Prob Scores DT-SMO:", df5_l, ":", probs_dt_scol4)
    print("Array of F1 Scores DT-SMO:", df5_l, ":", f1_dt_scol4)
    print("Array of ROCAUC Scores DT-SMO:", df5_l, ":", rocauc_dt_scol4)
    print("Array of Recall Scores DT-SMO:", df5_l, ":", recall_dt_scol4)
    print("Array of Precision Scores DT-SMO:", df5_l, ":", precision_dt_scol4)
    print("Array of Accuracy Scores DT-SMO:", df5_l, ":", accuracy_dt_scol4)

    print("Array of Prob Scores NB-SMO:", df5_l, ":", probs_nb_scol4)
    print("Array of F1 Scores NB-SMO:", df5_l, ":", f1_nb_scol4)
    print("Array of ROCAUC Scores NB-SMO:", df5_l, ":", rocauc_nb_scol4)
    print("Array of Recall Scores NB-SMO:", df5_l, ":", recall_nb_scol4)
    print("Array of Precision Scores NB-SMO:", df5_l, ":", precision_nb_scol4)
    print("Array of Accuracy Scores NB-SMO:", df5_l, ":", accuracy_nb_scol4)

    print("Array of Prob Scores XG-SMO:", df5_l, ":", probs_xg_scol4)
    print("Array of F1 Scores XG-SMO:", df5_l, ":", f1_xg_scol4)
    print("Array of ROCAUC Scores XG-SMO:", df5_l, ":", rocauc_xg_scol4)
    print("Array of Recall Scores XG-SMO:", df5_l, ":", recall_xg_scol4)
    print("Array of Precision Scores XG-SMO:", df5_l, ":", precision_xg_scol4)
    print("Array of Accuracy Scores XG-SMO:", df5_l, ":", accuracy_xg_scol4)

    print("Array of Prob Scores RF-SMO:", df5_l, ":", probs_rf_scol4)
    print("Array of F1 Scores RF-SMO:", df5_l, ":", f1_rf_scol4)
    print("Array of ROCAUC Scores RF-SMO:", df5_l, ":", rocauc_rf_scol4)
    print("Array of Recall Scores RF-SMO:", df5_l, ":", recall_rf_scol4)
    print("Array of Precision Scores RF-SMO:", df5_l, ":", precision_rf_scol4)
    print("Array of Accuracy Scores RF-SMO:", df5_l, ":", accuracy_rf_scol4)


year4 = [ args.group for t in range(25)]
sampling4 =['Oversampling' for t in range(25)]
technique4 = ['SMOTE' for t in range(25)]
...
x_smote5, y_smote5 = smote.fit_resample(x_tfidf5, df6["label"])
...
for i in train_values:
    ...
    x_train, x_test, y_train, y_test = train_test_split(x_smote5, y_smote5, train_size=i, stratify=y_smote5)
    ...
    print("===Logistic Regression with TfidfVectorizer SMOTE - ", args.group, df6_l, i)
    lr_end = time.time()
    print('Logistic F1-score', fly * 100)
    print('Logistic ROCAUC score:', rocauc_lr * 100)
    print('Logistic Recall score:', recalls_lr * 100)
    ...
    print("===DecisionTreeClassifier with TfidfVectorizer SMOTE - ", args.group, df6_l, i)
    dt_end = time.time()
    print('DCT F1-score', fdct * 100)
    print('DCT ROCAUC score:', rocauc_dt * 100)
    print('DCT Recall score:', recalls_dt * 100)
    ...
    nb_end = time.time()
    # Use accuracy_score function to get the accuracy
    print("===Naive Bayes with TfidfVectorizer SMOTE - ", args.group, df6_l, i)
    print('Naive F1-score', fnb * 100)
    print('Naive ROCAUC score:', rocauc_nb * 100)
    print('Naive Recall score:', recalls_nb * 100)
    print('Naive Precision Score:', precisions_nb * 100)
    ...
    xg_end = time.time()
    print("===XGB with TfidfVectorizer SMOTE - ", args.group, df6_l, i)
    print('XGB F1-Score', fxg * 100)
    print('XGB ROCAUC Score:', rocauc_xg * 100)
    print('XGB Recall score:', recall_xg * 100)
    print('XGB Precision Score:', precisions_xg * 100)
    ...
    rf_end = time.time()
    print("====RandomForest with Tfidf SMOTE ", args.group, df6_l, i)
    print('RFC F1 score', frfc * 100)
    print('RFC ROCAUC Score:', rocauc_rf * 100)
    print('RFC Recall score:', recalls_rf * 100)
    print('RFC Precision Score:', precisions_rf * 100)
    ...
    print("Array of Prob Scores LR-SMO:", df6_l, ":", probs_lr_scol5)
    print("Array of F1 Scores LR-SMO:", df6_l, ":", f1_lr_scol5)
    print("Array of ROCAUC Scores LR-SMO:", df6_l, ":", rocauc_lr_scol5)
    print("Array of Recall Scores LR-SMO:", df6_l, ":", recall_lr_scol5)
    print("Array of Precision Scores LR-SMO:", df6_l, ":", precision_lr_scol5)
    print("Array of Accuracy Scores LR-SMO:", df6_l, ":", accuracy_lr_scol5)

    print("Array of Prob Scores DT-SMO:", df6_l, ":", probs_dt_scol5)
    print("Array of F1 Scores DT-SMO:", df6_l, ":", f1_dt_scol5)
    print("Array of ROCAUC Scores DT-SMO:", df6_l, ":", rocauc_dt_scol5)
    print("Array of Recall Scores DT-SMO:", df6_l, ":", recall_dt_scol5)
    print("Array of Precision Scores DT-SMO:", df6_l, ":", precision_dt_scol5)
    print("Array of Accuracy Scores DT-SMO:", df6_l, ":", accuracy_dt_scol5)

    print("Array of Prob Scores NB-SMO:", df6_l, ":", probs_nb_scol5)
    print("Array of F1 Scores NB-SMO:", df6_l, ":", f1_nb_scol5)
    print("Array of ROCAUC Scores NB-SMO:", df6_l, ":", rocauc_nb_scol5)
    print("Array of Recall Scores NB-SMO:", df6_l, ":", recall_nb_scol5)
    print("Array of Precision Scores NB-SMO:", df6_l, ":", precision_nb_scol5)
    print("Array of Accuracy Scores NB-SMO:", df6_l, ":", accuracy_nb_scol5)

    print("Array of Prob Scores XG-SMO:", df6_l, ":", probs_xg_scol5)
    print("Array of F1 Scores XG-SMO:", df6_l, ":", f1_xg_scol5)
    print("Array of ROCAUC Scores XG-SMO:", df6_l, ":", rocauc_xg_scol5)
    print("Array of Recall Scores XG-SMO:", df6_l, ":", recall_xg_scol5)
    print("Array of Precision Scores XG-SMO:", df6_l, ":", precision_xg_scol5)
    print("Array of Accuracy Scores XG-SMO:", df6_l, ":", accuracy_xg_scol5)

    print("Array of Prob Scores RF-SMO:", df6_l, ":", probs_rf_scol5)
    print("Array of F1 Scores RF-SMO:", df6_l, ":", f1_rf_scol5)
    print("Array of ROCAUC Scores RF-SMO:", df6_l, ":", rocauc_rf_scol5)
    print("Array of Recall Scores RF-SMO:", df6_l, ":", recall_rf_scol5)
    print("Array of Precision Scores RF-SMO:", df6_l, ":", precision_rf_scol5)
    print("Array of Accuracy Scores RF-SMO:", df6_l, ":", accuracy_rf_scol5)
    

year5 = [ args.group for t in range(25)]
sampling5 =['Oversampling' for t in range(25)]
technique5 = ['SMOTE' for t in range(25)]
...
x_smote6, y_smote6 = smote.fit_resample(x_tfidf6, df7["label"])
...
for i in train_values:
    ...
    x_train, x_test, y_train, y_test = train_test_split(x_smote6, y_smote6, train_size=i, stratify=y_smote6)
    ...
    print("===Logistic Regression with TfidfVectorizer SMOTE - ", args.group, df7_l, i)
    lr_end = time.time()
    print('Logistic F1-score', fly * 100)
    print('Logistic ROCAUC score:', rocauc_lr * 100)
    print('Logistic Recall score:', recalls_lr * 100)
    ...
    print("===DecisionTreeClassifier with TfidfVectorizer SMOTE - ", args.group, df7_l, i)
    dt_end = time.time()
    print('DCT F1-score', fdct * 100)
    print('DCT ROCAUC score:', rocauc_dt * 100)
    print('DCT Recall score:', recalls_dt * 100)
    ...
    nb_end = time.time()
    # Use accuracy_score function to get the accuracy
    print("===Naive Bayes with TfidfVectorizer SMOTE - ", args.group, df7_l, i)
    print('Naive F1-score', fnb * 100)
    print('Naive ROCAUC score:', rocauc_nb * 100)
    print('Naive Recall score:', recalls_nb * 100)
    print('Naive Precision Score:', precisions_nb * 100)
    ...
    xg_end = time.time()
    print("===XGB with TfidfVectorizer SMOTE - ", args.group, df7_l, i)
    print('XGB F1-Score', fxg * 100)
    print('XGB ROCAUC Score:', rocauc_xg * 100)
    print('XGB Recall score:', recall_xg * 100)
    print('XGB Precision Score:', precisions_xg * 100)
    ...
    rf_end = time.time()
    print("====RandomForest with Tfidf SMOTE ", args.group, df7_l, i)
    print('RFC F1 score', frfc * 100)
    print('RFC ROCAUC Score:', rocauc_rf * 100)
    print('RFC Recall score:', recalls_rf * 100)
    print('RFC Precision Score:', precisions_rf * 100)
    ...
    print("Array of Prob Scores LR-SMO:", df7_l, ":", probs_lr_scol6)
    print("Array of F1 Scores LR-SMO:", df7_l, ":", f1_lr_scol6)
    print("Array of ROCAUC Scores LR-SMO:", df7_l, ":", rocauc_lr_scol6)
    print("Array of Recall Scores LR-SMO:", df7_l, ":", recall_lr_scol6)
    print("Array of Precision Scores LR-SMO:", df7_l, ":", precision_lr_scol6)
    print("Array of Accuracy Scores LR-SMO:", df7_l, ":", accuracy_lr_scol6)

    print("Array of Prob Scores DT-SMO:", df7_l, ":", probs_dt_scol6)
    print("Array of F1 Scores DT-SMO:", df7_l, ":", f1_dt_scol6)
    print("Array of ROCAUC Scores DT-SMO:", df7_l, ":", rocauc_dt_scol6)
    print("Array of Recall Scores DT-SMO:", df7_l, ":", recall_dt_scol6)
    print("Array of Precision Scores DT-SMO:", df7_l, ":", precision_dt_scol6)
    print("Array of Accuracy Scores DT-SMO:", df7_l, ":", accuracy_dt_scol6)

    print("Array of Prob Scores NB-SMO:", df7_l, ":", probs_nb_scol6)
    print("Array of F1 Scores NB-SMO:", df7_l, ":", f1_nb_scol6)
    print("Array of ROCAUC Scores NB-SMO:", df7_l, ":", rocauc_nb_scol6)
    print("Array of Recall Scores NB-SMO:", df7_l, ":", recall_nb_scol6)
    print("Array of Precision Scores NB-SMO:", df7_l, ":", precision_nb_scol6)
    print("Array of Accuracy Scores NB-SMO:", df7_l, ":", accuracy_nb_scol6)

    print("Array of Prob Scores XG-SMO:", df7_l, ":", probs_xg_scol6)
    print("Array of F1 Scores XG-SMO:", df7_l, ":", f1_xg_scol6)
    print("Array of ROCAUC Scores XG-SMO:", df7_l, ":", rocauc_xg_scol6)
    print("Array of Recall Scores XG-SMO:", df7_l, ":", recall_xg_scol6)
    print("Array of Precision Scores XG-SMO:", df7_l, ":", precision_xg_scol6)
    print("Array of Accuracy Scores XG-SMO:", df7_l, ":", accuracy_xg_scol6)

    print("Array of Prob Scores RF-SMO:", df7_l, ":", probs_rf_scol6)
    print("Array of F1 Scores RF-SMO:", df7_l, ":", f1_rf_scol6)
    print("Array of ROCAUC Scores RF-SMO:", df7_l, ":", rocauc_rf_scol6)
    print("Array of Recall Scores RF-SMO:", df7_l, ":", recall_rf_scol6)
    print("Array of Precision Scores RF-SMO:", df7_l, ":", precision_rf_scol6)
    print("Array of Accuracy Scores RF-SMO:", df7_l, ":", accuracy_rf_scol6)

year6 = [ args.group for t in range(25)]
sampling6 =['Oversampling' for t in range(25)]
technique6 = ['SMOTE' for t in range(25)]
...
x_smote7, y_smote7 = smote.fit_resample(x_tfidf7, df8["label"])
...
for i in train_values:
    ...
    x_train, x_test, y_train, y_test = train_test_split(x_smote7, y_smote7, train_size=i, stratify=y_smote7)
    ...
    print("===Logistic Regression with TfidfVectorizer SMOTE - ", args.group, df8_l, i)
    lr_end = time.time()
    print('Logistic F1-score', fly * 100)
    print('Logistic ROCAUC score:', rocauc_lr * 100)
    print('Logistic Recall score:', recalls_lr * 100)
    ...
    print("===DecisionTreeClassifier with TfidfVectorizer SMOTE - ", args.group, df8_l, i)
    dt_end = time.time()
    print('DCT F1-score', fdct * 100)
    print('DCT ROCAUC score:', rocauc_dt * 100)
    print('DCT Recall score:', recalls_dt * 100)
    ...
    nb_end = time.time()
    # Use accuracy_score function to get the accuracy
    print("===Naive Bayes with TfidfVectorizer SMOTE - ", args.group, df8_l, i)
    print('Naive F1-score', fnb * 100)
    print('Naive ROCAUC score:', rocauc_nb * 100)
    print('Naive Recall score:', recalls_nb * 100)
    print('Naive Precision Score:', precisions_nb * 100)
    ...
    xg_end = time.time()
    print("===XGB with TfidfVectorizer SMOTE - ", args.group, df8_l, i)
    print('XGB F1-Score', fxg * 100)
    print('XGB ROCAUC Score:', rocauc_xg * 100)
    print('XGB Recall score:', recall_xg * 100)
    print('XGB Precision Score:', precisions_xg * 100)
    ...
    rf_end = time.time()
    print("====RandomForest with Tfidf SMOTE ", args.group, df8_l, i)
    print('RFC F1 score', frfc * 100)
    print('RFC ROCAUC Score:', rocauc_rf * 100)
    print('RFC Recall score:', recalls_rf * 100)
    print('RFC Precision Score:', precisions_rf * 100)
    ...
    print("Array of Prob Scores LR-SMO:", df8_l, ":", probs_lr_scol7)
    print("Array of F1 Scores LR-SMO:", df8_l, ":", f1_lr_scol7)
    print("Array of ROCAUC Scores LR-SMO:", df8_l, ":", rocauc_lr_scol7)
    print("Array of Recall Scores LR-SMO:", df8_l, ":", recall_lr_scol7)
    print("Array of Precision Scores LR-SMO:", df8_l, ":", precision_lr_scol7)
    print("Array of Accuracy Scores LR-SMO:", df8_l, ":", accuracy_lr_scol7)

    print("Array of Prob Scores DT-SMO:", df8_l, ":", probs_dt_scol7)
    print("Array of F1 Scores DT-SMO:", df8_l, ":", f1_dt_scol7)
    print("Array of ROCAUC Scores DT-SMO:", df8_l, ":", rocauc_dt_scol7)
    print("Array of Recall Scores DT-SMO:", df8_l, ":", recall_dt_scol7)
    print("Array of Precision Scores DT-SMO:", df8_l, ":", precision_dt_scol7)
    print("Array of Accuracy Scores DT-SMO:", df8_l, ":", accuracy_dt_scol7)

    print("Array of Prob Scores NB-SMO:", df8_l, ":", probs_nb_scol7)
    print("Array of F1 Scores NB-SMO:", df8_l, ":", f1_nb_scol7)
    print("Array of ROCAUC Scores NB-SMO:", df8_l, ":", rocauc_nb_scol7)
    print("Array of Recall Scores NB-SMO:", df8_l, ":", recall_nb_scol7)
    print("Array of Precision Scores NB-SMO:", df8_l, ":", precision_nb_scol7)
    print("Array of Accuracy Scores NB-SMO:", df8_l, ":", accuracy_nb_scol7)

    print("Array of Prob Scores XG-SMO:", df8_l, ":", probs_xg_scol7)
    print("Array of F1 Scores XG-SMO:", df8_l, ":", f1_xg_scol7)
    print("Array of ROCAUC Scores XG-SMO:", df8_l, ":", rocauc_xg_scol7)
    print("Array of Recall Scores XG-SMO:", df8_l, ":", recall_xg_scol7)
    print("Array of Precision Scores XG-SMO:", df8_l, ":", precision_xg_scol7)
    print("Array of Accuracy Scores XG-SMO:", df8_l, ":", accuracy_xg_scol7)

    print("Array of Prob Scores RF-SMO:", df8_l, ":", probs_rf_scol7)
    print("Array of F1 Scores RF-SMO:", df8_l, ":", f1_rf_scol7)
    print("Array of ROCAUC Scores RF-SMO:", df8_l, ":", rocauc_rf_scol7)
    print("Array of Recall Scores RF-SMO:", df8_l, ":", recall_rf_scol7)
    print("Array of Precision Scores RF-SMO:", df8_l, ":", precision_rf_scol7)
    print("Array of Accuracy Scores RF-SMO:", df8_l, ":", accuracy_rf_scol7)

year7 = [ args.group for t in range(25)]
sampling7 =['Oversampling' for t in range(25)]
technique7 = ['SMOTE' for t in range(25)]
...
x_smote8, y_smote8 = smote.fit_resample(x_tfidf8, df9["label"])
...
for i in train_values:
    ...
    x_train, x_test, y_train, y_test = train_test_split(x_smote8, y_smote8, train_size=i, stratify=y_smote8)
    ...
    print("===Logistic Regression with TfidfVectorizer SMOTE - ", args.group, df9_l, i)
    lr_end = time.time()
    print('Logistic F1-score', fly * 100)
    print('Logistic ROCAUC score:', rocauc_lr * 100)
    print('Logistic Recall score:', recalls_lr * 100)
    ...
    print("===DecisionTreeClassifier with TfidfVectorizer SMOTE - ", args.group, df9_l, i)
    dt_end = time.time()
    print('DCT F1-score', fdct * 100)
    print('DCT ROCAUC score:', rocauc_dt * 100)
    print('DCT Recall score:', recalls_dt * 100)
    ...
    nb_end = time.time()
    # Use accuracy_score function to get the accuracy
    print("===Naive Bayes with TfidfVectorizer SMOTE - ", args.group, df9_l, i)
    print('Naive F1-score', fnb * 100)
    print('Naive ROCAUC score:', rocauc_nb * 100)
    print('Naive Recall score:', recalls_nb * 100)
    print('Naive Precision Score:', precisions_nb * 100)
    ...
    xg_end = time.time()
    print("===XGB with TfidfVectorizer SMOTE - ", args.group, df9_l, i)
    print('XGB F1-Score', fxg * 100)
    print('XGB ROCAUC Score:', rocauc_xg * 100)
    print('XGB Recall score:', recall_xg * 100)
    print('XGB Precision Score:', precisions_xg * 100)
    ...
    rf_end = time.time()
    print("====RandomForest with Tfidf SMOTE ", args.group, df9_l, i)
    print('RFC F1 score', frfc * 100)
    print('RFC ROCAUC Score:', rocauc_rf * 100)
    print('RFC Recall score:', recalls_rf * 100)
    print('RFC Precision Score:', precisions_rf * 100)
    ...
    print("Array of Prob Scores LR-SMO:", df9_l, ":", probs_lr_scol8)
    print("Array of F1 Scores LR-SMO:", df9_l, ":", f1_lr_scol8)
    print("Array of ROCAUC Scores LR-SMO:", df9_l, ":", rocauc_lr_scol8)
    print("Array of Recall Scores LR-SMO:", df9_l, ":", recall_lr_scol8)
    print("Array of Precision Scores LR-SMO:", df9_l, ":", precision_lr_scol8)
    print("Array of Accuracy Scores LR-SMO:", df9_l, ":", accuracy_lr_scol8)

    print("Array of Prob Scores DT-SMO:", df9_l, ":", probs_dt_scol8)
    print("Array of F1 Scores DT-SMO:", df9_l, ":", f1_dt_scol8)
    print("Array of ROCAUC Scores DT-SMO:", df9_l, ":", rocauc_dt_scol8)
    print("Array of Recall Scores DT-SMO:", df9_l, ":", recall_dt_scol8)
    print("Array of Precision Scores DT-SMO:", df9_l, ":", precision_dt_scol8)
    print("Array of Accuracy Scores DT-SMO:", df9_l, ":", accuracy_dt_scol8)

    print("Array of Prob Scores NB-SMO:", df9_l, ":", probs_nb_scol8)
    print("Array of F1 Scores NB-SMO:", df9_l, ":", f1_nb_scol8)
    print("Array of ROCAUC Scores NB-SMO:", df9_l, ":", rocauc_nb_scol8)
    print("Array of Recall Scores NB-SMO:", df9_l, ":", recall_nb_scol8)
    print("Array of Precision Scores NB-SMO:", df9_l, ":", precision_nb_scol8)
    print("Array of Accuracy Scores NB-SMO:", df9_l, ":", accuracy_nb_scol8)

    print("Array of Prob Scores XG-SMO:", df9_l, ":", probs_xg_scol8)
    print("Array of F1 Scores XG-SMO:", df9_l, ":", f1_xg_scol8)
    print("Array of ROCAUC Scores XG-SMO:", df9_l, ":", rocauc_xg_scol8)
    print("Array of Recall Scores XG-SMO:", df9_l, ":", recall_xg_scol8)
    print("Array of Precision Scores XG-SMO:", df9_l, ":", precision_xg_scol8)
    print("Array of Accuracy Scores XG-SMO:", df9_l, ":", accuracy_xg_scol8)

    print("Array of Prob Scores RF-SMO:", df9_l, ":", probs_rf_scol8)
    print("Array of F1 Scores RF-SMO:", df9_l, ":", f1_rf_scol8)
    print("Array of ROCAUC Scores RF-SMO:", df9_l, ":", rocauc_rf_scol8)
    print("Array of Recall Scores RF-SMO:", df9_l, ":", recall_rf_scol8)
    print("Array of Precision Scores RF-SMO:", df9_l, ":", precision_rf_scol8)
    print("Array of Accuracy Scores RF-SMO:", df9_l, ":", accuracy_rf_scol8)

year8 = [ args.group for t in range(25)]
sampling8 =['Oversampling' for t in range(25)]
technique8 = ['SMOTE' for t in range(25)]
...
x_smote9, y_smote9 = smote.fit_resample(x_tfidf9, df10["label"])
...
for i in train_values:
    ...
    x_train, x_test, y_train, y_test = train_test_split(x_smote9, y_smote9, train_size=i, stratify=y_smote9)
    ...
    print("===Logistic Regression with TfidfVectorizer SMOTE - ", args.group, df10_l, i)
    lr_end = time.time()
    print('Logistic F1-score', fly * 100)
    print('Logistic ROCAUC score:', rocauc_lr * 100)
    print('Logistic Recall score:', recalls_lr * 100)
    ...
    print("===DecisionTreeClassifier with TfidfVectorizer SMOTE - ", args.group, df10_l, i)
    dt_end = time.time()
    print('DCT F1-score', fdct * 100)
    print('DCT ROCAUC score:', rocauc_dt * 100)
    print('DCT Recall score:', recalls_dt * 100)
    ...
    nb_end = time.time()
    # Use accuracy_score function to get the accuracy
    print("===Naive Bayes with TfidfVectorizer SMOTE - ", args.group, df10_l, i)
    print('Naive F1-score', fnb * 100)
    print('Naive ROCAUC score:', rocauc_nb * 100)
    print('Naive Recall score:', recalls_nb * 100)
    print('Naive Precision Score:', precisions_nb * 100)
    ...
    xg_end = time.time()
    print("===XGB with TfidfVectorizer SMOTE - ", args.group, df10_l, i)
    print('XGB F1-Score', fxg * 100)
    print('XGB ROCAUC Score:', rocauc_xg * 100)
    print('XGB Recall score:', recall_xg * 100)
    print('XGB Precision Score:', precisions_xg * 100)
    ...
    rf_end = time.time()
    print("====RandomForest with Tfidf SMOTE ", args.group, df10_l, i)
    print('RFC F1 score', frfc * 100)
    print('RFC ROCAUC Score:', rocauc_rf * 100)
    print('RFC Recall score:', recalls_rf * 100)
    print('RFC Precision Score:', precisions_rf * 100)
    ...
    print("Array of Prob Scores LR-SMO:", df10_l, ":", probs_lr_scol9)
    print("Array of F1 Scores LR-SMO:", df10_l, ":", f1_lr_scol9)
    print("Array of ROCAUC Scores LR-SMO:", df10_l, ":", rocauc_lr_scol9)
    print("Array of Recall Scores LR-SMO:", df10_l, ":", recall_lr_scol9)
    print("Array of Precision Scores LR-SMO:", df10_l, ":", precision_lr_scol9)
    print("Array of Accuracy Scores LR-SMO:", df10_l, ":", accuracy_lr_scol9)

    print("Array of Prob Scores DT-SMO:", df10_l, ":", probs_dt_scol9)
    print("Array of F1 Scores DT-SMO:", df10_l, ":", f1_dt_scol9)
    print("Array of ROCAUC Scores DT-SMO:", df10_l, ":", rocauc_dt_scol9)
    print("Array of Recall Scores DT-SMO:", df10_l, ":", recall_dt_scol9)
    print("Array of Precision Scores DT-SMO:", df10_l, ":", precision_dt_scol9)
    print("Array of Accuracy Scores DT-SMO:", df10_l, ":", accuracy_dt_scol9)

    print("Array of Prob Scores NB-SMO:", df10_l, ":", probs_nb_scol9)
    print("Array of F1 Scores NB-SMO:", df10_l, ":", f1_nb_scol9)
    print("Array of ROCAUC Scores NB-SMO:", df10_l, ":", rocauc_nb_scol9)
    print("Array of Recall Scores NB-SMO:", df10_l, ":", recall_nb_scol9)
    print("Array of Precision Scores NB-SMO:", df10_l, ":", precision_nb_scol9)
    print("Array of Accuracy Scores NB-SMO:", df10_l, ":", accuracy_nb_scol9)

    print("Array of Prob Scores XG-SMO:", df10_l, ":", probs_xg_scol9)
    print("Array of F1 Scores XG-SMO:", df10_l, ":", f1_xg_scol9)
    print("Array of ROCAUC Scores XG-SMO:", df10_l, ":", rocauc_xg_scol9)
    print("Array of Recall Scores XG-SMO:", df10_l, ":", recall_xg_scol9)
    print("Array of Precision Scores XG-SMO:", df10_l, ":", precision_xg_scol9)
    print("Array of Accuracy Scores XG-SMO:", df10_l, ":", accuracy_xg_scol9)

    print("Array of Prob Scores RF-SMO:", df10_l, ":", probs_rf_scol9)
    print("Array of F1 Scores RF-SMO:", df10_l, ":", f1_rf_scol9)
    print("Array of ROCAUC Scores RF-SMO:", df10_l, ":", rocauc_rf_scol9)
    print("Array of Recall Scores RF-SMO:", df10_l, ":", recall_rf_scol9)
    print("Array of Precision Scores RF-SMO:", df10_l, ":", precision_rf_scol9)
    print("Array of Accuracy Scores RF-SMO:", df10_l, ":", accuracy_rf_scol9)

year9 = [ args.group for t in range(25)]
sampling9 =['Oversampling' for t in range(25)]
technique9 = ['SMOTE' for t in range(25)]
...
x_smote10, y_smote10 = smote.fit_resample(x_tfidf10, df11["label"])
...
for i in train_values:
    ...
    x_train, x_test, y_train, y_test = train_test_split(x_smote10, y_smote10, train_size=i, stratify=y_smote10)
    ...
    print("===Logistic Regression with TfidfVectorizer SMOTE - ", args.group, df11_l, i)
    lr_end = time.time()
    print('Logistic F1-score', fly * 100)
    print('Logistic ROCAUC score:', rocauc_lr * 100)
    print('Logistic Recall score:', recalls_lr * 100)
    ...
    print("===DecisionTreeClassifier with TfidfVectorizer SMOTE - ", args.group, df11_l, i)
    dt_end = time.time()
    print('DCT F1-score', fdct * 100)
    print('DCT ROCAUC score:', rocauc_dt * 100)
    print('DCT Recall score:', recalls_dt * 100)
    ...
    nb_end = time.time()
    # Use accuracy_score function to get the accuracy
    print("===Naive Bayes with TfidfVectorizer SMOTE - ", args.group, df11_l, i)
    print('Naive F1-score', fnb * 100)
    print('Naive ROCAUC score:', rocauc_nb * 100)
    print('Naive Recall score:', recalls_nb * 100)
    print('Naive Precision Score:', precisions_nb * 100)
    ...
    xg_end = time.time()
    print("===XGB with TfidfVectorizer SMOTE - ", args.group, df11_l, i)
    print('XGB F1-Score', fxg * 100)
    print('XGB ROCAUC Score:', rocauc_xg * 100)
    print('XGB Recall score:', recall_xg * 100)
    print('XGB Precision Score:', precisions_xg * 100)
    ...
    rf_end = time.time()
    print("====RandomForest with Tfidf SMOTE ", args.group, df11_l, i)
    print('RFC F1 score', frfc * 100)
    print('RFC ROCAUC Score:', rocauc_rf * 100)
    print('RFC Recall score:', recalls_rf * 100)
    print('RFC Precision Score:', precisions_rf * 100)
    ...
    print("Array of Prob Scores LR-SMO:", df11_l, ":", probs_lr_scol10)
    print("Array of F1 Scores LR-SMO:", df11_l, ":", f1_lr_scol10)
    print("Array of ROCAUC Scores LR-SMO:", df11_l, ":", rocauc_lr_scol10)
    print("Array of Recall Scores LR-SMO:", df11_l, ":", recall_lr_scol10)
    print("Array of Precision Scores LR-SMO:", df11_l, ":", precision_lr_scol10)
    print("Array of Accuracy Scores LR-SMO:", df11_l, ":", accuracy_lr_scol10)

    print("Array of Prob Scores DT-SMO:", df11_l, ":", probs_dt_scol10)
    print("Array of F1 Scores DT-SMO:", df11_l, ":", f1_dt_scol10)
    print("Array of ROCAUC Scores DT-SMO:", df11_l, ":", rocauc_dt_scol10)
    print("Array of Recall Scores DT-SMO:", df11_l, ":", recall_dt_scol10)
    print("Array of Precision Scores DT-SMO:", df11_l, ":", precision_dt_scol10)
    print("Array of Accuracy Scores DT-SMO:", df11_l, ":", accuracy_dt_scol10)

    print("Array of Prob Scores NB-SMO:", df11_l, ":", probs_nb_scol10)
    print("Array of F1 Scores NB-SMO:", df11_l, ":", f1_nb_scol10)
    print("Array of ROCAUC Scores NB-SMO:", df11_l, ":", rocauc_nb_scol10)
    print("Array of Recall Scores NB-SMO:", df11_l, ":", recall_nb_scol10)
    print("Array of Precision Scores NB-SMO:", df11_l, ":", precision_nb_scol10)
    print("Array of Accuracy Scores NB-SMO:", df11_l, ":", accuracy_nb_scol10)

    print("Array of Prob Scores XG-SMO:", df11_l, ":", probs_xg_scol10)
    print("Array of F1 Scores XG-SMO:", df11_l, ":", f1_xg_scol10)
    print("Array of ROCAUC Scores XG-SMO:", df11_l, ":", rocauc_xg_scol10)
    print("Array of Recall Scores XG-SMO:", df11_l, ":", recall_xg_scol10)
    print("Array of Precision Scores XG-SMO:", df11_l, ":", precision_xg_scol10)
    print("Array of Accuracy Scores XG-SMO:", df11_l, ":", accuracy_xg_scol10)

    print("Array of Prob Scores RF-SMO:", df11_l, ":", probs_rf_scol10)
    print("Array of F1 Scores RF-SMO:", df11_l, ":", f1_rf_scol10)
    print("Array of ROCAUC Scores RF-SMO:", df11_l, ":", rocauc_rf_scol10)
    print("Array of Recall Scores RF-SMO:", df11_l, ":", recall_rf_scol10)
    print("Array of Precision Scores RF-SMO:", df11_l, ":", precision_rf_scol10)
    print("Array of Accuracy Scores RF-SMO:", df11_l, ":", accuracy_rf_scol10)
    

year10 = [ args.group for t in range(25)]
sampling10 =['Oversampling' for t in range(25)]
technique10 = ['SMOTE' for t in range(25)]
...
x_smote11, y_smote11 = smote.fit_resample(x_tfidf11, df12["label"])
...
for i in train_values:
    ...
    x_train, x_test, y_train, y_test = train_test_split(x_smote11, y_smote11, train_size=i)
    ...
    print("===Logistic Regression with TfidfVectorizer SMOTE - ", args.group, df12_l, i)
    lr_end = time.time()
    print('Logistic F1-score', fly * 100)
    print('Logistic ROCAUC score:', rocauc_lr * 100)
    print('Logistic Recall score:', recalls_lr * 100)
    ...
    print("===DecisionTreeClassifier with TfidfVectorizer SMOTE - ", args.group, df12_l, i)
    dt_end = time.time()
    print('DCT F1-score', fdct * 100)
    print('DCT ROCAUC score:', rocauc_dt * 100)
    print('DCT Recall score:', recalls_dt * 100)
    ...
    nb_end = time.time()
    # Use accuracy_score function to get the accuracy
    print("===Naive Bayes with TfidfVectorizer SMOTE - ", args.group, df12_l, i)
    print('Naive F1-score', fnb * 100)
    print('Naive ROCAUC score:', rocauc_nb * 100)
    print('Naive Recall score:', recalls_nb * 100)
    print('Naive Precision Score:', precisions_nb * 100)
    ...
    xg_end = time.time()
    print("===XGB with TfidfVectorizer SMOTE - ", args.group, df12_l, i)
    print('XGB F1-Score', fxg * 100)
    print('XGB ROCAUC Score:', rocauc_xg * 100)
    print('XGB Recall score:', recall_xg * 100)
    print('XGB Precision Score:', precisions_xg * 100)
    ...
    rf_end = time.time()
    print("====RandomForest with Tfidf SMOTE ", args.group, df12_l, i)
    print('RFC F1 score', frfc * 100)
    print('RFC ROCAUC Score:', rocauc_rf * 100)
    print('RFC Recall score:', recalls_rf * 100)
    print('RFC Precision Score:', precisions_rf * 100)
    ...
    print("Array of Prob Scores LR-SMO:", df12_l, ":", probs_lr_scol11)
    print("Array of F1 Scores LR-SMO:", df12_l, ":", f1_lr_scol11)
    print("Array of ROCAUC Scores LR-SMO:", df12_l, ":", rocauc_lr_scol11)
    print("Array of Recall Scores LR-SMO:", df12_l, ":", recall_lr_scol11)
    print("Array of Precision Scores LR-SMO:", df12_l, ":", precision_lr_scol11)
    print("Array of Accuracy Scores LR-SMO:", df12_l, ":", accuracy_lr_scol11)

    print("Array of Prob Scores DT-SMO:", df12_l, ":", probs_dt_scol11)
    print("Array of F1 Scores DT-SMO:", df12_l, ":", f1_dt_scol11)
    print("Array of ROCAUC Scores DT-SMO:", df12_l, ":", rocauc_dt_scol11)
    print("Array of Recall Scores DT-SMO:", df12_l, ":", recall_dt_scol11)
    print("Array of Precision Scores DT-SMO:", df12_l, ":", precision_dt_scol11)
    print("Array of Accuracy Scores DT-SMO:", df12_l, ":", accuracy_dt_scol11)

    print("Array of Prob Scores NB-SMO:", df12_l, ":", probs_nb_scol11)
    print("Array of F1 Scores NB-SMO:", df12_l, ":", f1_nb_scol11)
    print("Array of ROCAUC Scores NB-SMO:", df12_l, ":", rocauc_nb_scol11)
    print("Array of Recall Scores NB-SMO:", df12_l, ":", recall_nb_scol11)
    print("Array of Precision Scores NB-SMO:", df12_l, ":", precision_nb_scol11)
    print("Array of Accuracy Scores NB-SMO:", df12_l, ":", accuracy_nb_scol11)

    print("Array of Prob Scores XG-SMO:", df12_l, ":", probs_xg_scol11)
    print("Array of F1 Scores XG-SMO:", df12_l, ":", f1_xg_scol11)
    print("Array of ROCAUC Scores XG-SMO:", df12_l, ":", rocauc_xg_scol11)
    print("Array of Recall Scores XG-SMO:", df12_l, ":", recall_xg_scol11)
    print("Array of Precision Scores XG-SMO:", df12_l, ":", precision_xg_scol11)
    print("Array of Accuracy Scores XG-SMO:", df12_l, ":", accuracy_xg_scol11)

    print("Array of Prob Scores RF-SMO:", df12_l, ":", probs_rf_scol11)
    print("Array of F1 Scores RF-SMO:", df12_l, ":", f1_rf_scol11)
    print("Array of ROCAUC Scores RF-SMO:", df12_l, ":", rocauc_rf_scol11)
    print("Array of Recall Scores RF-SMO:", df12_l, ":", recall_rf_scol11)
    print("Array of Precision Scores RF-SMO:", df12_l, ":", precision_rf_scol11)
    print("Array of Accuracy Scores RF-SMO:", df12_l, ":", accuracy_rf_scol11)

year11 = [ args.group for t in range(25)]
sampling11 =['Oversampling' for t in range(25)]
technique11 = ['SMOTE' for t in range(25)]
...
x_smote12, y_smote12 = smote.fit_resample(x_tfidf12, df13["label"])
...
for i in train_values:
    ...
    x_train, x_test, y_train, y_test = train_test_split(x_smote12, y_smote12, train_size=i, stratify=y_smote12)
    ...
    print("===Logistic Regression with TfidfVectorizer SMOTE - ", args.group, df13_l, i)
    lr_end = time.time()
    print('Logistic F1-score', fly * 100)
    print('Logistic ROCAUC score:', rocauc_lr * 100)
    print('Logistic Recall score:', recalls_lr * 100)
    ...
    print("===DecisionTreeClassifier with TfidfVectorizer SMOTE - ", args.group, df13_l, i)
    dt_end = time.time()
    print('DCT F1-score', fdct * 100)
    print('DCT ROCAUC score:', rocauc_dt * 100)
    print('DCT Recall score:', recalls_dt * 100)
    ...
    nb_end = time.time()
    # Use accuracy_score function to get the accuracy
    print("===Naive Bayes with TfidfVectorizer SMOTE - ", args.group, df13_l, i)
    print('Naive F1-score', fnb * 100)
    print('Naive ROCAUC score:', rocauc_nb * 100)
    print('Naive Recall score:', recalls_nb * 100)
    print('Naive Precision Score:', precisions_nb * 100)
    ...
    xg_end = time.time()
    print("===XGB with TfidfVectorizer SMOTE - ", args.group, df13_l, i)
    print('XGB F1-Score', fxg * 100)
    print('XGB ROCAUC Score:', rocauc_xg * 100)
    print('XGB Recall score:', recall_xg * 100)
    print('XGB Precision Score:', precisions_xg * 100)
    ...
    rf_end = time.time()
    print("====RandomForest with Tfidf SMOTE ", args.group, df13_l, i)
    print('RFC F1 score', frfc * 100)
    print('RFC ROCAUC Score:', rocauc_rf * 100)
    print('RFC Recall score:', recalls_rf * 100)
    print('RFC Precision Score:', precisions_rf * 100)
    ...
    print("Array of Prob Scores LR-SMO:", df13_l, ":", probs_lr_scol12)
    print("Array of F1 Scores LR-SMO:", df13_l, ":", f1_lr_scol12)
    print("Array of ROCAUC Scores LR-SMO:", df13_l, ":", rocauc_lr_scol12)
    print("Array of Recall Scores LR-SMO:", df13_l, ":", recall_lr_scol12)
    print("Array of Precision Scores LR-SMO:", df13_l, ":", precision_lr_scol12)
    print("Array of Accuracy Scores LR-SMO:", df13_l, ":", accuracy_lr_scol12)

    print("Array of Prob Scores DT-SMO:", df13_l, ":", probs_dt_scol12)
    print("Array of F1 Scores DT-SMO:", df13_l, ":", f1_dt_scol12)
    print("Array of ROCAUC Scores DT-SMO:", df13_l, ":", rocauc_dt_scol12)
    print("Array of Recall Scores DT-SMO:", df13_l, ":", recall_dt_scol12)
    print("Array of Precision Scores DT-SMO:", df13_l, ":", precision_dt_scol12)
    print("Array of Accuracy Scores DT-SMO:", df13_l, ":", accuracy_dt_scol12)

    print("Array of Prob Scores NB-SMO:", df13_l, ":", probs_nb_scol12)
    print("Array of F1 Scores NB-SMO:", df13_l, ":", f1_nb_scol12)
    print("Array of ROCAUC Scores NB-SMO:", df13_l, ":", rocauc_nb_scol12)
    print("Array of Recall Scores NB-SMO:", df13_l, ":", recall_nb_scol12)
    print("Array of Precision Scores NB-SMO:", df13_l, ":", precision_nb_scol12)
    print("Array of Accuracy Scores NB-SMO:", df13_l, ":", accuracy_nb_scol12)

    print("Array of Prob Scores XG-SMO:", df13_l, ":", probs_xg_scol12)
    print("Array of F1 Scores XG-SMO:", df13_l, ":", f1_xg_scol12)
    print("Array of ROCAUC Scores XG-SMO:", df13_l, ":", rocauc_xg_scol12)
    print("Array of Recall Scores XG-SMO:", df13_l, ":", recall_xg_scol12)
    print("Array of Precision Scores XG-SMO:", df13_l, ":", precision_xg_scol12)
    print("Array of Accuracy Scores XG-SMO:", df13_l, ":", accuracy_xg_scol12)

    print("Array of Prob Scores RF-SMO:", df13_l, ":", probs_rf_scol12)
    print("Array of F1 Scores RF-SMO:", df13_l, ":", f1_rf_scol12)
    print("Array of ROCAUC Scores RF-SMO:", df13_l, ":", rocauc_rf_scol12)
    print("Array of Recall Scores RF-SMO:", df13_l, ":", recall_rf_scol12)
    print("Array of Precision Scores RF-SMO:", df13_l, ":", precision_rf_scol12)
    print("Array of Accuracy Scores RF-SMO:", df13_l, ":", accuracy_rf_scol12)

year12 = [ args.group for t in range(25)]
sampling12 =['Oversampling' for t in range(25)]
technique12 = ['SMOTE' for t in range(25)]
...
x_smote13, y_smote13 = smote.fit_resample(x_tfidf13, df14["label"])
...
for i in train_values:
    ...
    x_train, x_test, y_train, y_test = train_test_split(x_smote13, y_smote13, train_size=i, stratify=y_smote13)
    ...
    print("===Logistic Regression with TfidfVectorizer SMOTE - ", args.group, df14_l, i)
    lr_end = time.time()
    print('Logistic F1-score', fly * 100)
    print('Logistic ROCAUC score:', rocauc_lr * 100)
    print('Logistic Recall score:', recalls_lr * 100)
    ...
    print("===DecisionTreeClassifier with TfidfVectorizer SMOTE - ", args.group, df14_l, i)
    dt_end = time.time()
    print('DCT F1-score', fdct * 100)
    print('DCT ROCAUC score:', rocauc_dt * 100)
    print('DCT Recall score:', recalls_dt * 100)
    ...
    nb_end = time.time()
    # Use accuracy_score function to get the accuracy
    print("===Naive Bayes with TfidfVectorizer SMOTE - ", args.group, df14_l, i)
    print('Naive F1-score', fnb * 100)
    print('Naive ROCAUC score:', rocauc_nb * 100)
    print('Naive Recall score:', recalls_nb * 100)
    print('Naive Precision Score:', precisions_nb * 100)
    ...
    xg_end = time.time()
    print("===XGB with TfidfVectorizer SMOTE - ", args.group, df14_l, i)
    print('XGB F1-Score', fxg * 100)
    print('XGB ROCAUC Score:', rocauc_xg * 100)
    print('XGB Recall score:', recall_xg * 100)
    print('XGB Precision Score:', precisions_xg * 100)
    ...
    rf_end = time.time()
    print("====RandomForest with Tfidf SMOTE ", args.group, df14_l, i)
    print('RFC F1 score', frfc * 100)
    print('RFC ROCAUC Score:', rocauc_rf * 100)
    print('RFC Recall score:', recalls_rf * 100)
    print('RFC Precision Score:', precisions_rf * 100)
    ...
    print("Array of Prob Scores LR-SMO:", df14_l, ":", probs_lr_scol13)
    print("Array of F1 Scores LR-SMO:", df14_l, ":", f1_lr_scol13)
    print("Array of ROCAUC Scores LR-SMO:", df14_l, ":", rocauc_lr_scol13)
    print("Array of Recall Scores LR-SMO:", df14_l, ":", recall_lr_scol13)
    print("Array of Precision Scores LR-SMO:", df14_l, ":", precision_lr_scol13)
    print("Array of Accuracy Scores LR-SMO:", df14_l, ":", accuracy_lr_scol13)

    print("Array of Prob Scores DT-SMO:", df14_l, ":", probs_dt_scol13)
    print("Array of F1 Scores DT-SMO:", df14_l, ":", f1_dt_scol13)
    print("Array of ROCAUC Scores DT-SMO:", df14_l, ":", rocauc_dt_scol13)
    print("Array of Recall Scores DT-SMO:", df14_l, ":", recall_dt_scol13)
    print("Array of Precision Scores DT-SMO:", df14_l, ":", precision_dt_scol13)
    print("Array of Accuracy Scores DT-SMO:", df14_l, ":", accuracy_dt_scol13)

    print("Array of Prob Scores NB-SMO:", df14_l, ":", probs_nb_scol13)
    print("Array of F1 Scores NB-SMO:", df14_l, ":", f1_nb_scol13)
    print("Array of ROCAUC Scores NB-SMO:", df14_l, ":", rocauc_nb_scol13)
    print("Array of Recall Scores NB-SMO:", df14_l, ":", recall_nb_scol13)
    print("Array of Precision Scores NB-SMO:", df14_l, ":", precision_nb_scol13)
    print("Array of Accuracy Scores NB-SMO:", df14_l, ":", accuracy_nb_scol13)

    print("Array of Prob Scores XG-SMO:", df14_l, ":", probs_xg_scol13)
    print("Array of F1 Scores XG-SMO:", df14_l, ":", f1_xg_scol13)
    print("Array of ROCAUC Scores XG-SMO:", df14_l, ":", rocauc_xg_scol13)
    print("Array of Recall Scores XG-SMO:", df14_l, ":", recall_xg_scol13)
    print("Array of Precision Scores XG-SMO:", df14_l, ":", precision_xg_scol13)
    print("Array of Accuracy Scores XG-SMO:", df14_l, ":", accuracy_xg_scol13)

    print("Array of Prob Scores RF-SMO:", df14_l, ":", probs_rf_scol13)
    print("Array of F1 Scores RF-SMO:", df14_l, ":", f1_rf_scol13)
    print("Array of ROCAUC Scores RF-SMO:", df14_l, ":", rocauc_rf_scol13)
    print("Array of Recall Scores RF-SMO:", df14_l, ":", recall_rf_scol13)
    print("Array of Precision Scores RF-SMO:", df14_l, ":", precision_rf_scol13)
    print("Array of Accuracy Scores RF-SMO:", df14_l, ":", accuracy_rf_scol13)

year13 = [ args.group for t in range(25)]
sampling13 =['Oversampling' for t in range(25)]
technique13 = ['SMOTE' for t in range(25)]
...
x_smote14, y_smote14 = smote.fit_resample(x_tfidf14, df15["label"])
...
for i in train_values:
    ...
    x_train, x_test, y_train, y_test = train_test_split(x_smote14, y_smote14, train_size=i, stratify=y_smote14)
    ...
    print("===Logistic Regression with TfidfVectorizer SMOTE - ", args.group, df15_l, i)
    lr_end = time.time()
    print('Logistic F1-score', fly * 100)
    print('Logistic ROCAUC score:', rocauc_lr * 100)
    print('Logistic Recall score:', recalls_lr * 100)
    ...
    print("===DecisionTreeClassifier with TfidfVectorizer SMOTE - ", args.group, df15_l, i)
    dt_end = time.time()
    print('DCT F1-score', fdct * 100)
    print('DCT ROCAUC score:', rocauc_dt * 100)
    print('DCT Recall score:', recalls_dt * 100)
    ...
    nb_end = time.time()
    # Use accuracy_score function to get the accuracy
    print("===Naive Bayes with TfidfVectorizer SMOTE - ", args.group, df15_l, i)
    print('Naive F1-score', fnb * 100)
    print('Naive ROCAUC score:', rocauc_nb * 100)
    print('Naive Recall score:', recalls_nb * 100)
    print('Naive Precision Score:', precisions_nb * 100)
    ...
    xg_end = time.time()
    print("===XGB with TfidfVectorizer SMOTE - ", args.group, df15_l, i)
    print('XGB F1-Score', fxg * 100)
    print('XGB ROCAUC Score:', rocauc_xg * 100)
    print('XGB Recall score:', recall_xg * 100)
    print('XGB Precision Score:', precisions_xg * 100)
    ...
    rf_end = time.time()
    print("====RandomForest with Tfidf SMOTE ", args.group, df15_l, i)
    print('RFC F1 score', frfc * 100)
    print('RFC ROCAUC Score:', rocauc_rf * 100)
    print('RFC Recall score:', recalls_rf * 100)
    print('RFC Precision Score:', precisions_rf * 100)
    ...
    print("Array of Prob Scores LR-SMO:", df15_l, ":", probs_lr_scol14)
    print("Array of F1 Scores LR-SMO:", df15_l, ":", f1_lr_scol14)
    print("Array of ROCAUC Scores LR-SMO:", df15_l, ":", rocauc_lr_scol14)
    print("Array of Recall Scores LR-SMO:", df15_l, ":", recall_lr_scol14)
    print("Array of Precision Scores LR-SMO:", df15_l, ":", precision_lr_scol14)
    print("Array of Accuracy Scores LR-SMO:", df15_l, ":", accuracy_lr_scol14)

    print("Array of Prob Scores DT-SMO:", df15_l, ":", probs_dt_scol14)
    print("Array of F1 Scores DT-SMO:", df15_l, ":", f1_dt_scol14)
    print("Array of ROCAUC Scores DT-SMO:", df15_l, ":", rocauc_dt_scol14)
    print("Array of Recall Scores DT-SMO:", df15_l, ":", recall_dt_scol14)
    print("Array of Precision Scores DT-SMO:", df15_l, ":", precision_dt_scol14)
    print("Array of Accuracy Scores DT-SMO:", df15_l, ":", accuracy_dt_scol14)

    print("Array of Prob Scores NB-SMO:", df15_l, ":", probs_nb_scol14)
    print("Array of F1 Scores NB-SMO:", df15_l, ":", f1_nb_scol14)
    print("Array of ROCAUC Scores NB-SMO:", df15_l, ":", rocauc_nb_scol14)
    print("Array of Recall Scores NB-SMO:", df15_l, ":", recall_nb_scol14)
    print("Array of Precision Scores NB-SMO:", df15_l, ":", precision_nb_scol14)
    print("Array of Accuracy Scores NB-SMO:", df15_l, ":", accuracy_nb_scol14)

    print("Array of Prob Scores XG-SMO:", df15_l, ":", probs_xg_scol14)
    print("Array of F1 Scores XG-SMO:", df15_l, ":", f1_xg_scol14)
    print("Array of ROCAUC Scores XG-SMO:", df15_l, ":", rocauc_xg_scol14)
    print("Array of Recall Scores XG-SMO:", df15_l, ":", recall_xg_scol14)
    print("Array of Precision Scores XG-SMO:", df15_l, ":", precision_xg_scol14)
    print("Array of Accuracy Scores XG-SMO:", df15_l, ":", accuracy_xg_scol14)

    print("Array of Prob Scores RF-SMO:", df15_l, ":", probs_rf_scol14)
    print("Array of F1 Scores RF-SMO:", df15_l, ":", f1_rf_scol14)
    print("Array of ROCAUC Scores RF-SMO:", df15_l, ":", rocauc_rf_scol14)
    print("Array of Recall Scores RF-SMO:", df15_l, ":", recall_rf_scol14)
    print("Array of Precision Scores RF-SMO:", df15_l, ":", precision_rf_scol14)
    print("Array of Accuracy Scores RF-SMO:", df15_l, ":", accuracy_rf_scol14)

year14 = [ args.group for t in range(25)]
sampling14 =['Oversampling' for t in range(25)]
technique14 = ['SMOTE' for t in range(25)]
...
x_smote15, y_smote15 = smote.fit_resample(x_tfidf15, df16["label"])
...
for i in train_values:
    ...
    x_train, x_test, y_train, y_test = train_test_split(x_smote15, y_smote15, train_size=i, stratify=y_smote15)
    ...
    print("===Logistic Regression with TfidfVectorizer SMOTE - ", args.group, df16_l, i)
    lr_end = time.time()
    print('Logistic F1-score', fly * 100)
    print('Logistic ROCAUC score:', rocauc_lr * 100)
    print('Logistic Recall score:', recalls_lr * 100)
    ...
    print("===DecisionTreeClassifier with TfidfVectorizer SMOTE - ", args.group, df16_l, i)
    dt_end = time.time()
    print('DCT F1-score', fdct * 100)
    print('DCT ROCAUC score:', rocauc_dt * 100)
    print('DCT Recall score:', recalls_dt * 100)
    ...
    nb_end = time.time()
    # Use accuracy_score function to get the accuracy
    print("===Naive Bayes with TfidfVectorizer SMOTE - ", args.group, df16_l, i)
    print('Naive F1-score', fnb * 100)
    print('Naive ROCAUC score:', rocauc_nb * 100)
    print('Naive Recall score:', recalls_nb * 100)
    print('Naive Precision Score:', precisions_nb * 100)
    ...
    xg_end = time.time()
    print("===XGB with TfidfVectorizer SMOTE - ", args.group, df16_l, i)
    print('XGB F1-Score', fxg * 100)
    print('XGB ROCAUC Score:', rocauc_xg * 100)
    print('XGB Recall score:', recall_xg * 100)
    print('XGB Precision Score:', precisions_xg * 100)
    ...
    rf_end = time.time()
    print("====RandomForest with Tfidf SMOTE ", args.group, df16_l, i)
    print('RFC F1 score', frfc * 100)
    print('RFC ROCAUC Score:', rocauc_rf * 100)
    print('RFC Recall score:', recalls_rf * 100)
    print('RFC Precision Score:', precisions_rf * 100)
    ...
    print("Array of Prob Scores LR-SMO:", df16_l, ":", probs_lr_scol15)
    print("Array of F1 Scores LR-SMO:", df16_l, ":", f1_lr_scol15)
    print("Array of ROCAUC Scores LR-SMO:", df16_l, ":", rocauc_lr_scol15)
    print("Array of Recall Scores LR-SMO:", df16_l, ":", recall_lr_scol15)
    print("Array of Precision Scores LR-SMO:", df16_l, ":", precision_lr_scol15)
    print("Array of Accuracy Scores LR-SMO:", df16_l, ":", accuracy_lr_scol15)

    print("Array of Prob Scores DT-SMO:", df16_l, ":", probs_dt_scol15)
    print("Array of F1 Scores DT-SMO:", df16_l, ":", f1_dt_scol15)
    print("Array of ROCAUC Scores DT-SMO:", df16_l, ":", rocauc_dt_scol15)
    print("Array of Recall Scores DT-SMO:", df16_l, ":", recall_dt_scol15)
    print("Array of Precision Scores DT-SMO:", df16_l, ":", precision_dt_scol15)
    print("Array of Accuracy Scores DT-SMO:", df16_l, ":", accuracy_dt_scol15)

    print("Array of Prob Scores NB-SMO:", df16_l, ":", probs_nb_scol15)
    print("Array of F1 Scores NB-SMO:", df16_l, ":", f1_nb_scol15)
    print("Array of ROCAUC Scores NB-SMO:", df16_l, ":", rocauc_nb_scol15)
    print("Array of Recall Scores NB-SMO:", df16_l, ":", recall_nb_scol15)
    print("Array of Precision Scores NB-SMO:", df16_l, ":", precision_nb_scol15)
    print("Array of Accuracy Scores NB-SMO:", df16_l, ":", accuracy_nb_scol15)

    print("Array of Prob Scores XG-SMO:", df16_l, ":", probs_xg_scol15)
    print("Array of F1 Scores XG-SMO:", df16_l, ":", f1_xg_scol15)
    print("Array of ROCAUC Scores XG-SMO:", df16_l, ":", rocauc_xg_scol15)
    print("Array of Recall Scores XG-SMO:", df16_l, ":", recall_xg_scol15)
    print("Array of Precision Scores XG-SMO:", df16_l, ":", precision_xg_scol15)
    print("Array of Accuracy Scores XG-SMO:", df16_l, ":", accuracy_xg_scol15)

    print("Array of Prob Scores RF-SMO:", df16_l, ":", probs_rf_scol15)
    print("Array of F1 Scores RF-SMO:", df16_l, ":", f1_rf_scol15)
    print("Array of ROCAUC Scores RF-SMO:", df16_l, ":", rocauc_rf_scol15)
    print("Array of Recall Scores RF-SMO:", df16_l, ":", recall_rf_scol15)
    print("Array of Precision Scores RF-SMO:", df16_l, ":", precision_rf_scol15)
    print("Array of Accuracy Scores RF-SMO:", df16_l, ":", accuracy_rf_scol15)
    

year15 = [ args.group for t in range(25)]
sampling15 = ['Oversampling' for t in range(25)]
technique15 = ['SMOTE' for t in range(25)]
...
x_smote16, y_smote16 = smote.fit_resample(x_tfidf16, df17["label"])
...
for i in train_values:
    ...
    x_train, x_test, y_train, y_test = train_test_split(x_smote16, y_smote16, train_size=i, stratify=y_smote16)
    ...
    print("===Logistic Regression with TfidfVectorizer SMOTE - ", args.group, df17_l, i)
    lr_end = time.time()
    print('Logistic F1-score', fly * 100)
    print('Logistic ROCAUC score:', rocauc_lr * 100)
    print('Logistic Recall score:', recalls_lr * 100)
    ...
    print("===DecisionTreeClassifier with TfidfVectorizer SMOTE - ", args.group, df17_l, i)
    dt_end = time.time()
    print('DCT F1-score', fdct * 100)
    print('DCT ROCAUC score:', rocauc_dt * 100)
    print('DCT Recall score:', recalls_dt * 100)
    ...
    nb_end = time.time()
    # Use accuracy_score function to get the accuracy
    print("===Naive Bayes with TfidfVectorizer SMOTE - ", args.group, df17_l, i)
    print('Naive F1-score', fnb * 100)
    print('Naive ROCAUC score:', rocauc_nb * 100)
    print('Naive Recall score:', recalls_nb * 100)
    print('Naive Precision Score:', precisions_nb * 100)
    ...
    xg_end = time.time()
    print("===XGB with TfidfVectorizer SMOTE - ", args.group, df17_l, i)
    print('XGB F1-Score', fxg * 100)
    print('XGB ROCAUC Score:', rocauc_xg * 100)
    print('XGB Recall score:', recall_xg * 100)
    print('XGB Precision Score:', precisions_xg * 100)
    ...
    rf_end = time.time()
    print("====RandomForest with Tfidf SMOTE ", args.group, df17_l, i)
    print('RFC F1 score', frfc * 100)
    print('RFC ROCAUC Score:', rocauc_rf * 100)
    print('RFC Recall score:', recalls_rf * 100)
    print('RFC Precision Score:', precisions_rf * 100)
    ...
    print("Array of Prob Scores LR-SMO:", df17_l, ":", probs_lr_scol16)
    print("Array of F1 Scores LR-SMO:", df17_l, ":", f1_lr_scol16)
    print("Array of ROCAUC Scores LR-SMO:", df17_l, ":", rocauc_lr_scol16)
    print("Array of Recall Scores LR-SMO:", df17_l, ":", recall_lr_scol16)
    print("Array of Precision Scores LR-SMO:", df17_l, ":", precision_lr_scol16)
    print("Array of Accuracy Scores LR-SMO:", df17_l, ":", accuracy_lr_scol16)

    print("Array of Prob Scores DT-SMO:", df17_l, ":", probs_dt_scol16)
    print("Array of F1 Scores DT-SMO:", df17_l, ":", f1_dt_scol16)
    print("Array of ROCAUC Scores DT-SMO:", df17_l, ":", rocauc_dt_scol16)
    print("Array of Recall Scores DT-SMO:", df17_l, ":", recall_dt_scol16)
    print("Array of Precision Scores DT-SMO:", df17_l, ":", precision_dt_scol16)
    print("Array of Accuracy Scores DT-SMO:", df17_l, ":", accuracy_dt_scol16)

    print("Array of Prob Scores NB-SMO:", df17_l, ":", probs_nb_scol16)
    print("Array of F1 Scores NB-SMO:", df17_l, ":", f1_nb_scol16)
    print("Array of ROCAUC Scores NB-SMO:", df17_l, ":", rocauc_nb_scol16)
    print("Array of Recall Scores NB-SMO:", df17_l, ":", recall_nb_scol16)
    print("Array of Precision Scores NB-SMO:", df17_l, ":", precision_nb_scol16)
    print("Array of Accuracy Scores NB-SMO:", df17_l, ":", accuracy_nb_scol16)

    print("Array of Prob Scores XG-SMO:", df17_l, ":", probs_xg_scol16)
    print("Array of F1 Scores XG-SMO:", df17_l, ":", f1_xg_scol16)
    print("Array of ROCAUC Scores XG-SMO:", df17_l, ":", rocauc_xg_scol16)
    print("Array of Recall Scores XG-SMO:", df17_l, ":", recall_xg_scol16)
    print("Array of Precision Scores XG-SMO:", df17_l, ":", precision_xg_scol16)
    print("Array of Accuracy Scores XG-SMO:", df17_l, ":", accuracy_xg_scol16)

    print("Array of Prob Scores RF-SMO:", df17_l, ":", probs_rf_scol16)
    print("Array of F1 Scores RF-SMO:", df17_l, ":", f1_rf_scol16)
    print("Array of ROCAUC Scores RF-SMO:", df17_l, ":", rocauc_rf_scol16)
    print("Array of Recall Scores RF-SMO:", df17_l, ":", recall_rf_scol16)
    print("Array of Precision Scores RF-SMO:", df17_l, ":", precision_rf_scol16)
    print("Array of Accuracy Scores RF-SMO:", df17_l, ":", accuracy_rf_scol16)
    

year16 = [ args.group for t in range(25)]
sampling16 = ['Oversampling' for t in range(25)]
technique16 = ['SMOTE' for t in range(25)]
...
x_smote17, y_smote17 = smote.fit_resample(x_tfidf17, df18["label"])
...
for i in train_values:
    ...
    x_train, x_test, y_train, y_test = train_test_split(x_smote17, y_smote17, train_size=i, stratify=y_smote17)
    ...
    print("===Logistic Regression with TfidfVectorizer SMOTE - ", args.group, df18_l, i)
    lr_end = time.time()
    print('Logistic F1-score', fly * 100)
    print('Logistic ROCAUC score:', rocauc_lr * 100)
    print('Logistic Recall score:', recalls_lr * 100)
    ...
    print("===DecisionTreeClassifier with TfidfVectorizer SMOTE - ", args.group, df18_l, i)
    dt_end = time.time()
    print('DCT F1-score', fdct * 100)
    print('DCT ROCAUC score:', rocauc_dt * 100)
    print('DCT Recall score:', recalls_dt * 100)
    ...
    nb_end = time.time()
    # Use accuracy_score function to get the accuracy
    print("===Naive Bayes with TfidfVectorizer SMOTE - ", args.group, df18_l, i)
    print('Naive F1-score', fnb * 100)
    print('Naive ROCAUC score:', rocauc_nb * 100)
    print('Naive Recall score:', recalls_nb * 100)
    print('Naive Precision Score:', precisions_nb * 100)
    ...
    xg_end = time.time()
    print("===XGB with TfidfVectorizer SMOTE - ", args.group, df18_l, i)
    print('XGB F1-Score', fxg * 100)
    print('XGB ROCAUC Score:', rocauc_xg * 100)
    print('XGB Recall score:', recall_xg * 100)
    print('XGB Precision Score:', precisions_xg * 100)
    ...
    rf_end = time.time()
    print("====RandomForest with Tfidf SMOTE ", args.group, df18_l, i)
    print('RFC F1 score', frfc * 100)
    print('RFC ROCAUC Score:', rocauc_rf * 100)
    print('RFC Recall score:', recalls_rf * 100)
    print('RFC Precision Score:', precisions_rf * 100)
    ...
    print("Array of Prob Scores LR-SMO:", df18_l, ":", probs_lr_scol17)
    print("Array of F1 Scores LR-SMO:", df18_l, ":", f1_lr_scol17)
    print("Array of ROCAUC Scores LR-SMO:", df18_l, ":", rocauc_lr_scol17)
    print("Array of Recall Scores LR-SMO:", df18_l, ":", recall_lr_scol17)
    print("Array of Precision Scores LR-SMO:", df18_l, ":", precision_lr_scol17)
    print("Array of Accuracy Scores LR-SMO:", df18_l, ":", accuracy_lr_scol17)

    print("Array of Prob Scores DT-SMO:", df18_l, ":", probs_dt_scol17)
    print("Array of F1 Scores DT-SMO:", df18_l, ":", f1_dt_scol17)
    print("Array of ROCAUC Scores DT-SMO:", df18_l, ":", rocauc_dt_scol17)
    print("Array of Recall Scores DT-SMO:", df18_l, ":", recall_dt_scol17)
    print("Array of Precision Scores DT-SMO:", df18_l, ":", precision_dt_scol17)
    print("Array of Accuracy Scores DT-SMO:", df18_l, ":", accuracy_dt_scol17)

    print("Array of Prob Scores NB-SMO:", df18_l, ":", probs_nb_scol17)
    print("Array of F1 Scores NB-SMO:", df18_l, ":", f1_nb_scol17)
    print("Array of ROCAUC Scores NB-SMO:", df18_l, ":", rocauc_nb_scol17)
    print("Array of Recall Scores NB-SMO:", df18_l, ":", recall_nb_scol17)
    print("Array of Precision Scores NB-SMO:", df18_l, ":", precision_nb_scol17)
    print("Array of Accuracy Scores NB-SMO:", df18_l, ":", accuracy_nb_scol17)

    print("Array of Prob Scores XG-SMO:", df18_l, ":", probs_xg_scol17)
    print("Array of F1 Scores XG-SMO:", df18_l, ":", f1_xg_scol17)
    print("Array of ROCAUC Scores XG-SMO:", df18_l, ":", rocauc_xg_scol17)
    print("Array of Recall Scores XG-SMO:", df18_l, ":", recall_xg_scol17)
    print("Array of Precision Scores XG-SMO:", df18_l, ":", precision_xg_scol17)
    print("Array of Accuracy Scores XG-SMO:", df18_l, ":", accuracy_xg_scol17)

    print("Array of Prob Scores RF-SMO:", df18_l, ":", probs_rf_scol17)
    print("Array of F1 Scores RF-SMO:", df18_l, ":", f1_rf_scol17)
    print("Array of ROCAUC Scores RF-SMO:", df18_l, ":", rocauc_rf_scol17)
    print("Array of Recall Scores RF-SMO:", df18_l, ":", recall_rf_scol17)
    print("Array of Precision Scores RF-SMO:", df18_l, ":", precision_rf_scol17)
    print("Array of Accuracy Scores RF-SMO:", df18_l, ":", accuracy_rf_scol17)

year17 = [ args.group for t in range(25)]
sampling17 = ['Oversampling' for t in range(25)]
technique17 = ['SMOTE' for t in range(25)]
...
x_smote18, y_smote18 = smote.fit_resample(x_tfidf18, df19["label"])
...
for i in train_values:
    ...
    x_train, x_test, y_train, y_test = train_test_split(x_smote18, y_smote18, train_size=i, stratify=y_smote18)
    ...
    print("===Logistic Regression with TfidfVectorizer SMOTE - ", args.group, df19_l, i)
    lr_end = time.time()
    print('Logistic F1-score', fly * 100)
    print('Logistic ROCAUC score:', rocauc_lr * 100)
    print('Logistic Recall score:', recalls_lr * 100)
    ...
    print("===DecisionTreeClassifier with TfidfVectorizer SMOTE - ", args.group, df19_l, i)
    dt_end = time.time()
    print('DCT F1-score', fdct * 100)
    print('DCT ROCAUC score:', rocauc_dt * 100)
    print('DCT Recall score:', recalls_dt * 100)
    ...
    nb_end = time.time()
    # Use accuracy_score function to get the accuracy
    print("===Naive Bayes with TfidfVectorizer SMOTE - ", args.group, df19_l, i)
    print('Naive F1-score', fnb * 100)
    print('Naive ROCAUC score:', rocauc_nb * 100)
    print('Naive Recall score:', recalls_nb * 100)
    print('Naive Precision Score:', precisions_nb * 100)
    ...
    xg_end = time.time()
    print("===XGB with TfidfVectorizer SMOTE - ", args.group, df19_l, i)
    print('XGB F1-Score', fxg * 100)
    print('XGB ROCAUC Score:', rocauc_xg * 100)
    print('XGB Recall score:', recall_xg * 100)
    print('XGB Precision Score:', precisions_xg * 100)
    ...
    rf_end = time.time()
    print("====RandomForest with Tfidf SMOTE ", args.group, df19_l, i)
    print('RFC F1 score', frfc * 100)
    print('RFC ROCAUC Score:', rocauc_rf * 100)
    print('RFC Recall score:', recalls_rf * 100)
    print('RFC Precision Score:', precisions_rf * 100)
    ...
    print("Array of Prob Scores LR-SMO:", df19_l, ":", probs_lr_scol18)
    print("Array of F1 Scores LR-SMO:", df19_l, ":", f1_lr_scol18)
    print("Array of ROCAUC Scores LR-SMO:", df19_l, ":", rocauc_lr_scol18)
    print("Array of Recall Scores LR-SMO:", df19_l, ":", recall_lr_scol18)
    print("Array of Precision Scores LR-SMO:", df19_l, ":", precision_lr_scol18)
    print("Array of Accuracy Scores LR-SMO:", df19_l, ":", accuracy_lr_scol18)

    print("Array of Prob Scores DT-SMO:", df19_l, ":", probs_dt_scol18)
    print("Array of F1 Scores DT-SMO:", df19_l, ":", f1_dt_scol18)
    print("Array of ROCAUC Scores DT-SMO:", df19_l, ":", rocauc_dt_scol18)
    print("Array of Recall Scores DT-SMO:", df19_l, ":", recall_dt_scol18)
    print("Array of Precision Scores DT-SMO:", df19_l, ":", precision_dt_scol18)
    print("Array of Accuracy Scores DT-SMO:", df19_l, ":", accuracy_dt_scol18)

    print("Array of Prob Scores NB-SMO:", df19_l, ":", probs_nb_scol18)
    print("Array of F1 Scores NB-SMO:", df19_l, ":", f1_nb_scol18)
    print("Array of ROCAUC Scores NB-SMO:", df19_l, ":", rocauc_nb_scol18)
    print("Array of Recall Scores NB-SMO:", df19_l, ":", recall_nb_scol18)
    print("Array of Precision Scores NB-SMO:", df19_l, ":", precision_nb_scol18)
    print("Array of Accuracy Scores NB-SMO:", df19_l, ":", accuracy_nb_scol18)

    print("Array of Prob Scores XG-SMO:", df19_l, ":", probs_xg_scol18)
    print("Array of F1 Scores XG-SMO:", df19_l, ":", f1_xg_scol18)
    print("Array of ROCAUC Scores XG-SMO:", df19_l, ":", rocauc_xg_scol18)
    print("Array of Recall Scores XG-SMO:", df19_l, ":", recall_xg_scol18)
    print("Array of Precision Scores XG-SMO:", df19_l, ":", precision_xg_scol18)
    print("Array of Accuracy Scores XG-SMO:", df19_l, ":", accuracy_xg_scol18)

    print("Array of Prob Scores RF-SMO:", df19_l, ":", probs_rf_scol18)
    print("Array of F1 Scores RF-SMO:", df19_l, ":", f1_rf_scol18)
    print("Array of ROCAUC Scores RF-SMO:", df19_l, ":", rocauc_rf_scol18)
    print("Array of Recall Scores RF-SMO:", df19_l, ":", recall_rf_scol18)
    print("Array of Precision Scores RF-SMO:", df19_l, ":", precision_rf_scol18)
    print("Array of Accuracy Scores RF-SMO:", df19_l, ":", accuracy_rf_scol18)
    

year18 = [ args.group for t in range(25)]
sampling18 = ['Oversampling' for t in range(25)]
technique18 = ['SMOTE' for t in range(25)]
...
x_smote19, y_smote19 = smote.fit_resample(x_tfidf19, df20["label"])
...
for i in train_values:
    ...
    x_train, x_test, y_train, y_test = train_test_split(x_smote19, y_smote19, train_size=i, stratify=y_smote19)
    ...
    print("===Logistic Regression with TfidfVectorizer SMOTE - ", args.group, df20_l, i)
    lr_end = time.time()
    print('Logistic F1-score', fly * 100)
    print('Logistic ROCAUC score:', rocauc_lr * 100)
    print('Logistic Recall score:', recalls_lr * 100)
    ...
    print("===DecisionTreeClassifier with TfidfVectorizer SMOTE - ", args.group, df20_l, i)
    dt_end = time.time()
    print('DCT F1-score', fdct * 100)
    print('DCT ROCAUC score:', rocauc_dt * 100)
    print('DCT Recall score:', recalls_dt * 100)
    ...
    nb_end = time.time()
    # Use accuracy_score function to get the accuracy
    print("===Naive Bayes with TfidfVectorizer SMOTE - ", args.group, df20_l, i)
    print('Naive F1-score', fnb * 100)
    print('Naive ROCAUC score:', rocauc_nb * 100)
    print('Naive Recall score:', recalls_nb * 100)
    print('Naive Precision Score:', precisions_nb * 100)
    ...
    xg_end = time.time()
    print("===XGB with TfidfVectorizer SMOTE - ", args.group, df20_l, i)
    print('XGB F1-Score', fxg * 100)
    print('XGB ROCAUC Score:', rocauc_xg * 100)
    print('XGB Recall score:', recall_xg * 100)
    print('XGB Precision Score:', precisions_xg * 100)
    ...
    rf_end = time.time()
    print("====RandomForest with Tfidf SMOTE ", args.group, df20_l, i)
    print('RFC F1 score', frfc * 100)
    print('RFC ROCAUC Score:', rocauc_rf * 100)
    print('RFC Recall score:', recalls_rf * 100)
    print('RFC Precision Score:', precisions_rf * 100)
    ...
    print("Array of Prob Scores LR-SMO:", df20_l, ":", probs_lr_scol19)
    print("Array of F1 Scores LR-SMO:", df20_l, ":", f1_lr_scol19)
    print("Array of ROCAUC Scores LR-SMO:", df20_l, ":", rocauc_lr_scol19)
    print("Array of Recall Scores LR-SMO:", df20_l, ":", recall_lr_scol19)
    print("Array of Precision Scores LR-SMO:", df20_l, ":", precision_lr_scol19)
    print("Array of Accuracy Scores LR-SMO:", df20_l, ":", accuracy_lr_scol19)

    print("Array of Prob Scores DT-SMO:", df20_l, ":", probs_dt_scol19)
    print("Array of F1 Scores DT-SMO:", df20_l, ":", f1_dt_scol19)
    print("Array of ROCAUC Scores DT-SMO:", df20_l, ":", rocauc_dt_scol19)
    print("Array of Recall Scores DT-SMO:", df20_l, ":", recall_dt_scol19)
    print("Array of Precision Scores DT-SMO:", df20_l, ":", precision_dt_scol19)
    print("Array of Accuracy Scores DT-SMO:", df20_l, ":", accuracy_dt_scol19)

    print("Array of Prob Scores NB-SMO:", df20_l, ":", probs_nb_scol19)
    print("Array of F1 Scores NB-SMO:", df20_l, ":", f1_nb_scol19)
    print("Array of ROCAUC Scores NB-SMO:", df20_l, ":", rocauc_nb_scol19)
    print("Array of Recall Scores NB-SMO:", df20_l, ":", recall_nb_scol19)
    print("Array of Precision Scores NB-SMO:", df20_l, ":", precision_nb_scol19)
    print("Array of Accuracy Scores NB-SMO:", df20_l, ":", accuracy_nb_scol19)

    print("Array of Prob Scores XG-SMO:", df20_l, ":", probs_xg_scol19)
    print("Array of F1 Scores XG-SMO:", df20_l, ":", f1_xg_scol19)
    print("Array of ROCAUC Scores XG-SMO:", df20_l, ":", rocauc_xg_scol19)
    print("Array of Recall Scores XG-SMO:", df20_l, ":", recall_xg_scol19)
    print("Array of Precision Scores XG-SMO:", df20_l, ":", precision_xg_scol19)
    print("Array of Accuracy Scores XG-SMO:", df20_l, ":", accuracy_xg_scol19)

    print("Array of Prob Scores RF-SMO:", df20_l, ":", probs_rf_scol19)
    print("Array of F1 Scores RF-SMO:", df20_l, ":", f1_rf_scol19)
    print("Array of ROCAUC Scores RF-SMO:", df20_l, ":", rocauc_rf_scol19)
    print("Array of Recall Scores RF-SMO:", df20_l, ":", recall_rf_scol19)
    print("Array of Precision Scores RF-SMO:", df20_l, ":", precision_rf_scol19)
    print("Array of Accuracy Scores RF-SMO:", df20_l, ":", accuracy_rf_scol19)
    

year19 = [ args.group for t in range(25)]
sampling19 = ['Oversampling' for t in range(25)]
technique19 = ['SMOTE' for t in range(25)]
