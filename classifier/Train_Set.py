...
subsample_csv = [next(o) for _ in range(rounds1)] * 10
...
csv_data = [subset, other_set, sampling, technique, classifier_csv, subsample_csv, precision_csv, recall_csv,
...
subsample_csv1 = [next(o1) for _ in range(rounds1)] * 10
...
csv_data1 = [subset1, other_set1, sampling1, technique1, classifier_csv1, subsample_csv1, precision_csv1, recall_csv1,
...
classifier_csv2 = [next(p) for _ in range(rounds)] * 10
subsample_csv2 = [next(o) for _ in range(rounds1)] * 10
...
csv_data2 = [subset2, other_set2, sampling2, technique2, classifier_csv2, subsample_csv2, precision_csv2, recall_csv2,
            auc_csv2, accuracy_csv2]
...
subsample_csv3 = [next(o3) for _ in range(rounds1)] * 10
...
csv_data3 = [subset3, other_set3, sampling3, technique3, classifier_csv3, subsample_csv3, precision_csv3, recall_csv3,
            auc_csv3, accuracy_csv3]
...
print("What else this program will do...")
pause()
...
subsample_csv4 = [next(o4) for _ in range(rounds1)] * 10
...
csv_data4 = [subset4, other_set4, sampling4, technique4, classifier_csv4, subsample_csv4, precision_csv4, recall_csv4,
            auc_csv4, accuracy_csv4]
...
subsample_csv5 = [next(o5) for _ in range(rounds1)] * 10
...
csv_data5 = [subset5, other_set5, sampling5, technique5, classifier_csv5, subsample_csv5, precision_csv5, recall_csv5,
            auc_csv5, accuracy_csv5]
...
subsample_csv6 = [next(o6) for _ in range(rounds1)] * 10
#test_size_csv = [next(o) for _ in range(rounds)] * 1
#train_size_csv = [next(k) for _ in range(rounds)] * 1
# split_csv = ['1' for t in range(25)]
# train_csv = ['0.5' for t in range(25)]
...
csv_data6 = [subset6, sampling6, technique6, classifier_csv6, subsample_csv6, precision_csv6, recall_csv6,
            auc_csv6, accuracy_csv6]
...
#for h, j, k, l in zip(tl_xtrain_list, tl_xtest_list, tl_ytrain_list, tl_ytest_list):
    ...
    print("===Logistic Regression with TfidfVectorizer Tomelinks Train_Set & Test_Set - 2010-2016", k)
    lr_end = time.time()
    print('Logistic F1-score', fly * 100)
    print('Logistic ROCAUC score:', rocauc_lr * 100)
    print('Logistic Recall score:', recalls_lr * 100)
    ...
    print("===DecisionTreeClassifier with TfidfVectorizer Tomelinks Train_Set & Test_Set - 2010-2016", k)
    dt_end = time.time()
    print('DCT F1-score', fdct * 100)
    print('DCT ROCAUC score:', rocauc_dt * 100)
    print('DCT Recall score:', recalls_dt * 100)
    ...
    nb_end = time.time()
    # Use accuracy_score function to get the accuracy
    print("===Naive Bayes with TfidfVectorizer Imabalanced Tomelinks Train_Set & Test_Set - 2010-2016", k)
    print('Naive F1-score', fnb * 100)
    print('Naive ROCAUC score:', rocauc_nb * 100)
    print('Naive Recall score:', recalls_nb * 100)
    print('Naive Precision Score:', precisions_nb * 100)
    ...
    xg_end = time.time()
    print("===XGB with TfidfVectorizer Tomelinks Train_Set & Test_Set - 2010-2016", k)
    print('XGB F1-Score', fxg * 100)
    print('XGB ROCAUC Score:', rocauc_xg * 100)
    print('XGB Recall score:', recall_xg * 100)
    print('XGB Precision Score:', precisions_xg * 100)
    ...
    start5 = time.time()
    rfc_model = RandomForestClassifier(n_estimators=1000, random_state=0).fit(h, k)
    probs_rf = rfc_model.predict_proba(j)[:, 1]
    ...
    rf_end = time.time()
    print("====RandomForest with Tfidf Tomelinks Train_Set & Test_Set - 2010-2016", k)
    print('RFC F1 score', frfc * 100)
    print('RFC ROCAUC Score:', rocauc_rf * 100)
    print('RFC Recall score:', recalls_rf * 100)
    print('RFC Precision Score:', precisions_rf * 100)
...
rounds = 5
rounds1 = 1
p7 = itertools.cycle(classifier_names)
...
subsample_csv7 = [next(o7) for _ in range(rounds)] * 10
...
csv_data7 = [subset7, sampling7, technique7, classifier_csv7, subsample_csv7, precision_csv7, recall_csv7,
            auc_csv7, accuracy_csv7]
...
#for h, j, k, l in zip(tl_xtrain_list, tl_xtest_list, tl_ytrain_list, tl_ytest_list):
    ...
    print("===Logistic Regression with TfidfVectorizer NearMiss Train_Set & Test_Set - 2010-2016", k)
    lr_end = time.time()
    print('Logistic F1-score', fly * 100)
    print('Logistic ROCAUC score:', rocauc_lr * 100)
    print('Logistic Recall score:', recalls_lr * 100)
    ...
    print("===DecisionTreeClassifier with TfidfVectorizer NearMiss Train_Set & Test_Set - 2010-2016", k)
    dt_end = time.time()
    print('DCT F1-score', fdct * 100)
    print('DCT ROCAUC score:', rocauc_dt * 100)
    print('DCT Recall score:', recalls_dt * 100)
    ...
    nb_end = time.time()
    # Use accuracy_score function to get the accuracy
    print("===Naive Bayes with TfidfVectorizer Imabalanced NearMiss Train_Set & Test_Set - 2010-2016", k)
    print('Naive F1-score', fnb * 100)
    print('Naive ROCAUC score:', rocauc_nb * 100)
    print('Naive Recall score:', recalls_nb * 100)
    print('Naive Precision Score:', precisions_nb * 100)
    ...
    xg_end = time.time()
    print("===XGB with TfidfVectorizer NearMiss Train_Set & Test_Set - 2010-2016", k)
    print('XGB F1-Score', fxg * 100)
    print('XGB ROCAUC Score:', rocauc_xg * 100)
    print('XGB Recall score:', recall_xg * 100)
    print('XGB Precision Score:', precisions_xg * 100)
    ...
    rf_end = time.time()
    print("====RandomForest with Tfidf NearMiss Train_Set & Test_Set - 2010-2016", k)
    print('RFC F1 score', frfc * 100)
    print('RFC ROCAUC Score:', rocauc_rf * 100)
    print('RFC Recall score:', recalls_rf * 100)
    print('RFC Precision Score:', precisions_rf * 100)
...
classifier_csv8 = [next(p7) for _ in range(rounds)] * 10
subsample_csv8 = [next(o7) for _ in range(rounds1)] * 10
...
csv_data8 = [subset8, other_set8, sampling8, technique8, classifier_csv8, subsample_csv8, precision_csv8, recall_csv8, 
             auc_csv8, accuracy_csv8]
...
#for h, j, k, l in zip(tl_xtrain_list, tl_xtest_list, tl_ytrain_list, tl_ytest_list):
    ...
    print("===Logistic Regression with TfidfVectorizer SMOTE Train_Set & Test_Set - 2010-2016", k)
    lr_end = time.time()
    print('Logistic F1-score', fly * 100)
    print('Logistic ROCAUC score:', rocauc_lr * 100)
    print('Logistic Recall score:', recalls_lr * 100)
    ...
    print("===DecisionTreeClassifier with TfidfVectorizer SMOTE Train_Set & Test_Set - 2010-2016", k)
    dt_end = time.time()
    print('DCT F1-score', fdct * 100)
    print('DCT ROCAUC score:', rocauc_dt * 100)
    print('DCT Recall score:', recalls_dt * 100)
    ...
    nb_end = time.time()
    # Use accuracy_score function to get the accuracy
    print("===Naive Bayes with TfidfVectorizer Imabalanced SMOTE Train_Set & Test_Set - 2010-2016", k)
    print('Naive F1-score', fnb * 100)
    print('Naive ROCAUC score:', rocauc_nb * 100)
    print('Naive Recall score:', recalls_nb * 100)
    print('Naive Precision Score:', precisions_nb * 100)
    ...
    xg_end = time.time()
    print("===XGB with TfidfVectorizer SMOTE Train_Set & Test_Set - 2010-2016", k)
    print('XGB F1-Score', fxg * 100)
    print('XGB ROCAUC Score:', rocauc_xg * 100)
    print('XGB Recall score:', recall_xg * 100)
    print('XGB Precision Score:', precisions_xg * 100)
    ...
    rf_end = time.time()
    print("====RandomForest with Tfidf SMOTE Train_Set & Test_Set - 2010-2016", k)
    print('RFC F1 score', frfc * 100)
    print('RFC ROCAUC Score:', rocauc_rf * 100)
    print('RFC Recall score:', recalls_rf * 100)
    print('RFC Precision Score:', precisions_rf * 100)
...
subsample_csv9 = [next(o9) for _ in range(rounds)] * 10
...
csv_data9 = [subset9, other_set9, sampling9, technique9, classifier_csv9, subsample_csv9, precision_csv9, recall_csv9,
            auc_csv9, accuracy_csv9]
...
#for h, j, k, l in zip(tl_xtrain_list, tl_xtest_list, tl_ytrain_list, tl_ytest_list):
    ...
    print("===Logistic Regression with TfidfVectorizer ROS Train_Set & Test_Set - 2010-2016", k)
    lr_end = time.time()
    print('Logistic F1-score', fly * 100)
    print('Logistic ROCAUC score:', rocauc_lr * 100)
    print('Logistic Recall score:', recalls_lr * 100)
    ...
    print("===DecisionTreeClassifier with TfidfVectorizer ROS Train_Set & Test_Set - 2010-2016", k)
    dt_end = time.time()
    print('DCT F1-score', fdct * 100)
    print('DCT ROCAUC score:', rocauc_dt * 100)
    print('DCT Recall score:', recalls_dt * 100)
    ...
    nb_end = time.time()
    # Use accuracy_score function to get the accuracy
    print("===Naive Bayes with TfidfVectorizer Imabalanced ROS Train_Set & Test_Set - 2010-2016", k)
    print('Naive F1-score', fnb * 100)
    print('Naive ROCAUC score:', rocauc_nb * 100)
    print('Naive Recall score:', recalls_nb * 100)
    print('Naive Precision Score:', precisions_nb * 100)
    ...
    xg_end = time.time()
    print("===XGB with TfidfVectorizer ROS Train_Set & Test_Set - 2010-2016", k)
    print('XGB F1-Score', fxg * 100)
    print('XGB ROCAUC Score:', rocauc_xg * 100)
    print('XGB Recall score:', recall_xg * 100)
    print('XGB Precision Score:', precisions_xg * 100)
    ...
    rf_end = time.time()
    print("====RandomForest with Tfidf ROS Train_Set & Test_Set - 2010-2016", k)
    print('RFC F1 score', frfc * 100)
    print('RFC ROCAUC Score:', rocauc_rf * 100)
    print('RFC Recall score:', recalls_rf * 100)
    print('RFC Precision Score:', precisions_rf * 100)
...
rounds = 5
rounds1 = 1
p10 = itertools.cycle(classifier_names)
...
classifier_csv10 = [next(p) for _ in range(rounds)] * 10
subsample_csv10 = [next(o) for _ in range(rounds1)] * 10
...
csv_data10 = [subset10, sampling10, technique10, classifier_csv10, subsample_csv10, precision_csv10, recall_csv10,
            auc_csv10, accuracy_csv10]
...
#for h, j, k, l in zip(tl_xtrain_list, tl_xtest_list, tl_ytrain_list, tl_ytest_list):
    ...
    print("===Logistic Regression with TfidfVectorizer RUS Train_Set & Test_Set - 2010-2016", k)
    lr_end = time.time()
    print('Logistic F1-score', fly * 100)
    print('Logistic ROCAUC score:', rocauc_lr * 100)
    print('Logistic Recall score:', recalls_lr * 100)
    ...
    print("===DecisionTreeClassifier with TfidfVectorizer RUS Train_Set & Test_Set - 2010-2016", k)
    dt_end = time.time()
    print('DCT F1-score', fdct * 100)
    print('DCT ROCAUC score:', rocauc_dt * 100)
    print('DCT Recall score:', recalls_dt * 100)
    ...
    nb_end = time.time()
    # Use accuracy_score function to get the accuracy
    print("===Naive Bayes with TfidfVectorizer Imabalanced RUS Train_Set & Test_Set - 2010-2016", k)
    print('Naive F1-score', fnb * 100)
    print('Naive ROCAUC score:', rocauc_nb * 100)
    print('Naive Recall score:', recalls_nb * 100)
    print('Naive Precision Score:', precisions_nb * 100)
    ...
    xg_end = time.time()
    print("===XGB with TfidfVectorizer RUS Train_Set & Test_Set - 2010-2016", k)
    print('XGB F1-Score', fxg * 100)
    print('XGB ROCAUC Score:', rocauc_xg * 100)
    print('XGB Recall score:', recall_xg * 100)
    print('XGB Precision Score:', precisions_xg * 100)
    ...
    rf_end = time.time()
    print("====RandomForest with Tfidf RUS Train_Set & Test_Set - 2010-2016", k)
    print('RFC F1 score', frfc * 100)
    print('RFC ROCAUC Score:', rocauc_rf * 100)
    print('RFC Recall score:', recalls_rf * 100)
    print('RFC Precision Score:', precisions_rf * 100)
...
import itertools
rounds = 5
p11 = itertools.cycle(classifier_names)
...
subsample_csv11 = [next(o11) for _ in range(rounds)] * 10
#test_size_csv = [next(o) for _ in range(rounds)] * 1
#train_size_csv = [next(k) for _ in range(rounds)] * 1
# split_csv = ['1' for t in range(25)]
# train_csv = ['0.5' for t in range(25)]
...
csv_data11 = [subset11, sampling11, technique11, classifier_csv11, subsample_csv11, precision_csv11, recall_csv11,
            auc_csv11, accuracy_csv11]
